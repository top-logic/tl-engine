...
public class StructuredElementCreateHandler extends AbstractCreateCommandHandler {
	...
	public Object createObject(LayoutComponent component, Object createContext, FormContainer formContainer,
		...
		return createChild((StructuredElement) createContext, type, theName);
    }

    /**
	 * This method creates a new {@link StructuredElement}.
	 * 
	 * @param aParent
	 *        The parent of the new child, must not be <code>null</code>..
	 * @param aName
	 *        The name for the element, must not be <code>null</code> or empty.
	 * @param type
	 *        The desired type of the child, must not be <code>null</code>.
