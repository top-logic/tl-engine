...
var $strongName = 'BBA5D24C0098E852DBEB3BBC4FA69093';
var $gwt = {};
...
function $getRelativeX(this$static, target){
  ...
  return ((e.clientX || 0) | 0) - (rect = target.getBoundingClientRect && target.getBoundingClientRect() , left = rect?rect.left + $getScrollLeft(target.ownerDocument):getAbsoluteLeftUsingOffsets(target) , left | 0) + $getScrollLeft_0(target) + $getScrollLeft_1(target.ownerDocument);
}

function $getRelativeY(this$static, target){
  var e, rect, top_0;
  e = this$static.nativeEvent;
  return ((e.clientY || 0) | 0) - (rect = target.getBoundingClientRect && target.getBoundingClientRect() , top_0 = rect?rect.top + $getScrollTop(target.ownerDocument):getAbsoluteTopUsingOffsets(target) , top_0 | 0) + ((target.scrollTop || 0) | 0) + $getScrollTop_0(target.ownerDocument);
}
...
_.invoke_0 = function invoke_1(command, args){
  ...
  switch (command) {
    ...
    case 'showHiddenElements':
      $setShowHiddenElements_0(this, ($clinit_Boolean() , $equalsIgnoreCase('true', castToString(args[0]))));
      break;
...
_.onClick = function onClick_0(event_0){
  var element;
  element = $eventGetTarget(event_0.nativeEvent);
}
;
_._changeTimeout = 0;
...
function $dispatch_1(event_0, node){
  ...
  if ($equals_0('mouseover', eventName) || $equals_0('mouseout', eventName)) {
    if ($isChildOf(event_0.currentTarget || $wnd, event_0.relatedTarget)) {
      return;
    }
  }
  fireNativeEvent(event_0, node, event_0.currentTarget || $wnd);
...
function SVGParserImplWebkit(){
  new DOMParser;
}

defineClass(337, 336, {}, SVGParserImplWebkit);
var Lorg_vectomatic_dom_svg_impl_SVGParserImplWebkit_2_classLit = createForClass('org.vectomatic.dom.svg.impl', 'SVGParserImplWebkit', 337);
