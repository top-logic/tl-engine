...
/**
 * {@link FastListElement} fetching its model properties from the dynamic model.
 * 
 * @author <a href="mailto:daniel.busche@top-logic.com">Daniel Busche</a>
 */
public class PersistentClassifier extends FastListElement {

	/**
	 * This constructor creates a new {@link PersistentClassifier}.
	 */
	public PersistentClassifier(KnowledgeObject ko) {
		super(ko);
	}
