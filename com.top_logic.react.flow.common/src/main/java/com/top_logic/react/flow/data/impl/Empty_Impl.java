...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Empty}.
 */
public class Empty_Impl extends com.top_logic.react.flow.data.impl.Box_Impl implements com.top_logic.react.flow.data.Empty {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Empty#create()
	 */
	public Empty_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Empty setMinWidth(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Empty setMinHeight(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Empty setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Empty setRenderInfo(java.lang.Object value) {
