...
/**
 * Implementation of {@link com.top_logic.react.flow.data.TreeConnection}.
 */
public class TreeConnection_Impl extends com.top_logic.react.flow.data.impl.Widget_Impl implements com.top_logic.react.flow.data.TreeConnection {

	private com.top_logic.react.flow.data.TreeLayout _owner = null;

	private com.top_logic.react.flow.data.TreeConnector _parent = null;

	private com.top_logic.react.flow.data.TreeConnector _child = null;
	 ...
	 *
	 * @see com.top_logic.react.flow.data.TreeConnection#create()
	 */
	...
	@Override
	public final com.top_logic.react.flow.data.TreeLayout getOwner() {
		return _owner;
	}
	 ...
	 */
	com.top_logic.react.flow.data.TreeConnection setOwner(com.top_logic.react.flow.data.TreeLayout value) {
		internalSetOwner(value);
		return this;
	}

	/** Internal setter for {@link #getOwner()} without chain call utility. */
	protected final void internalSetOwner(com.top_logic.react.flow.data.TreeLayout value) {
	...
	@Override
	public final com.top_logic.react.flow.data.TreeConnector getParent() {
		return _parent;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnection setParent(com.top_logic.react.flow.data.TreeConnector value) {
		internalSetParent(value);
		return this;
	}

	/** Internal setter for {@link #getParent()} without chain call utility. */
	protected final void internalSetParent(com.top_logic.react.flow.data.TreeConnector value) {
		com.top_logic.react.flow.data.impl.TreeConnector_Impl before = (com.top_logic.react.flow.data.impl.TreeConnector_Impl) _parent;
		com.top_logic.react.flow.data.impl.TreeConnector_Impl after = (com.top_logic.react.flow.data.impl.TreeConnector_Impl) value;
		if (after != null) {
			com.top_logic.react.flow.data.TreeConnection oldContainer = after.getConnection();
	...
	@Override
	public final com.top_logic.react.flow.data.TreeConnector getChild() {
		return _child;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnection setChild(com.top_logic.react.flow.data.TreeConnector value) {
		internalSetChild(value);
		return this;
	}

	/** Internal setter for {@link #getChild()} without chain call utility. */
	protected final void internalSetChild(com.top_logic.react.flow.data.TreeConnector value) {
		com.top_logic.react.flow.data.impl.TreeConnector_Impl before = (com.top_logic.react.flow.data.impl.TreeConnector_Impl) _child;
		com.top_logic.react.flow.data.impl.TreeConnector_Impl after = (com.top_logic.react.flow.data.impl.TreeConnector_Impl) value;
		if (after != null) {
			com.top_logic.react.flow.data.TreeConnection oldContainer = after.getConnection();
			if (oldContainer != null && oldContainer != this) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setStrokeStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setThickness(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setDashes(java.util.List<? extends Double> value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection addDash(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setDecorations(java.util.List<? extends com.top_logic.react.flow.data.EdgeDecoration> value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection addDecoration(com.top_logic.react.flow.data.EdgeDecoration value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setBarPosition(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnection setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnection setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnection setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnection setRenderInfo(java.lang.Object value) {
	...
	public void set(String field, Object value) {
		switch (field) {
			case PARENT__PROP: internalSetParent((com.top_logic.react.flow.data.TreeConnector) value); break;
			case CHILD__PROP: internalSetChild((com.top_logic.react.flow.data.TreeConnector) value); break;
	...
	public void readField(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in, String field) throws java.io.IOException {
		switch (field) {
			case PARENT__PROP: setParent(com.top_logic.react.flow.data.TreeConnector.readTreeConnector(scope, in)); break;
			case CHILD__PROP: setChild(com.top_logic.react.flow.data.TreeConnector.readTreeConnector(scope, in)); break;
