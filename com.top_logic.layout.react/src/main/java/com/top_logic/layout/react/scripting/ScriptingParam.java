 ...
 */
public record ScriptingParam(String name, String type, boolean required, String description) {
	 ...
	 */
	public static ScriptingParam requiredString(String name, String description) {
		return new ScriptingParam(name, "string", true, description);
	}
}
