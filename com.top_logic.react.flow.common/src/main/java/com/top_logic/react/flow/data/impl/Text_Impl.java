...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Text}.
 */
public class Text_Impl extends com.top_logic.react.flow.data.impl.Box_Impl implements com.top_logic.react.flow.data.Text {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Text#create()
	 */
	public Text_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Text setValue(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setFontWeight(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setFontFamily(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setStrokeStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setFillStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setBaseLine(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Text setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Text setRenderInfo(java.lang.Object value) {
