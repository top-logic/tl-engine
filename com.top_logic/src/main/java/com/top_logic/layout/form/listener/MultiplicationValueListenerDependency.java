...
/**
 * An {@link AggregationValueListenerDependency} implementation that computes the product
 * over the fields.
 *
 * @author <a href=mailto:Christian.Braun@top-logic.com>Christian Braun</a>
 */
public class MultiplicationValueListenerDependency extends AggregationValueListenerDependency {

	/** See {@link #isMandatory()}. */
	private boolean mandatory;

    /**
     * Creates a {@link MultiplicationValueListenerDependency}. The Fields must
     ...
     */
    public MultiplicationValueListenerDependency(FormField[] relatedFields, FormField resultField) {
     ...
     */
    public MultiplicationValueListenerDependency(FormField[] relatedFields, FormField resultField, boolean mandatory) {
    ...
    /**
     * Computes the product over all {@link FormField}s.
