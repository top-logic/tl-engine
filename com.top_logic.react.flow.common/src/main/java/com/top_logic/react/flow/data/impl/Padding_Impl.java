...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Padding}.
 */
public class Padding_Impl extends com.top_logic.react.flow.data.impl.Decoration_Impl implements com.top_logic.react.flow.data.Padding {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Padding#create()
	 */
	public Padding_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Padding setTop(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Padding setLeft(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Padding setBottom(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Padding setRight(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Padding setContent(com.top_logic.react.flow.data.Box value) {
		internalSetContent(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Padding setRenderInfo(java.lang.Object value) {
