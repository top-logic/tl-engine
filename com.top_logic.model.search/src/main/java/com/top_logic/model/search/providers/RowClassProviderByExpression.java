...
public class RowClassProviderByExpression extends AbstractConfiguredInstance<RowClassProviderByExpression.Config<?>>
	...
	public interface Config<I extends RowClassProviderByExpression> extends PolymorphicConfiguration<I> {
		 ...
		 * 
		 * <pre>
		 * <code>row -> model -> "tl-info"</code>
		 * </pre>
		 * 
		 * <dl>
		 * <dt><code>row</code></dt>
		 * <dd>The row object of the current table row. This row object is one element of the list
		 * generated by the table's model builder.</dd>
		 * 
		 ...
		 * property greater than <code>99</code>, you may use the following expression:
		 * </p>
		 * 
		 * <pre>
