 ...
 */
public interface Widget extends de.haumacher.msgbuf.graph.SharedGraphNode, com.top_logic.react.flow.operations.WidgetOperations {

	/** Type codes for the {@link com.top_logic.react.flow.data.Widget} hierarchy. */
	public enum TypeKind {

		/** Type literal for {@link com.top_logic.react.flow.data.Diagram}. */
		DIAGRAM,

		/** Type literal for {@link com.top_logic.react.flow.data.FloatingLayout}. */
		FLOATING_LAYOUT,
		...
		/** Type literal for {@link com.top_logic.react.flow.data.Image}. */
		IMAGE,

		/** Type literal for {@link com.top_logic.react.flow.data.Empty}. */
		EMPTY,
		...
		/** Type literal for {@link com.top_logic.react.flow.data.ClickTarget}. */
		CLICK_TARGET,

		/** Type literal for {@link com.top_logic.react.flow.data.ContextMenu}. */
		CONTEXT_MENU,

		/** Type literal for {@link com.top_logic.react.flow.data.DropRegion}. */
		DROP_REGION,

		/** Type literal for {@link com.top_logic.react.flow.data.Tooltip}. */
		TOOLTIP,

		/** Type literal for {@link com.top_logic.react.flow.data.Align}. */
		ALIGN,

		/** Type literal for {@link com.top_logic.react.flow.data.Border}. */
		BORDER,

		/** Type literal for {@link com.top_logic.react.flow.data.Fill}. */
		FILL,

		/** Type literal for {@link com.top_logic.react.flow.data.Padding}. */
		PADDING,

		/** Type literal for {@link com.top_logic.react.flow.data.Sized}. */
		SIZED,

		/** Type literal for {@link com.top_logic.react.flow.data.ClipBox}. */
		CLIP_BOX,

		/** Type literal for {@link com.top_logic.react.flow.data.CompassLayout}. */
		COMPASS_LAYOUT,

		/** Type literal for {@link com.top_logic.react.flow.data.GridLayout}. */
		GRID_LAYOUT,

		/** Type literal for {@link com.top_logic.react.flow.data.HorizontalLayout}. */
		HORIZONTAL_LAYOUT,
		...
		/** Type literal for {@link com.top_logic.react.flow.data.EdgeDecoration}. */
		EDGE_DECORATION,
	...
	/** Visitor interface for the {@link com.top_logic.react.flow.data.Widget} hierarchy.*/
	public interface Visitor<R,A,E extends Throwable> extends com.top_logic.react.flow.data.Box.Visitor<R,A,E> {
		...
		/** Visit case for {@link com.top_logic.react.flow.data.EdgeDecoration}.*/
		R visit(com.top_logic.react.flow.data.EdgeDecoration self, A arg) throws E;
	 ...
	 * @see #getCssClass()
	 */
	com.top_logic.react.flow.data.Widget setCssClass(String value);
	 ...
	 * @see #getUserObject()
	 */
	com.top_logic.react.flow.data.Widget setUserObject(java.lang.Object value);
	 ...
	 * @see #getClientId()
	 */
	com.top_logic.react.flow.data.Widget setClientId(String value);
	 ...
	 * @see #getRenderInfo()
	 */
	com.top_logic.react.flow.data.Widget setRenderInfo(java.lang.Object value);
	...
	static com.top_logic.react.flow.data.Widget readWidget(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.react.flow.data.Widget) scope.resolveOrFail(in.nextInt());
		}
		com.top_logic.react.flow.data.Widget result;
		in.beginArray();
