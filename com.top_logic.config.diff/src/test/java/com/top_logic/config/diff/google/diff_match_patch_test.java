 ...
 */
package com.top_logic.config.diff.google;
...
import com.top_logic.config.diff.google.diff_match_patch.LinesToCharsResult;
import com.top_logic.config.diff.google.diff_match_patch.Patch;
...
protected void setUp() {
  ...
  public static Test suite() {
      TestSuite theSuite = new TestSuite(diff_match_patch_test.class);
//      Test theSuite = new TestFileDiffGenerator("testGenerateBernhards");
      return theSuite;
	}
