...
/**
 * {@link MethodBuilder} creating {@link IsStringEqual} expressions.
 * 
 * @see SearchExpressions#isStringEqual(SearchExpression, SearchExpression, boolean)
 *
...
public class IsStringEqualBuilder extends TwoArgOptionalBooleanMethodBuilder<SearchExpression> {
	 ...
	 */
	public IsStringEqualBuilder(InstantiationContext context, Config<?> config) {
