...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Point}.
 */
public class Point_Impl extends de.haumacher.msgbuf.graph.AbstractSharedGraphNode implements com.top_logic.react.flow.data.Point {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Point#create()
	 */
	public Point_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Point setX(double value) {
		internalSetX(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.Point setY(double value) {
		internalSetY(value);
		return this;
	}
