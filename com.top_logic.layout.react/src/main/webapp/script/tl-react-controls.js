import { React as e, useTLFieldValue as Re, useTLCommand as re, useTLState as G, useKeyboardBinding as de, useTLUpload as Fe, TLChild as Y, useI18N as ie, useTLDataUrl as Oe, scrollToAnchor as Xt, useStandaloneKeyboardScope as Le, KeyboardScopeProvider as mt, useFocusTrap as pt, CMD_VALUE_CHANGED as We, anchoredOverlayProps as qt, register as U } from "tl-react-bridge";
...
const { useCallback: dn } = e, mn = ({ controlId: l, command: t, label: n, image: r, disabled: c, displayMode: s }) => {
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlFieldList" }, n && /* @__PURE__ */ e.createElement("h3", { className: "tlFieldList__title" }, n), /* @__PURE__ */ e.createElement("div", { className: "tlFieldList__fields" }, r.map((c, s) => /* @__PURE__ */ e.createElement("div", { key: s, className: "tlFieldList__item" }, /* @__PURE__ */ e.createElement(Y, { control: c })))));
}, En = {
...
const Fn = ({ controlId: l }) => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    k && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__header" }, !!c && c.trim() !== "" && /* @__PURE__ */ e.createElement("span", { className: "tlPanel__title" }, c), t.titleContent && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__titleContent" }, /* @__PURE__ */ e.createElement(Y, { control: t.titleContent })), /* @__PURE__ */ e.createElement("div", { className: "tlPanel__toolbar" }, t.toolbar && /* @__PURE__ */ e.createElement(Y, { control: t.toolbar }), i && !w && /* @__PURE__ */ e.createElement(
      "button",
      {
        type: "button",
    ...
    !b && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__content" }, /* @__PURE__ */ e.createElement(Y, { control: t.child })),
    ...
    !b && t.buttonBar && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__buttonBar" }, /* @__PURE__ */ e.createElement(Y, { control: t.buttonBar }))
  );
}, tl = ({ controlId: l }) => {
  const t = G();
  return /* @__PURE__ */ e.createElement(
...
const Be = ({ icon: l }) => l ? /* @__PURE__ */ e.createElement(we, { encoded: l, className: "tlSidebar__icon" }) : null, rl = ({ item: l, active: t, collapsed: n, onSelect: r, tabIndex: c, itemRef: s, onFocus: i }) => /* @__PURE__ */ e.createElement(
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: B }, t.drawerToggleContribution && /* @__PURE__ */ e.createElement(Y, { control: t.drawerToggleContribution }), u && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__backdrop", onClick: w, "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("nav", { className: "tlSidebar__nav", "aria-label": r["js.sidebar.ariaLabel"] }, a ? t.headerCollapsedContent && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerSlot tlSidebar__headerSlot--collapsed" }, /* @__PURE__ */ e.createElement(Y, { control: t.headerCollapsedContent })) : t.headerContent && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerSlot" }, /* @__PURE__ */ e.createElement(Y, { control: t.headerContent })), /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__items", onKeyDown: H }, c.map((R) => /* @__PURE__ */ e.createElement(
    Ot,
    {
      key: R.id,
      item: R,
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: a }, u.map((o, m) => /* @__PURE__ */ e.createElement(Y, { key: m, control: o })));
}, ml = ({ controlId: l }) => {
  const t = G();
  ...
  return r ? i.gridTemplateColumns = `repeat(auto-fit, minmax(min(${r}, 100%), 1fr))` : n && (i.gridTemplateColumns = `repeat(${n}, 1fr)`), /* @__PURE__ */ e.createElement("div", { id: l, className: `tlGrid tlGrid--gap-${c}`, style: i }, s.map((u, a) => /* @__PURE__ */ e.createElement(Y, { key: a, control: u })));
}, fl = ({ controlId: l }) => {
  const t = G(), n = t.title, r = t.variant ?? "outlined", c = t.padding ?? "default", s = t.headerActions ?? [], i = t.child, u = n != null || s.length > 0;
  return /* @__PURE__ */ e.createElement("div", { id: l, className: `tlCard tlCard--${r}` }, u && /* @__PURE__ */ e.createElement("div", { className: "tlCard__header" }, n && /* @__PURE__ */ e.createElement("span", { className: "tlCard__title" }, n), s.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlCard__headerActions" }, s.map((a, o) => /* @__PURE__ */ e.createElement(Y, { key: o, control: a })))), /* @__PURE__ */ e.createElement("div", { className: `tlCard__body tlCard__body--pad-${c}` }, /* @__PURE__ */ e.createElement(Y, { control: i })));
}, hl = ({ controlId: l }) => {
  ...
  return /* @__PURE__ */ e.createElement("header", { id: l, className: a }, r && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__leading" }, /* @__PURE__ */ e.createElement(Y, { control: r })), /* @__PURE__ */ e.createElement("h1", { className: "tlAppBar__title" }, n), c.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__children" }, c.map((o, m) => /* @__PURE__ */ e.createElement(Y, { key: m, control: o }))), s.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__actions" }, s.map((o, m) => /* @__PURE__ */ e.createElement(Y, { key: m, control: o }))));
  ...
  }, [n.length]), n.length === 0 ? null : /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDialogManager" }, n.map((c) => /* @__PURE__ */ e.createElement(Y, { key: c.controlId, control: c })));
}, { useCallback: ze, useRef: Pe, useState: Ve } = e, Nl = ({ onClose: l }) => (de("ESCAPE", () => (l(), !0)), null), Tl = {
  "js.window.close": "Close",
  "js.window.maximize": "Maximize",
  "js.window.restore": "Restore"
}, Rl = ["n", "ne", "e", "se", "s", "sw", "w", "nw"], Dl = ({ controlId: l }) => {
  const t = G(), n = re(), r = ie(Tl), c = t.title ?? "", s = t.width ?? "32rem", i = t.height ?? null, u = t.minHeight ?? null, a = t.resizable === !0, o = t.child, m = t.actions ?? [], p = t.toolbar, f = t.buttonBar, [_, b] = Ve(null), [w, E] = Ve(null), [v, g] = Ve(null), x = Pe(null), [L, C] = Ve(!1), k = Pe(null), h = Pe(null), I = Pe(null), T = Pe(null), S = Pe(null), H = ze(() => {
    n("close");
  }, [n]);
  pt(!0, T, "field");
  const B = ze((O, P) => {
  ...
  return /* @__PURE__ */ e.createElement(mt, { modal: !0 }, /* @__PURE__ */ e.createElement(Nl, { onClose: H }), /* @__PURE__ */ e.createElement(
    ...
    (m.length > 0 || f) && /* @__PURE__ */ e.createElement("div", { className: "tlWindow__footer" }, f && /* @__PURE__ */ e.createElement(Y, { control: f }), m.map((O, P) => /* @__PURE__ */ e.createElement(Y, { key: P, control: O }))),
  ...
  )), /* @__PURE__ */ e.createElement("div", { className: "tlDrawer__body" }, a && /* @__PURE__ */ e.createElement(Y, { control: a })));
}, { useCallback: Pl } = e, Ml = ({ controlId: l }) => {
  const t = G(), n = re(), r = t.child, c = Pl((s) => {
    s.preventDefault(), s.stopPropagation(), n("openContextMenu", { x: s.clientX, y: s.clientY });
  }, [n]);
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tl-context-menu-region", onContextMenu: c }, r && /* @__PURE__ */ e.createElement(Y, { control: r }));
...
const Yl = ({ controlId: l }) => {
  ...
  const Q = e.useCallback((y) => k[y.name] ?? y.width, [k]), W = e.useMemo(() => {
    ...
    for (let z = 0; z < f && z < s.length; z++)
      y.push(D), D += Q(s[z]);
    return y;
  }, [s, f, w, E, Q]), O = i * a, P = e.useRef(null), j = e.useCallback((y, D, z) => {
    ...
    const ce = () => {
      ...
      bt !== 0 && (me && (me.scrollLeft = ue.scrollLeft), te += bt, ce()), P.current = requestAnimationFrame(ae);
    };
        ...
        s.map((D, z) => {
          ...
          return /* @__PURE__ */ e.createElement(
            ...
            Se ? /* @__PURE__ */ e.createElement("div", { className: "tlTableView__treeCell", style: { paddingLeft: ue * v } }, y.expandable ? /* @__PURE__ */ e.createElement(
              ...
              y.expanded ? "▾" : "▸"
            ) : /* @__PURE__ */ e.createElement("span", { className: "tlTableView__treeToggleSpacer" }), /* @__PURE__ */ e.createElement(Y, { control: y.cells[D.name] })) : /* @__PURE__ */ e.createElement(Y, { control: y.cells[D.name] })
          );
        })
      )))
    ),
  ...
  ), c && /* @__PURE__ */ e.createElement("span", { className: "tlFormGroup__title" }, /* @__PURE__ */ e.createElement(Y, { control: c })), s.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlFormGroup__actions" }, s.map((b, w) => /* @__PURE__ */ e.createElement(Y, { key: w, control: b })))), /* @__PURE__ */ e.createElement("div", { className: "tlFormGroup__body" }, m.map((b, w) => /* @__PURE__ */ e.createElement(Y, { key: w, control: b }))));
...
const gr = ({ controlId: l, state: t }) => {
  const n = re(), r = t.value ?? [], c = t.multiSelect === !0, s = t.customOrder === !0, i = t.mandatory === !0, u = t.disabled === !0, a = t.editable !== !1, o = t.optionsLoaded === !0, m = t.options ?? [], p = t.emptyOptionLabel ?? "", f = s && c && !u && a, _ = ie({
    ...
    [_]
  ), [E, v] = Te(!1), [g, x] = Te(""), [L, C] = Te(-1), [k, h] = Te(!1), [I, T] = Te({}), [S, H] = Te(null), [B, R] = Te(null), [F, Q] = Te(null), W = $e(null), O = $e(null), P = $e(null), j = $e(r);
  j.current = r;
  const X = $e(-1), d = ut(
    () => new Set(r.map((M) => M.value)),
    [r]
  ), N = ut(() => {
    let M = m.filter((K) => !d.has(K.value));
    if (g) {
      const K = g.toLowerCase();
      M = M.filter((ne) => ne.label.toLowerCase().includes(K));
    }
    return M;
  }, [m, d, g]);
  Me(() => {
    ...
    const M = X.current;
    X.current = -1;
    const K = (ne = W.current) == null ? void 0 : ne.querySelectorAll(
      ".tlDropdownSelect__chipRemove"
    );
    K && K.length > 0 ? K[Math.min(M, K.length - 1)].focus() : (se = W.current) == null || se.focus();
  }, [r]), Me(() => {
    if (!E) return;
    const M = (K) => {
      W.current && !W.current.contains(K.target) && P.current && !P.current.contains(K.target) && (v(!1), x(""));
    };
    return document.addEventListener("mousedown", M), () => document.removeEventListener("mousedown", M);
  }, [E]), Me(() => {
    if (!E || !W.current) return;
    const M = W.current.getBoundingClientRect(), K = window.innerHeight - M.bottom, se = K < 300 && M.top > K;
    T({
      left: M.left,
      width: M.width,
  ...
  const V = fe(async () => {
    ...
    var M;
    v(!1), x(""), C(-1), (M = W.current) == null || M.focus();
  }, []), q = fe(
    (M) => {
      let K;
      if (c) {
      ...
      j.current = K, n(We, { value: K.map((ne) => ne.value) }), c ? (x(""), C(-1)) : $();
    },
    [c, m, n, $]
  ), A = fe(
    (M) => {
      X.current = j.current.findIndex((ne) => ne.value === M);
      const K = j.current.filter((ne) => ne.value !== M);
      j.current = K, n(We, { value: K.map((ne) => ne.value) });
    },
    [n]
  ), ee = fe(
    (M) => {
      ...
      switch (M.key) {
        case "ArrowDown":
          M.preventDefault(), M.stopPropagation(), C(
            (K) => K < N.length - 1 ? K + 1 : 0
          );
          break;
        case "ArrowUp":
          M.preventDefault(), M.stopPropagation(), C(
            (K) => K > 0 ? K - 1 : N.length - 1
          );
          break;
        case "Enter":
    ...
    (M, K) => {
      H(M), K.dataTransfer.effectAllowed = "move", K.dataTransfer.setData("text/plain", String(M));
    },
    []
  ), ge = fe(
    (M, K) => {
      if (K.preventDefault(), K.dataTransfer.dropEffect = "move", S === null || S === M) {
        R(null), Q(null);
        return;
      }
      const ne = K.currentTarget.getBoundingClientRect(), se = ne.left + ne.width / 2, Ie = K.clientX < se ? "before" : "after";
      R(M), Q(Ie);
    },
    [S]
  ), ye = fe(
    (M) => {
      ...
      const K = [...j.current], [ne] = K.splice(S, 1);
      let se = B;
      S < B ? se = F === "before" ? se - 1 : se : se = F === "before" ? se : se + 1, K.splice(se, 0, ne), j.current = K, n(We, { value: K.map((Ie) => Ie.value) }), H(null), R(null), Q(null);
    },
    [S, B, F, n]
  ), ke = fe(() => {
  ...
  if (Me(() => {
    ...
    return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDropdownSelect tlDropdownSelect--immutable" }, r.map((M) => /* @__PURE__ */ e.createElement("span", { key: M.value, className: "tlDropdownSelect__readonlyValue" }, /* @__PURE__ */ e.createElement(ft, { image: M.image }), /* @__PURE__ */ e.createElement("span", null, M.label))));
  const xe = !i && r.length > 0 && !u, He = E ? /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      ...
      o && N.map((M, K) => /* @__PURE__ */ e.createElement(
        vr,
        {
          key: M.value,
          id: `${l}-opt-${K}`,
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__chips" }, r.length === 0 ? /* @__PURE__ */ e.createElement("span", { className: "tlDropdownSelect__placeholder" }, p) : r.map((M, K) => {
      let ne = "";
      return S === K ? ne = "tlDropdownSelect__chip--dragging" : B === K && F === "before" ? ne = "tlDropdownSelect__chip--dropBefore" : B === K && F === "after" && (ne = "tlDropdownSelect__chip--dropAfter"), /* @__PURE__ */ e.createElement(
        _r,
        {
          key: M.value,
          option: M,
          ...
          draggable: f,
          onDragStart: f ? (se) => ve(K, se) : void 0,
          onDragOver: f ? (se) => ge(K, se) : void 0,
          onDrop: f ? ye : void 0,
...
const { useCallback: je, useRef: Pt } = e, Sr = ({ color: l, onColorChange: t }) => {
  const [n, r, c] = kr(l), s = Pt(null), i = Pt(null), u = je(
    (b, w) => {
      var x;
...
const Tr = {
  ...
  "js.colorInput.ok": "OK"
}, { useState: Ke, useCallback: Ee, useEffect: Mt, useRef: Rr, useLayoutEffect: Dr } = e, Lr = ({
  anchorRef: l,
  currentColor: t,
  palette: n,
  paletteColumns: r,
  ...
  const h = Ee(
    (P) => (j) => {
      ...
      if (isNaN(X)) return;
      const d = zt(X);
      f(Kt(P === "r" ? d : g, P === "g" ? d : x, P === "b" ? d : L));
    },
    [g, x, L]
  ), I = Ee(
    (P) => {
      if (p != null) {
        P.dataTransfer.setData(Wt, p.toUpperCase()), P.dataTransfer.effectAllowed = "move";
...
}, xr = { "js.colorInput.chooseColor": "Choose color" }, { useState: Ir, useCallback: Ye, useRef: Pr } = e, Mr = ({ controlId: l, state: t }) => {
  const [n, r] = Re(), c = re(), s = ie(xr), [i, u] = Ir(!1), a = Pr(null), o = n, m = t.editable !== !1, p = t.palette ?? [], f = t.paletteColumns ?? 6, _ = t.defaultPalette ?? p, b = Ye(() => {
    m && u(!0);
  }, [m]), w = Ye(
    (g) => {
      u(!1), r(g);
...
const Zr = ({ controlId: l }) => {
  ...
  if (a.length === 1 && !((p = l.subGroups) != null && p.length) && !l.icon)
    return /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--inline" }, /* @__PURE__ */ e.createElement("span", { className: "tlToolbar__item" }, /* @__PURE__ */ e.createElement(Y, { control: a[0] })));
  ...
  return /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--menu" }, /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      ...
      a.map((_, b) => /* @__PURE__ */ e.createElement("div", { key: b, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(Y, { control: _ }))),
      (f = l.subGroups) == null ? void 0 : f.map((_, b) => /* @__PURE__ */ e.createElement(e.Fragment, { key: `sub-${b}` }, /* @__PURE__ */ e.createElement("hr", { className: "tlToolbar__dropdownSeparator" }), _.items.map((w, E) => /* @__PURE__ */ e.createElement("div", { key: E, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(Y, { control: w })))))
    ),
    document.body
  ));
}, la = ({ controlId: l }) => {
  ...
  const n = G().children ?? [];
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlSlot" }, n.map((r, c) => /* @__PURE__ */ e.createElement(Y, { key: c, control: r })));
