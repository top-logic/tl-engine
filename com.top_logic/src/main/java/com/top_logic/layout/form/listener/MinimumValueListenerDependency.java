...
/**
 * An {@link AggregationValueListenerDependency} implementation that computes the minimum
 * of the fields.
 *
 * @author <a href="mailto:CBR@top-logic.com">CBR</a>
 */
public class MinimumValueListenerDependency extends AggregationValueListenerDependency {

	/** See {@link #isMandatory()}. */
	private boolean mandatory;

    /**
     * Creates a {@link MinimumValueListenerDependency}. The Fields must
     ...
     */
    public MinimumValueListenerDependency(FormField[] relatedFields, FormField resultField) {
		this(relatedFields, resultField, false);
	}

	/**
	 * Creates a {@link MinimumValueListenerDependency}. The Fields must contain
	 ...
	 */
	public MinimumValueListenerDependency(FormField[] relatedFields, FormField resultField, boolean mandatory) {
    ...
    /**
     * Computes the minimum of all {@link FormField}s.
