...
/**
 * {@link FieldProvider} creating {@link FormFactory#newDateField(String, Object, boolean)}.
 * 
...
public class DateFieldProvider extends AbstractFieldProvider {
	...
	/**
	 * Singleton {@link DateFieldProvider} instance.
	 */
	public static final DateFieldProvider INSTANCE = new DateFieldProvider();

	private DateFieldProvider() {
	...
	public FormMember createField(Object model, Accessor accessor, String property) {
		...
		return FormFactory.newDateField(getFieldName(model, accessor, property), value, false);
	}
