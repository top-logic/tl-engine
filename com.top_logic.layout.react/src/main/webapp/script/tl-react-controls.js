import { React as e, useTLFieldValue as xe, getComponent as Nt, useTLState as G, useTLCommand as ne, TLChild as U, useTLUpload as Je, useI18N as ae, useTLDataUrl as et, register as z } from "tl-react-bridge";
...
const { useCallback: $t } = e, Ot = ({ controlId: l, command: t, label: n, image: r, disabled: i, displayMode: c }) => {
  const s = G(), u = ne(), a = t ?? "click", o = n ?? s.label, m = r ?? s.image, p = i ?? s.disabled === !0, h = c ?? s.displayMode ?? "label-only", N = s.hidden === !0, f = s.tooltip, T = N ? { display: "none" } : void 0, w = $t(() => {
    u(a);
  }, [u, a]), v = h === "icon-only", C = h === "icon-only" || h === "icon-label", D = h === "label-only" || h === "icon-label" || v && !m, M = f ?? (v ? o : void 0), _ = M ? `text:${M}` : void 0;
  return /* @__PURE__ */ e.createElement(
    "button",
    {
      type: "button",
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlFieldList" }, n && /* @__PURE__ */ e.createElement("h3", { className: "tlFieldList__title" }, n), /* @__PURE__ */ e.createElement("div", { className: "tlFieldList__fields" }, r.map((i, c) => /* @__PURE__ */ e.createElement("div", { key: c, className: "tlFieldList__item" }, /* @__PURE__ */ e.createElement(U, { control: i })))));
}, Kt = {
  ...
  const t = G(), n = Je(), [r, i] = e.useState("idle"), [c, s] = e.useState(null), u = e.useRef(null), a = e.useRef([]), o = e.useRef(null), m = t.status ?? "idle", p = t.error, h = m === "received" ? "idle" : r !== "idle" ? r : m, N = e.useCallback(async () => {
    ...
    if (r !== "uploading") {
      ...
      try {
        ...
        u.current = M, M.ondataavailable = (_) => {
          _.data.size > 0 && a.current.push(_.data);
        }, M.onstop = async () => {
          C.getTracks().forEach((E) => E.stop()), o.current = null;
          const _ = new Blob(a.current, { type: M.mimeType || "audio/webm" });
  ...
  const t = G(), n = Je(), [r, i] = e.useState("idle"), [c, s] = e.useState(!1), u = e.useRef(null), a = t.status ?? "idle", o = t.error, m = t.accept ?? "", p = a === "received" ? "idle" : r !== "idle" ? r : a, h = e.useCallback(async (_) => {
    i("uploading");
    const b = new FormData();
    ...
    var E;
    if (_.preventDefault(), _.stopPropagation(), s(!1), r === "uploading") return;
  ...
  const _ = ae(en), b = r === "uploading" ? _["js.uploading"] : _["js.photoCapture.open"], E = ["tlPhotoCapture__cameraBtn"];
  ...
  ), c && /* @__PURE__ */ e.createElement("span", { className: "tlPhotoCapture__status tlPhotoCapture__status--error" }, _[c]), f && /* @__PURE__ */ e.createElement("span", { className: "tlPhotoCapture__status tlPhotoCapture__status--error" }, f));
}, nn = {
  ...
  const t = G(), n = ne(), r = t.orientation, i = t.resizable === !0, c = t.children ?? [], s = r === "horizontal", u = c.length > 0 && c.every((w) => w.collapsed), a = !u && c.some((w) => w.collapsed), o = u ? !s : s, m = Fe(null), p = Fe(null), h = Fe(null), N = ot((w, v) => {
    ...
    const C = m.current;
    if (!C) return;
    const D = c[v], M = c[v + 1], _ = C.querySelectorAll(":scope > .tlSplitPanel__child"), b = [];
    _.forEach((k) => {
      b.push(s ? k.offsetWidth : k.offsetHeight);
  ...
  return c.forEach((w, v) => {
    if (T.push(
      /* @__PURE__ */ e.createElement(
        ...
        /* @__PURE__ */ e.createElement(U, { control: w.control })
      )
    ), i && v < c.length - 1) {
      const C = c[v + 1];
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlPanel__header" }, /* @__PURE__ */ e.createElement("span", { className: "tlPanel__title" }, i), /* @__PURE__ */ e.createElement("div", { className: "tlPanel__toolbar" }, t.toolbar && /* @__PURE__ */ e.createElement(U, { control: t.toolbar }), s && !p && /* @__PURE__ */ e.createElement(
      "button",
      {
        type: "button",
    ...
    !m && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__content" }, /* @__PURE__ */ e.createElement(U, { control: t.child })),
    !m && t.buttonBar && /* @__PURE__ */ e.createElement("div", { className: "tlPanel__buttonBar" }, /* @__PURE__ */ e.createElement(U, { control: t.buttonBar }))
  );
}, pn = ({ controlId: l }) => {
  const t = G();
  return /* @__PURE__ */ e.createElement(
  ...
  const t = G();
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDeckPane", style: { width: "100%", height: "100%" } }, t.activeChild && /* @__PURE__ */ e.createElement(U, { control: t.activeChild }));
...
const Ne = ({ icon: l }) => l ? /* @__PURE__ */ e.createElement("i", { className: "tlSidebar__icon " + l, "aria-hidden": "true" }) : null, bn = ({ item: l, active: t, collapsed: n, onSelect: r, tabIndex: i, itemRef: c, onFocus: s }) => /* @__PURE__ */ e.createElement(
  "button",
  {
...
), _n = ({ item: l, collapsed: t, onExecute: n, tabIndex: r, itemRef: i, onFocus: c }) => /* @__PURE__ */ e.createElement(
  "button",
  {
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlSidebar" + (s ? " tlSidebar--collapsed" : "") }, t.drawerToggleContribution && /* @__PURE__ */ e.createElement(U, { control: t.drawerToggleContribution }), !s && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__backdrop", onClick: h, "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("nav", { className: "tlSidebar__nav", "aria-label": r["js.sidebar.ariaLabel"] }, s ? t.headerCollapsedContent && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerSlot tlSidebar__headerSlot--collapsed" }, /* @__PURE__ */ e.createElement(U, { control: t.headerCollapsedContent })) : t.headerContent && /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerSlot" }, /* @__PURE__ */ e.createElement(U, { control: t.headerContent })), /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__items", onKeyDown: W }, i.map((k) => /* @__PURE__ */ e.createElement(
    Et,
    {
      key: k.id,
      item: k,
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: u }, s.map((a, o) => /* @__PURE__ */ e.createElement(U, { key: o, control: a })));
}, kn = ({ controlId: l }) => {
  const t = G(), n = t.columns, r = t.minColumnWidth, i = t.gap ?? "default", c = t.children ?? [], s = {};
  return r ? s.gridTemplateColumns = `repeat(auto-fit, minmax(${r}, 1fr))` : n && (s.gridTemplateColumns = `repeat(${n}, 1fr)`), /* @__PURE__ */ e.createElement("div", { id: l, className: `tlGrid tlGrid--gap-${i}`, style: s }, c.map((u, a) => /* @__PURE__ */ e.createElement(U, { key: a, control: u })));
}, Sn = ({ controlId: l }) => {
  const t = G(), n = t.title, r = t.variant ?? "outlined", i = t.padding ?? "default", c = t.headerActions ?? [], s = t.child, u = n != null || c.length > 0;
  return /* @__PURE__ */ e.createElement("div", { id: l, className: `tlCard tlCard--${r}` }, u && /* @__PURE__ */ e.createElement("div", { className: "tlCard__header" }, n && /* @__PURE__ */ e.createElement("span", { className: "tlCard__title" }, n), c.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlCard__headerActions" }, c.map((a, o) => /* @__PURE__ */ e.createElement(U, { key: o, control: a })))), /* @__PURE__ */ e.createElement("div", { className: `tlCard__body tlCard__body--pad-${i}` }, /* @__PURE__ */ e.createElement(U, { control: s })));
}, Nn = ({ controlId: l }) => {
  const t = G(), n = t.title ?? "", r = t.leading, i = t.children ?? [], c = t.actions ?? [], s = t.variant ?? "flat", a = [
    "tlAppBar",
    `tlAppBar--${t.color ?? "primary"}`,
    s === "elevated" ? "tlAppBar--elevated" : ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ e.createElement("header", { id: l, className: a }, r && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__leading" }, /* @__PURE__ */ e.createElement(U, { control: r })), /* @__PURE__ */ e.createElement("h1", { className: "tlAppBar__title" }, n), i.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__children" }, i.map((o, m) => /* @__PURE__ */ e.createElement(U, { key: m, control: o }))), c.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlAppBar__actions" }, c.map((o, m) => /* @__PURE__ */ e.createElement(U, { key: m, control: o }))));
  ...
  return st(() => {
    ...
    /* @__PURE__ */ e.createElement(U, { control: c })
  ) : null;
}, { useEffect: Mn, useRef: Pn } = e, jn = ({ controlId: l }) => {
  const n = G().dialogs ?? [], r = Pn(n.length);
  return Mn(() => {
    n.length < r.current && n.length > 0, r.current = n.length;
  }, [n.length]), n.length === 0 ? null : /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDialogManager" }, n.map((i) => /* @__PURE__ */ e.createElement(U, { key: i.controlId, control: i })));
  ...
  const t = G(), n = ne(), r = ae(An), i = t.title ?? "", c = t.width ?? "32rem", s = t.height ?? null, u = t.minHeight ?? null, a = t.resizable === !0, o = t.child, m = t.actions ?? [], p = t.toolbar, h = t.buttonBar, [N, f] = Ie(null), [T, w] = Ie(null), [v, C] = Ie(null), D = Ce(null), [M, _] = Ie(!1), b = Ce(null), E = Ce(null), W = Ce(null), k = Ce(null), S = Ce(null), B = De(() => {
    n("close");
  }, [n]), x = De((J, A) => {
    A.preventDefault();
    const j = k.current;
    if (!j) return;
    const V = j.getBoundingClientRect(), d = !D.current, y = D.current ?? { x: V.left, y: V.top };
    ...
    const F = (K) => {
      const P = S.current;
      if (!P) return;
      const X = K.clientX - P.startX, te = K.clientY - P.startY;
      ...
      const K = E.current, P = W.current;
      (K != null || P != null) && n("resize", {
        ...K != null ? { width: Math.round(K) + "px" } : {},
    ...
    const A = k.current;
    if (!A) return;
    const j = A.getBoundingClientRect(), V = D.current ?? { x: j.left, y: j.top }, d = J.clientX - V.x, y = J.clientY - V.y, F = (K) => {
      const P = window.innerWidth, X = window.innerHeight;
      let te = K.clientX - d, ee = K.clientY - y;
    ...
    if (M) {
      ...
      const j = k.current, V = j == null ? void 0 : j.getBoundingClientRect();
      b.current = {
        x: ((J = D.current) == null ? void 0 : J.x) ?? (V == null ? void 0 : V.left) ?? -1,
        y: ((A = D.current) == null ? void 0 : A.y) ?? (V == null ? void 0 : V.top) ?? -1,
        w: N ?? (V == null ? void 0 : V.width) ?? null,
        h: T ?? null
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      ...
      p && /* @__PURE__ */ e.createElement("div", { className: "tlWindow__toolbar" }, /* @__PURE__ */ e.createElement(U, { control: p })),
      /* @__PURE__ */ e.createElement(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlWindow__body" }, /* @__PURE__ */ e.createElement(U, { control: o })),
    (m.length > 0 || h) && /* @__PURE__ */ e.createElement("div", { className: "tlWindow__footer" }, h && /* @__PURE__ */ e.createElement(U, { control: h }), m.map((J, A) => /* @__PURE__ */ e.createElement(U, { key: A, control: J }))),
  ...
  )), /* @__PURE__ */ e.createElement("div", { className: "tlDrawer__body" }, a && /* @__PURE__ */ e.createElement(U, { control: a })));
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tl-context-menu-region", onContextMenu: i }, r && /* @__PURE__ */ e.createElement(U, { control: r }));
  ...
  ze(() => {
    ...
    let _ = M.bottom + 4, b = M.left;
    _ + v > window.innerHeight && (_ = M.top - v - 4), b + C > window.innerWidth && (b = M.right - C), m({ top: _, left: b }), h(0);
  }, [r, i, c, s]);
  const f = We(() => {
    n("close");
  }, [n]), T = We((v) => {
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlAppShell" }, n && /* @__PURE__ */ e.createElement("div", { className: "tlAppShell__header" }, /* @__PURE__ */ e.createElement(U, { control: n })), /* @__PURE__ */ e.createElement("div", { className: "tlAppShell__content" }, /* @__PURE__ */ e.createElement(U, { control: r })), i && /* @__PURE__ */ e.createElement("div", { className: "tlAppShell__footer" }, /* @__PURE__ */ e.createElement(U, { control: i })), /* @__PURE__ */ e.createElement(U, { control: c }), s && /* @__PURE__ */ e.createElement(U, { control: s }), u && /* @__PURE__ */ e.createElement(U, { control: u }));
}, Qn = ({ controlId: l }) => {
  ...
  const c = t.columns ?? [], s = t.totalRowCount ?? 0, u = t.rows ?? [], a = t.rowHeight ?? 36, o = t.selectionMode ?? "single", m = t.selectedCount ?? 0, p = t.frozenColumnCount ?? 0, h = t.treeMode ?? !1, N = e.useMemo(
    ...
    [c]
  ), f = o === "multi", T = 40, w = 20, v = e.useRef(null), C = e.useRef(null), D = e.useRef(null), [M, _] = e.useState({}), b = e.useRef(null), E = e.useRef(!1), W = e.useRef(null), [k, S] = e.useState(null), [B, x] = e.useState(null);
  e.useEffect(() => {
    b.current || _({});
  }, [c]);
  const $ = e.useCallback((R) => M[R.name] ?? R.width, [M]), q = e.useMemo(() => {
    ...
    g.preventDefault(), g.stopPropagation(), b.current = { column: R, startX: g.clientX, startWidth: I };
    let L = g.clientX, H = 0;
    const Z = () => {
      const oe = b.current;
      if (!oe) return;
    ...
    const Ee = (oe) => {
      ...
      document.removeEventListener("mousemove", Ee), document.removeEventListener("mouseup", Le), Q.current !== null && (cancelAnimationFrame(Q.current), Q.current = null);
      const pe = b.current;
      if (pe) {
        const ge = Math.max(it, pe.startWidth + (oe.clientX - pe.startX) + H);
    ...
    /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement("div", { style: { height: le, position: "relative", width: ue } }, u.map((R) => /* @__PURE__ */ e.createElement(
        ...
        c.map((I, g) => {
          ...
          Z && (Ee += " tlTableView__cell--frozen"), re && (Ee += " tlTableView__cell--frozenLast");
          ...
          return /* @__PURE__ */ e.createElement(
            ...
            Le ? /* @__PURE__ */ e.createElement("div", { className: "tlTableView__treeCell", style: { paddingLeft: oe * w } }, R.expandable ? /* @__PURE__ */ e.createElement(
              ...
              R.expanded ? "▾" : "▸"
            ) : /* @__PURE__ */ e.createElement("span", { className: "tlTableView__treeToggleSpacer" }), /* @__PURE__ */ e.createElement(U, { control: R.cells[I.name] })) : /* @__PURE__ */ e.createElement(U, { control: R.cells[I.name] })
          );
        })
      )))
    ),
  ...
  ), i && /* @__PURE__ */ e.createElement("span", { className: "tlFormGroup__title" }, /* @__PURE__ */ e.createElement(U, { control: i })), c.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlFormGroup__actions" }, c.map((f, T) => /* @__PURE__ */ e.createElement(U, { key: T, control: f })))), /* @__PURE__ */ e.createElement("div", { className: "tlFormGroup__body" }, m.map((f, T) => /* @__PURE__ */ e.createElement(U, { key: T, control: f }))));
}, { useContext: dl, useState: ml, useCallback: pl } = e, fl = ({ controlId: l }) => {
  const t = G(), n = dl(gt), r = t.label ?? "", i = t.required === !0, c = t.error, s = t.warnings, u = t.helpText, a = t.dirty === !0, o = t.labelPosition ?? n.resolvedLabelPosition, m = t.fullLine === !0, p = t.visible !== !1, h = t.hasTooltip === !0, N = t.field, f = n.readOnly, [T, w] = ml(!1), v = pl(() => w((_) => !_), []);
  if (!p) return null;
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: M }, /* @__PURE__ */ e.createElement("div", { className: "tlFormField__label" }, /* @__PURE__ */ e.createElement(
  ...
  )), /* @__PURE__ */ e.createElement("div", { className: "tlFormField__input" }, /* @__PURE__ */ e.createElement(U, { control: N })), !f && C && /* @__PURE__ */ e.createElement("div", { className: "tlFormField__error", role: "alert" }, /* @__PURE__ */ e.createElement(
    "svg",
    {
  ...
  ), /* @__PURE__ */ e.createElement("span", null, c)), !f && !C && D && /* @__PURE__ */ e.createElement("div", { className: "tlFormField__warnings", "aria-live": "polite" }, s.map((_, b) => /* @__PURE__ */ e.createElement("div", { key: b, className: "tlFormField__warning" }, /* @__PURE__ */ e.createElement(
    "svg",
    {
    ...
    /* @__PURE__ */ e.createElement("line", { x1: "8", y1: "6", x2: "8", y2: "10", stroke: "currentColor", strokeWidth: "1.2" }),
    /* @__PURE__ */ e.createElement("circle", { cx: "8", cy: "12", r: "0.8", fill: "currentColor" })
  ), /* @__PURE__ */ e.createElement("span", null, _)))), !f && u && T && /* @__PURE__ */ e.createElement("div", { className: "tlFormField__helpText" }, u));
}, hl = ({ controlId: l }) => {
  ...
  const l = G(), t = ne(), n = l.nodes ?? [], r = l.selectionMode ?? "single", i = l.dragEnabled ?? !1, c = l.dropEnabled ?? !1, s = l.dropIndicatorNodeId ?? null, u = l.dropIndicatorPosition ?? null, [a, o] = e.useState(-1), m = e.useRef(null), p = e.useCallback((_, b) => {
  ...
  }, [t]), N = e.useCallback((_, b) => {
    b.preventDefault(), t("contextMenu", { nodeId: _, x: b.clientX, y: b.clientY });
  }, [t]), f = e.useRef(null), T = e.useCallback((_, b) => {
    const E = b.getBoundingClientRect(), W = _.clientY - E.top, k = E.height / 3;
    ...
    switch (_.key) {
      case "ArrowDown":
        _.preventDefault(), b = Math.min(a + 1, n.length - 1);
        break;
      case "ArrowUp":
        _.preventDefault(), b = Math.max(a - 1, 0);
        break;
      case "ArrowRight":
    ...
    n.map((_, b) => /* @__PURE__ */ e.createElement(
      "li",
      {
        ...
        className: [
          ...
          b === a ? "tlTreeView__node--focused" : "",
          s === _.id && u === "above" ? "tlTreeView__node--drop-above" : "",
          s === _.id && u === "within" ? "tlTreeView__node--drop-within" : "",
          s === _.id && u === "below" ? "tlTreeView__node--drop-below" : ""
        ].filter(Boolean).join(" "),
        style: { paddingLeft: _.depth * bl },
        draggable: i,
        onClick: (E) => h(_.id, E),
        onContextMenu: (E) => N(_.id, E),
        onDragStart: (E) => w(_.id, E),
        onDragOver: c ? (E) => v(_.id, E) : void 0,
        onDrop: c ? (E) => C(_.id, E) : void 0,
        onDragEnd: D
      },
      ...
      /* @__PURE__ */ e.createElement("span", { className: "tlTreeView__content" }, /* @__PURE__ */ e.createElement(U, { control: _.content }))
    ))
  );
};
...
function vl() {
  ...
  function Q(d, y, F, O, K) {
    ...
    if (X)
      return K = K(d), X = O === "" ? "." + q(d, 0) : O, _(K) ? (F = "", X != null && (F = X.replace($, "$&/") + "/"), Q(K, y, F, "", function(ie) {
        return ie;
      })) : K != null && (B(K) && (K = S(
        K,
  ...
  return Y.Activity = p, Y.Children = V, Y.Component = v, Y.Fragment = n, Y.Profiler = i, Y.PureComponent = D, Y.StrictMode = r, Y.Suspense = a, Y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = E, Y.__COMPILER_RUNTIME = {
    __proto__: null,
    c: function(d) {
    ...
    var O = T({}, d.props), K = d.key;
    if (y != null)
      for (P in y.key !== void 0 && (K = "" + y.key), y)
    ...
    if (y != null)
      for (O in y.key !== void 0 && (P = "" + y.key), y)
        W.call(y, O) && O !== "key" && O !== "__self" && O !== "__source" && (K[O] = y[O]);
    ...
    try {
      var O = d(), K = E.S;
      K !== null && K(F, O), typeof O == "object" && O !== null && typeof O.then == "function" && O.then(b, j);
    } catch (P) {
      j(P);
    } finally {
...
const Sl = ({ controlId: l, state: t }) => {
  const n = ne(), r = t.value ?? [], i = t.multiSelect === !0, c = t.customOrder === !0, s = t.mandatory === !0, u = t.disabled === !0, a = t.editable !== !1, o = t.optionsLoaded === !0, m = t.options ?? [], p = t.emptyOptionLabel ?? "", h = c && i && !u && a, N = ae({
    ...
    [N]
  ), [w, v] = _e(!1), [C, D] = _e(""), [M, _] = _e(-1), [b, E] = _e(!1), [W, k] = _e({}), [S, B] = _e(null), [x, $] = _e(null), [q, le] = _e(null), Q = Te(null), J = Te(null), A = Te(null), j = Te(r);
  j.current = r;
  const V = Te(-1), d = Ze(
  ...
  const F = ce(async () => {
    ...
    var g;
    v(!1), D(""), _(-1), (g = Q.current) == null || g.focus();
  }, []), K = ce(
    (g) => {
      let L;
      if (i) {
      ...
      j.current = L, n("valueChanged", { value: L.map((H) => H.value) }), i ? (D(""), _(-1)) : O();
    },
    [i, m, n, O]
  ), P = ce(
    (g) => {
      V.current = j.current.findIndex((H) => H.value === g);
    ...
    (g) => {
      ...
      switch (g.key) {
        case "ArrowDown":
          g.preventDefault(), g.stopPropagation(), _(
        ...
        case "ArrowUp":
          ...
          break;
        case "Enter":
          g.preventDefault(), g.stopPropagation(), M >= 0 && M < y.length && K(y[M].value);
          break;
        case "Escape":
  ...
  const R = !s && r.length > 0 && !u, I = w ? /* @__PURE__ */ e.createElement(
    ...
    (o || b) && /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__searchWrapper" }, /* @__PURE__ */ e.createElement("span", { className: "tlDropdownSelect__searchIcon", "aria-hidden": "true" }, "🔍"), /* @__PURE__ */ e.createElement(
      "input",
      {
        ref: J,
        type: "text",
    ...
    /* @__PURE__ */ e.createElement(
      ...
      !o && !b && /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__loading" }, /* @__PURE__ */ e.createElement("span", { className: "tlDropdownSelect__spinner" })),
      b && /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__error" }, /* @__PURE__ */ e.createElement("a", { href: "#", onClick: ie }, N["js.dropdownSelect.error"])),
...
const { useCallback: we, useRef: ft } = e, Dl = ({ color: l, onColorChange: t }) => {
  const [n, r, i] = Ll(l), c = ft(null), s = ft(null), u = we(
    (f, T) => {
      var D;
...
const Ml = {
  ...
  jl(() => {
    ...
    let V = A.bottom + 4, d = A.left;
    V + j.height > window.innerHeight && (V = A.top - j.height - 4), d + j.width > window.innerWidth && (d = Math.max(0, A.right - j.width)), w({ top: V, left: d });
  }, [l]);
  const v = p != null, [C, D, M] = v ? wt(p) : [0, 0, 0], [_, b] = Me((p == null ? void 0 : p.toUpperCase()) ?? "");
  Ge(() => {
    ...
    const A = (V) => {
      N.current && !N.current.contains(V.target) && u();
  ...
  const E = fe(
    (A) => (j) => {
      const V = parseInt(j.target.value, 10);
      if (isNaN(V)) return;
      const d = yt(V);
      ...
      r && M.map(
        (x) => x.variants.map(($) => /* @__PURE__ */ e.createElement(
          "div",
          {
            ...
            tabIndex: 0,
            title: x.label,
            onClick: () => a === "simple" ? b($.encoded) : E($.encoded),
            onKeyDown: (q) => {
              (q.key === "Enter" || q.key === " ") && (q.preventDefault(), a === "simple" ? b($.encoded) : E($.encoded));
            }
          },
          /* @__PURE__ */ e.createElement(Se, { encoded: $.encoded })
        ))
      )
    ),
...
const lr = ({ controlId: l }) => {
  const t = G(), n = ne(), r = t.minColWidth ?? "16rem", i = (t.children ?? []).filter((b) => b && b.id), c = ql(null), [s, u] = Xe(1), a = t.editMode === !0;
  Xl(() => {
    const b = c.current;
    if (!b) return;
    const E = parseFloat(getComputedStyle(document.documentElement).fontSize) || 16, W = Jl(r, E), k = () => u(er(b.clientWidth, W));
    k();
    const S = new ResizeObserver(k);
    return S.observe(b), () => S.disconnect();
  }, [r]);
  const o = bt(() => nr(i, s), [i, s]), m = bt(() => {
    const b = {};
    for (const E of o) b[E.id] = E;
    return b;
  }, [o]), [p, h] = Xe(null), [N, f] = Xe(null), T = ke((b, E) => {
    if (!a) {
      b.preventDefault();
      return;
    }
    ...
    if (!a || !p || p === E) return;
    b.preventDefault(), b.dataTransfer.dropEffect = "move";
    const W = b.currentTarget.getBoundingClientRect(), k = b.clientX < W.left + W.width / 2;
    f((S) => S && S.id === E && S.before === k ? S : { id: E, before: k });
  }, [a, p]), v = ke(() => {
  }, []), C = ke((b, E, W) => {
    const k = i.map(($) => $.id), S = k.indexOf(b);
    if (S < 0) return;
    k.splice(S, 1);
    const B = k.indexOf(E);
    if (B < 0) {
    ...
    const x = W ? B : B + 1;
    k.splice(x, 0, b), n("reorder", { order: k });
  }, [i, n]), D = ke((b, E) => {
    if (!a || !p || p === E) return;
    b.preventDefault();
    const W = b.currentTarget.getBoundingClientRect(), k = b.clientX < W.left + W.width / 2;
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDashboard__grid", style: _ }, i.map((b) => {
      ...
      return p === b.id && k.push("tlDashboard__tile--dragging"), N && N.id === b.id && k.push(N.before ? "tlDashboard__tile--dropBefore" : "tlDashboard__tile--dropAfter"), /* @__PURE__ */ e.createElement(
        "div",
        {
          key: b.id,
          className: k.join(" "),
          style: W,
          draggable: a,
          onDragStart: (S) => T(S, b.id),
          onDragOver: (S) => w(S, b.id),
          onDragLeave: v,
          onDrop: (S) => D(S, b.id),
          onDragEnd: M
        },
        /* @__PURE__ */ e.createElement(U, { control: b.control }),
  ...
  return t.length === 0 ? null : /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--inline" }, t.map((n, r) => /* @__PURE__ */ e.createElement("span", { key: r, className: "tlToolbar__item" }, /* @__PURE__ */ e.createElement(U, { control: n }))));
}, sr = ({ group: l }) => {
  var u, a;
  const [t, n] = or(!1), r = _t(null), i = _t(null), c = rr(() => {
    n((o) => !o);
  }, []);
  vt(() => {
    if (!t) return;
  ...
  return s.length === 0 ? null : s.length === 1 && !((u = l.subGroups) != null && u.length) ? /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--inline" }, /* @__PURE__ */ e.createElement("span", { className: "tlToolbar__item" }, /* @__PURE__ */ e.createElement(U, { control: s[0] }))) : /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--menu" }, /* @__PURE__ */ e.createElement(
    "button",
    {
      ref: r,
      type: "button",
    ...
    s.map((o, m) => /* @__PURE__ */ e.createElement("div", { key: m, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(U, { control: o }))),
    (a = l.subGroups) == null ? void 0 : a.map((o, m) => /* @__PURE__ */ e.createElement(e.Fragment, { key: `sub-${m}` }, /* @__PURE__ */ e.createElement("hr", { className: "tlToolbar__dropdownSeparator" }), o.items.map((p, h) => /* @__PURE__ */ e.createElement("div", { key: h, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(U, { control: p })))))
  ));
}, cr = ({ controlId: l }) => {
  ...
  const t = G();
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlTileStack", style: { width: "100%", height: "100%" } }, t.frame && /* @__PURE__ */ e.createElement(U, { control: t.frame }));
}, ur = ({ controlId: l }) => {
  const n = G().children ?? [];
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlSlot" }, n.map((r, i) => /* @__PURE__ */ e.createElement(U, { key: i, control: r })));
