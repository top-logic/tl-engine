...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Border}.
 */
public class Border_Impl extends com.top_logic.react.flow.data.impl.Decoration_Impl implements com.top_logic.react.flow.data.Border {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Border#create()
	 */
	public Border_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Border setStrokeStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setThickness(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setDashes(java.util.List<? extends Double> value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border addDash(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setTop(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setLeft(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setBottom(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setRight(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.Border setContent(com.top_logic.react.flow.data.Box value) {
		internalSetContent(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Border setRenderInfo(java.lang.Object value) {
