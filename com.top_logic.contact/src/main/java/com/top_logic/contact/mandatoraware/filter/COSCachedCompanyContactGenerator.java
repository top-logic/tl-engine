...
/**
 * Generate {@link CompanyContact}s that are bound to a part of {@link Mandator}-Structure.
 * 
 * @author <a href=mailto:kbu@top-logic.com>kbu</a>
 */
public class COSCachedCompanyContactGenerator extends MandatorAwareContactGenerator {

	private static final Filter<? super Object> COMPANY_CONTACT_FILTER = FilterFactory
		.createClassFilter(CompanyContact.class);

	@Override
	protected Filter<? super TLObject> getFilter() {
		return COMPANY_CONTACT_FILTER;
	}
