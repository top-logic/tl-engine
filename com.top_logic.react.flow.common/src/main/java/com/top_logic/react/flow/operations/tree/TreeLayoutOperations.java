...
import com.top_logic.react.flow.operations.layout.FloatingLayoutOperations;
import com.top_logic.react.flow.operations.tree.TreeRenderInfo.GridInfo;
	...
	default void computeIntrinsicSize(RenderContext context, double offsetX, double offsetY,
		...
		TreeRenderInfo renderInfo =
			new TreeRenderInfo(
				...
				self().isRowWise(), self().getSubGridCols(), self().getSubGridStartCol(),
				self().getBridgeGapY(),
