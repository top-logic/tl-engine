...
function Re({ encoded: l, className: t }) {
  if (l.startsWith("css:")) {
...
const { useCallback: $t } = e, Ot = ({ controlId: l, command: t, label: n, image: r, disabled: i, displayMode: c }) => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    C && m && /* @__PURE__ */ e.createElement(Re, { encoded: m, className: "tlReactButton__image" }),
...
const Se = ({ icon: l }) => l ? /* @__PURE__ */ e.createElement("i", { className: "tlSidebar__icon " + l, "aria-hidden": "true" }) : null, _n = ({ item: l, active: t, collapsed: n, onSelect: r, tabIndex: i, itemRef: c, onFocus: s }) => /* @__PURE__ */ e.createElement(
  "button",
  {
...
), vn = ({ item: l, collapsed: t }) => t && !l.icon ? null : /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerItem", title: t ? l.label : void 0 }, /* @__PURE__ */ e.createElement(Se, { icon: l.icon }), !t && /* @__PURE__ */ e.createElement("span", { className: "tlSidebar__label" }, l.label)), En = () => /* @__PURE__ */ e.createElement("hr", { className: "tlSidebar__separator" }), gn = ({ item: l, activeItemId: t, anchorRect: n, onSelect: r, onExecute: i, onClose: c }) => {
  const s = Oe(null);
  $e(() => {
    const o = (m) => {
...
var yl = Cl();
const { useState: be, useCallback: ce, useRef: Ne, useEffect: ye, useMemo: Ze } = e;
function tt({ image: l }) {
  if (!l) return null;
  if (l.startsWith("/"))
...
const Sl = ({ controlId: l, state: t }) => {
  const n = ne(), r = t.value ?? [], i = t.multiSelect === !0, c = t.customOrder === !0, s = t.mandatory === !0, u = t.disabled === !0, a = t.editable !== !1, o = t.optionsLoaded === !0, m = t.options ?? [], p = t.emptyOptionLabel ?? "", h = c && i && !u && a, N = ae({
    ...
    [N]
  ), [w, v] = be(!1), [C, D] = be(""), [M, b] = be(-1), [_, E] = be(!1), [W, k] = be({}), [S, B] = be(null), [x, $] = be(null), [q, le] = be(null), Q = Ne(null), J = Ne(null), A = Ne(null), j = Ne(r);
  j.current = r;
  const U = Ne(-1), d = Ze(
...
const Ml = {
...
}, { useState: Te, useCallback: ve, useEffect: je, useRef: ht, useLayoutEffect: Hl, useMemo: Wl } = e, zl = {
  ...
  const u = ae(zl), [a, o] = Te("simple"), [m, p] = Te(""), [h, N] = Te(t ?? ""), [f, T] = Te(!1), [w, v] = Te(null), C = ht(null), D = ht(null);
  Hl(() => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      ...
      r && M.map(
        (x) => x.variants.map(($) => /* @__PURE__ */ e.createElement(
          ...
          /* @__PURE__ */ e.createElement(Re, { encoded: $.encoded })
        ))
      )
    ),
    ...
    )), /* @__PURE__ */ e.createElement("div", { className: "tlIconSelect__previewArea" }, /* @__PURE__ */ e.createElement("span", { className: "tlIconSelect__editLabel" }, u["js.iconSelect.previewLabel"]), /* @__PURE__ */ e.createElement("div", { className: "tlIconSelect__previewIcon" }, h && /* @__PURE__ */ e.createElement(Re, { encoded: h })), /* @__PURE__ */ e.createElement("span", { className: "tlIconSelect__previewLabel" }, h ? h.startsWith("css:") ? h.substring(4) : h : ""))),
  ...
  return a ? /* @__PURE__ */ e.createElement("span", { id: l, className: "tlIconSelect" }, /* @__PURE__ */ e.createElement(
    ...
    u ? /* @__PURE__ */ e.createElement(Re, { encoded: u }) : /* @__PURE__ */ e.createElement("i", { className: "fa-solid fa-icons" })
  ), i && /* @__PURE__ */ e.createElement(
    Ul,
    {
      anchorRef: s,
  ...
  )) : /* @__PURE__ */ e.createElement("span", { id: l, className: "tlIconSelect tlIconSelect--immutable" }, /* @__PURE__ */ e.createElement("span", { className: "tlIconSelect__swatch" }, u ? /* @__PURE__ */ e.createElement(Re, { encoded: u }) : null));
...
const lr = ({ controlId: l }) => {
  ...
  return s.length === 0 ? null : s.length === 1 && !((u = l.subGroups) != null && u.length) ? /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--inline" }, /* @__PURE__ */ e.createElement("span", { className: "tlToolbar__item" }, /* @__PURE__ */ e.createElement(K, { control: s[0] }))) : /* @__PURE__ */ e.createElement("div", { className: "tlToolbar__group tlToolbar__group--menu" }, /* @__PURE__ */ e.createElement(
    ...
    l.icon && /* @__PURE__ */ e.createElement("i", { className: l.icon, "aria-hidden": "true" }),
  ...
  ), t && /* @__PURE__ */ e.createElement("div", { ref: i, className: "tlToolbar__dropdown", role: "menu" }, s.map((o, m) => /* @__PURE__ */ e.createElement("div", { key: m, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(K, { control: o }))), (a = l.subGroups) == null ? void 0 : a.map((o, m) => /* @__PURE__ */ e.createElement(e.Fragment, { key: `sub-${m}` }, /* @__PURE__ */ e.createElement("hr", { className: "tlToolbar__dropdownSeparator" }), o.items.map((p, h) => /* @__PURE__ */ e.createElement("div", { key: h, className: "tlToolbar__dropdownItem", role: "menuitem" }, /* @__PURE__ */ e.createElement(K, { control: p })))))));
}, cr = ({ controlId: l }) => {
