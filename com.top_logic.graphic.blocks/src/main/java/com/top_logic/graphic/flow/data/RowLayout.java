 ...
 */
public interface RowLayout extends com.top_logic.graphic.flow.data.Layout {
	...
	@Override
	com.top_logic.graphic.flow.data.RowLayout setRenderInfo(java.lang.Object value);
