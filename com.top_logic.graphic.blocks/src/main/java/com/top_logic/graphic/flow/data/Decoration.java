...
public interface Decoration extends Box, com.top_logic.graphic.flow.operations.DecorationOperations {
	...
	public interface Visitor<R,A,E extends Throwable> {
		...
		/** Visit case for {@link com.top_logic.graphic.flow.data.ContextMenu}.*/
		R visit(com.top_logic.graphic.flow.data.ContextMenu self, A arg) throws E;

		/** Visit case for {@link com.top_logic.graphic.flow.data.DropRegion}.*/
		R visit(com.top_logic.graphic.flow.data.DropRegion self, A arg) throws E;

		/** Visit case for {@link com.top_logic.graphic.flow.data.Tooltip}.*/
		R visit(com.top_logic.graphic.flow.data.Tooltip self, A arg) throws E;
	...
	@Override
	com.top_logic.graphic.flow.data.Decoration setRenderInfo(java.lang.Object value);
