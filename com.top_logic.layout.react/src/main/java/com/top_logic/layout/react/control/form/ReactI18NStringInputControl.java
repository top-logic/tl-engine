 ...
 * a {@link ResKey} that <b>preserves the values of the other locales</b>, so the model receives a
 * typed {@link ResKey} (a plain {@link String} would be rejected by the I18N storage mapping).
 * </p>
 *
