...
public interface ClickTargetOperations extends DecorationOperations, SVGClickHandler {
	...
	default void onClick(SVGClickEvent event) {
		...
		for (MouseButton button : expectedButtons) {
			com.top_logic.react.flow.svg.event.MouseButton svgButton;
			switch (button) {
				case LEFT:
					svgButton = com.top_logic.react.flow.svg.event.MouseButton.LEFT;
					break;
				case MIDDLE:
					svgButton = com.top_logic.react.flow.svg.event.MouseButton.MIDDLE;
					break;
				case RIGHT:
					svgButton = com.top_logic.react.flow.svg.event.MouseButton.RIGHT;
					break;
				default:
