...
public class LDAPUserMapping extends AbstractConfiguredInstance<LDAPUserMapping.Config> implements ExternalUserMapping {
	...
	@Override
	public Person findPersonForExternalName(String externalUserName) throws LoginDeniedException {
		Person authenticatedPerson = ExternalUserMapping.findValidPerson(externalUserName);
		if (!Utils.equals(getConfig().getLDAP(), authenticatedPerson.getAuthenticationDeviceID())) {
