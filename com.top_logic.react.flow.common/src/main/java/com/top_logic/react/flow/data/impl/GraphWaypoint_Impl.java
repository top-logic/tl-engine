...
/**
 * Implementation of {@link com.top_logic.react.flow.data.GraphWaypoint}.
 */
public class GraphWaypoint_Impl extends de.haumacher.msgbuf.graph.AbstractSharedGraphNode implements com.top_logic.react.flow.data.GraphWaypoint {
	...
	/**
	 * Creates a {@link GraphWaypoint_Impl} instance.
	 *
	 * @see com.top_logic.react.flow.data.GraphWaypoint#create()
	 */
	public GraphWaypoint_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.GraphWaypoint setX(double value) {
		internalSetX(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.GraphWaypoint setY(double value) {
		internalSetY(value);
		return this;
	}
