 ...
 * {@link ExportExecutor} of type {@link ExportHandler#TECHNOLOGY_POWERPOINT}.
 * 
 * @author    <a href=mailto:fsc@top-logic.com>fsc</a>
 */
public abstract class AbstractPowerpointExportHandler extends AbstractExportHandler {

	public AbstractPowerpointExportHandler(String anExportID) {
		super(anExportID);
	}
