import { React as e, useTLFieldValue as De, useTLCommand as ne, useTLState as X, useKeyboardBinding as me, useTLUpload as Ge, useFill as Ct, FillBarrier as Pe, TLChild as G, useI18N as ue, useTLDataUrl as Xe, scrollToAnchor as Zn, useStandaloneKeyboardScope as Oe, useFillHost as rt, FillProvider as ot, KeyboardScopeProvider as Yt, useFocusTrap as Gt, CMD_VALUE_CHANGED as ct, anchoredOverlayProps as Qn, register as U } from "tl-react-bridge";
...
const { useCallback: bl } = e, gl = ({ controlId: l, command: t, label: n, image: a, disabled: o, displayMode: u }) => {
  const s = X(), i = ne(), r = t ?? "click", c = n ?? s.label, d = a ?? s.image, m = o ?? s.disabled === !0, p = s.active === !0, h = u ?? s.displayMode ?? "label-only", g = s.hidden === !0, N = s.tooltip, C = s.appearance, E = s.size, y = s.cssClasses, k = s.navigateUrl, x = bl(() => {
    if (k) {
      window.location.assign(k);
      return;
    }
    i(r);
  }, [i, r, k]), v = s.keyGesture;
  me(v, () => m || g ? !1 : (x(), !0));
  const w = h === "icon-only", b = h === "label-only" || h === "icon-label" || w && !d, D = N ?? (w ? c : void 0), j = D ? `text:${D}` : void 0;
  return g ? null : /* @__PURE__ */ e.createElement(
    "button",
    {
      ...
      onClick: x,
      disabled: m,
      className: "tlReactButton" + (w ? " tlReactButton--iconOnly" : "") + (h === "label-only" ? " tlReactButton--labelOnly" : "") + (C === "link" ? " tlReactButton--link" : "") + (C === "primary" ? " tlReactButton--primary" : "") + (E === "small" ? " tlReactButton--small" : "") + (E === "large" ? " tlReactButton--large" : "") + (p ? " tlReactButton--active" : "") + (y ? " " + y : ""),
      "data-tooltip": j,
      "aria-pressed": p ? !0 : void 0,
      "aria-label": d || w ? c : void 0
    },
    d && /* @__PURE__ */ e.createElement(Ne, { encoded: d, className: "tlReactButton__image" }),
    b && /* @__PURE__ */ e.createElement("span", { className: "tlReactButton__label" }, c)
  );
}, vl = ({ controlId: l }) => {
  const t = X(), n = Ge(), a = e.useRef(null), [o, u] = e.useState(!1), s = t.label ?? "", i = t.image, r = t.disabled === !0, c = t.hidden === !0, d = t.displayMode ?? "label-only", m = t.appearance, p = t.accept, h = t.multiple === !0, g = e.useCallback(() => {
    var x;
  ...
  }, [n]), C = d === "icon-only", E = d === "icon-only" || d === "icon-label", y = d === "label-only" || d === "icon-label" || C && !i, k = r || o;
  return /* @__PURE__ */ e.createElement("span", { id: l, style: { display: "contents" } }, /* @__PURE__ */ e.createElement(
    ...
    E && i && /* @__PURE__ */ e.createElement(Ne, { encoded: i, className: "tlReactButton__image" }),
    y && /* @__PURE__ */ e.createElement("span", { className: "tlReactButton__label" }, s)
  ));
}, { useCallback: El } = e, _l = ({ controlId: l, command: t, label: n, active: a, disabled: o }) => {
  const u = X(), s = ne(), i = t ?? "click", r = n ?? u.label, c = a ?? u.active === !0, d = o ?? u.disabled === !0, m = El(() => {
    s(i);
  }, [s, i]);
  return /* @__PURE__ */ e.createElement(
    "button",
    {
      ...
      className: "tlReactButton" + (c ? " tlReactButton--active" : "")
    },
    r
  );
}, Cl = ({ controlId: l }) => {
  ...
  const t = X(), n = ne(), a = Ct(!0), o = t.tabs ?? [], u = t.activeTabId, s = yl((i) => {
    ...
    if (a !== "uploading") {
      ...
      try {
        ...
        i.current = x, x.ondataavailable = (v) => {
          ...
          o("uploading");
          const w = new FormData();
          w.append("audio", v, "recording.webm"), await n(w), o("idle");
        }, x.start(), o("recording");
      } catch (y) {
        console.error("[TLAudioRecorder] Microphone access denied or unavailable:", y), s("js.audioRecorder.error.denied"), o("idle");
      }
    }
  }, [a, n]), g = ue(Nl), N = p === "recording" ? g["js.audioRecorder.stop"] : p === "uploading" ? g["js.uploading"] : g["js.audioRecorder.record"], C = p === "uploading", E = ["tlAudioRecorder__button"];
  ...
  const t = X(), n = Ge(), [a, o] = e.useState("idle"), [u, s] = e.useState(!1), i = e.useRef(null), r = t.status ?? "idle", c = t.error, d = t.accept ?? "", m = r === "received" ? "idle" : a !== "idle" ? a : r, p = e.useCallback(async (v) => {
    o("uploading");
    const w = new FormData();
    w.append("file", v, v.name), await n(w), o("idle");
  }, [n]), h = e.useCallback((v) => {
    var b;
    const w = (b = v.target.files) == null ? void 0 : b[0];
    w && p(w);
  }, [p]), g = e.useCallback(() => {
    var v;
    ...
    const w = (b = v.dataTransfer.files) == null ? void 0 : b[0];
    w && p(w);
  ...
  const a = X() ?? t ?? {}, o = Ge(), u = Xe(), s = ue(xl), i = a.editable !== !1, r = !!a.hasData, c = a.fileName ?? "download", d = a.dataRevision ?? 0, m = a.accept ?? "", p = a.status ?? "idle", h = a.error ?? null, [g, N] = e.useState("idle"), [C, E] = e.useState(!1), [y, k] = e.useState(!1), x = e.useRef(null), v = e.useCallback(async () => {
    if (!(!r || y)) {
      k(!0);
      try {
    ...
    I.preventDefault(), I.stopPropagation(), E(!0);
  }, []), H = e.useCallback((I) => {
    I.preventDefault(), I.stopPropagation(), E(!1);
  }, []), K = e.useCallback((I) => {
    var S;
    if (I.preventDefault(), I.stopPropagation(), E(!1), b) return;
...
const Pl = ({ controlId: l }) => {
  const t = X(), n = ne(), a = Ge(), o = Xe(), u = ue(Il), s = t.chips ?? [], i = t.editable === !0, [r, c] = e.useState(!1), [d, m] = e.useState(!1), p = e.useRef(null), h = e.useCallback(async (v) => {
  ...
  }, [a]), g = e.useCallback(async (v) => {
    if (v.hasData)
      try {
        const w = o + "&key=" + encodeURIComponent(v.key), b = await fetch(w);
        if (!b.ok) {
        ...
        R.href = j, R.download = v.name, R.style.display = "none", document.body.appendChild(R), R.click(), document.body.removeChild(R), URL.revokeObjectURL(j);
      } catch (w) {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    s.map((v) => {
      const w = u["js.download.file"].replace("{0}", v.name), b = u["js.fileChips.remove"].replace("{0}", v.name);
      return /* @__PURE__ */ e.createElement("span", { key: v.key, className: "tlFileChip" }, /* @__PURE__ */ e.createElement(
        ...
        v.size != null && /* @__PURE__ */ e.createElement("span", { className: "tlFileChip__size" }, jl(v.size))
...
const Ul = ({ controlId: l }) => {
  ...
  const t = X(), n = Xe(), a = ne(), o = !!t.hasData, u = t.dataRevision ?? 0, s = t.fileName ?? "download", i = !!t.clearable, [r, c] = e.useState(!1), d = e.useCallback(async () => {
    if (!(!o || r)) {
      ...
      try {
        ...
        const C = await N.blob(), E = URL.createObjectURL(C), y = document.createElement("a");
        y.href = E, y.download = s, y.style.display = "none", document.body.appendChild(y), y.click(), document.body.removeChild(y), URL.revokeObjectURL(E);
      } catch (g) {
  ...
  const t = X(), n = Ge(), [a, o] = e.useState("idle"), [u, s] = e.useState(null), [i, r] = e.useState(!1), c = e.useRef(null), d = e.useRef(null), m = e.useRef(null), p = e.useRef(null), h = e.useRef(null), g = t.error, N = e.useMemo(
    () => {
      var R;
  ...
  const v = ue(Kl), w = a === "uploading" ? v["js.uploading"] : v["js.photoCapture.open"], b = ["tlPhotoCapture__cameraBtn"];
  ...
  ), u && /* @__PURE__ */ e.createElement("span", { className: "tlPhotoCapture__status tlPhotoCapture__status--error" }, v[u]), g && /* @__PURE__ */ e.createElement("span", { className: "tlPhotoCapture__status tlPhotoCapture__status--error" }, g));
}, Gl = {
  ...
  const t = X(), n = Xe(), a = !!t.hasPdf, o = t.dataRevision ?? 0, u = ue(ql), i = n.indexOf("react-api/"), r = i >= 0 ? n.slice(0, i) : n, c = n + "&rev=" + o, d = r + "html/pdfjs/web/viewer.html?file=" + encodeURIComponent(c);
...
}, { useCallback: ln, useRef: St } = e, Ql = ({ controlId: l }) => {
  const t = X(), n = ne(), a = Ct(!0), o = t.orientation, u = t.resizable === !0, s = t.children ?? [], i = o === "horizontal", r = s.length > 0 && s.every((E) => E.collapsed), c = !r && s.some((E) => E.collapsed), d = r ? !i : i, m = St(null), p = St(null), h = St(null), g = ln((E, y) => {
    const k = {
      overflow: E.scrolling || "auto"
    };
    return E.collapsed ? r && !d ? k.flex = "1 0 0%" : k.flex = "0 0 auto" : y !== void 0 ? k.flex = `0 0 ${y}px` : k.flex = `${E.size} 1 0%`, E.minSize > 0 && !E.collapsed && (k.minWidth = i ? E.minSize : void 0, k.minHeight = i ? void 0 : E.minSize), k;
  }, [i, r, c, d]), N = ln((E, y) => {
    E.preventDefault();
    const k = m.current;
    if (!k) return;
    const x = s[y], v = s[y + 1], w = k.querySelectorAll(":scope > .tlSplitPanel__child"), b = [];
    w.forEach((R) => {
  ...
  return s.forEach((E, y) => {
    if (C.push(
      ...
      const k = s[y + 1];
      !E.collapsed && !k.collapsed && C.push(
        /* @__PURE__ */ e.createElement(
          "div",
          {
            key: `splitter-${y}`,
  ...
  const t = X(), n = ne(), a = ue(Jl), o = t.title, u = t.expansionState ?? "NORMALIZED", s = t.showMinimize === !0, i = t.showMaximize === !0, r = t.showPopOut === !0, c = t.fullLine === !0, d = t.fill === !0, m = t.hoverActions === !0, p = t.appearance === "card", h = t.errorMessage, g = u === "MINIMIZED", N = u === "MAXIMIZED", C = u === "HIDDEN", E = Dt(() => {
    n("toggleMinimize");
  }, [n]), y = Dt(() => {
    n("toggleMaximize");
  }, [n]), k = Dt(() => {
  ...
  if (C)
    return null;
  const v = N ? { position: "absolute", inset: 0, zIndex: 10, display: "flex", flexDirection: "column" } : { display: "flex", flexDirection: "column", width: "100%", height: "100%" }, w = s && !N || i && !g || r, b = !!o && o.trim() !== "" || !!t.titleContent || !!t.toolbar || w;
  return /* @__PURE__ */ e.createElement(
    "div",
    {
      id: l,
...
}, { useCallback: ve, useState: ht, useEffect: $t, useRef: gt } = e, ca = {
...
const Ye = ({ icon: l }) => l ? /* @__PURE__ */ e.createElement(Ne, { encoded: l, className: "tlSidebar__icon" }) : null, ia = ({ item: l, active: t, collapsed: n, onSelect: a, tabIndex: o, itemRef: u, onFocus: s }) => /* @__PURE__ */ e.createElement(
  "button",
  {
...
), da = ({ item: l, collapsed: t }) => t && !l.icon ? null : /* @__PURE__ */ e.createElement("div", { className: "tlSidebar__headerItem", title: t ? l.label : void 0 }, /* @__PURE__ */ e.createElement(Ye, { icon: l.icon }), !t && /* @__PURE__ */ e.createElement("span", { className: "tlSidebar__label" }, l.label)), ma = () => /* @__PURE__ */ e.createElement("hr", { className: "tlSidebar__separator" }), pa = ({ item: l, activeItemId: t, anchorRect: n, onSelect: a, onExecute: o, onClose: u }) => {
  const s = gt(null);
  $t(() => {
    const c = (d) => {
  ...
  const t = X(), n = ne(), a = ue(ca), o = t.items ?? [], u = t.activeItemId, s = t.collapsed, i = t.drawerOpen, r = i ? !1 : s, [c, d] = ht(() => {
  ...
  }), w = gt(/* @__PURE__ */ new Map()), b = ve((A) => (z) => {
...
}, { useCallback: an, useRef: Na } = e, Sa = ({ onClose: l }) => (me("ESCAPE", () => (l(), !0)), null), Da = ({ controlId: l }) => {
...
}, { useCallback: it, useRef: We, useState: ut } = e, xa = ({ onClose: l }) => (me("ESCAPE", () => (l(), !0)), null), Ma = {
  "js.window.close": "Close",
  "js.window.maximize": "Maximize",
  "js.window.restore": "Restore"
}, Ia = ["n", "ne", "e", "se", "s", "sw", "w", "nw"], ja = ({ controlId: l }) => {
  const t = X(), n = ne(), a = ue(Ma), o = t.title ?? "", u = t.width ?? "32rem", s = t.height ?? null, i = t.minHeight ?? null, r = t.resizable === !0, c = t.child, d = t.actions ?? [], m = t.toolbar, p = t.buttonBar, [h, g] = ut(null), [N, C] = ut(null), [E, y] = ut(null), k = We(null), [x, v] = ut(!1), w = We(null), b = We(null), D = We(null), j = We(null), R = We(null), H = it(() => {
    n("close");
  }, [n]);
  Gt(!0, j, "field");
  const K = it((I, L) => {
    ...
    if (x) {
      const S = w.current;
      S && (y(S.x !== -1 ? { x: S.x, y: S.y } : null), g(S.w), C(S.h)), v(!1);
    } else {
...
}, { useCallback: dt, useRef: Fa } = e, Oa = ({ controlId: l }) => {
  const t = X(), n = ne(), a = Fa(null), o = t.child, s = (t.trigger ?? "contextmenu") === "click", i = dt((m) => {
...
const qa = ({ controlId: l }) => {
  ...
  sn(() => {
    if (!g) return;
    const x = setInterval(() => h((v) => v + 1), Ga);
  ...
  const y = E != null ? Xa(E) : null, k = c != null;
  return /* @__PURE__ */ e.createElement(
    "div",
    {
      id: l,
...
}, { useCallback: Tt, useEffect: Rt, useRef: Za, useState: cn } = e, Qa = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.open === !0, o = t.anchorId, u = t.anchorX, s = t.anchorY, i = t.items ?? [], r = Za(null), [c, d] = cn({ top: 0, left: 0 }), [m, p] = cn(0), h = i.filter((E) => E.type === "item" && !E.disabled);
  Rt(() => {
    var b, D;
    if (!a) return;
    const E = ((b = r.current) == null ? void 0 : b.offsetHeight) ?? 200, y = ((D = r.current) == null ? void 0 : D.offsetWidth) ?? 200;
    if (u != null && s != null) {
      let j = s, R = u;
      j + E > window.innerHeight && (j = Math.max(0, window.innerHeight - E)), R + y > window.innerWidth && (R = Math.max(0, window.innerWidth - y)), d({ top: j, left: R }), p(0);
      return;
    }
    if (!o) return;
    ...
    let v = x.bottom + 4, w = x.left;
    v + E > window.innerHeight && (v = x.top - E - 4), w + y > window.innerWidth && (w = x.right - y), d({ top: v, left: w }), p(0);
  }, [a, o, u, s]);
  const g = Tt(() => {
    n("close");
  }, [n]), N = Tt((E) => {
  ...
  const C = Tt((E) => {
    ...
    if (E.key === "ArrowDown")
      E.preventDefault(), p((y) => (y + 1) % h.length);
    else if (E.key === "ArrowUp")
      E.preventDefault(), p((y) => (y - 1 + h.length) % h.length);
  ...
  return Gt(a, r), Rt(() => {
    var y;
    if (!a) return;
    const E = (y = r.current) == null ? void 0 : y.querySelector(".tlMenu__item--focused");
    E == null || E.scrollIntoView({ block: "nearest" });
  }, [a, m]), a ? /* @__PURE__ */ e.createElement(
    "div",
    {
      id: l,
      className: "tlMenu",
    ...
    i.map((E, y) => {
      ...
      if (E.type === "header")
        return /* @__PURE__ */ e.createElement("div", { key: y, className: "tlMenu__header", role: "presentation" }, E.label);
      const x = h.indexOf(E) === m;
      return /* @__PURE__ */ e.createElement(
        "button",
        {
          key: E.id,
          type: "button",
          className: "tlMenu__item" + (x ? " tlMenu__item--focused" : "") + (E.disabled ? " tlMenu__item--disabled" : "") + (E.active ? " tlMenu__item--active" : "") + (E.cssClasses ? " " + E.cssClasses : ""),
          role: "menuitem",
...
}, nr = ({ isMulti: l, cursorIndex: t, onMove: n, onToggle: a, onSelectAll: o }) => (me("ArrowUp", () => (n("up", !1, !1), !0)), me("ArrowDown", () => (n("down", !1, !1), !0)), me("Home", () => (n("home", !1, !1), !0)), me("End", () => (n("end", !1, !1), !0)), me("PageUp", () => (n("pageUp", !1, !1), !0)), me("PageDown", () => (n("pageDown", !1, !1), !0)), me("Shift+ArrowUp", () => (n("up", l, !1), !0)), me("Shift+ArrowDown", () => (n("down", l, !1), !0)), me("Shift+Home", () => (n("home", l, !1), !0)), me("Shift+End", () => (n("end", l, !1), !0)), me("Shift+PageUp", () => (n("pageUp", l, !1), !0)), me("Shift+PageDown", () => (n("pageDown", l, !1), !0)), me("Ctrl+ArrowUp", () => (n("up", !1, l), !0)), me("Ctrl+ArrowDown", () => (n("down", !1, l), !0)), me("Space", () => t < 0 ? !1 : (a(), !0)), me("Ctrl+A", () => l ? (o(), !0) : !1), null), lr = {
...
}, ar = 300, un = 50, rr = 'input, textarea, select, button, a, [contenteditable="true"], [role="combobox"], [role="listbox"], [role="option"], [role="button"], [role="link"], [role="checkbox"], [role="radio"], [role="switch"], [role="textbox"], [role="spinbutton"], [role="slider"], [role="menu"], [role="menuitem"]';
function Lt(l) {
  var n;
  const t = l.target;
...
const sr = ({ controlId: l }) => {
  ...
  e.useEffect(() => {
    ...
    return _.addEventListener("tl-tooltip-resolve", T), () => _.removeEventListener("tl-tooltip-resolve", T);
  }, []);
  const u = t.columns ?? [], s = t.totalRowCount ?? 0, i = t.rows ?? [], r = t.rowHeight ?? 36, c = t.selectionMode ?? "single", d = t.selectedCount ?? 0, m = t.cursorIndex ?? -1, p = t.frozenColumnCount ?? 0, h = t.treeMode ?? !1, g = t.columnSelect ?? !1, N = t.filterBar ?? !1, C = t.namedFilters ?? [], E = t.activeNamedFilter ?? "", y = t.search ?? "", k = t.filterSaving ?? !1, x = e.useMemo(
    () => u.filter((_) => _.sortPriority && _.sortPriority > 0).length,
    [u]
  ), v = c === "multi", w = 40, b = 20, D = e.useRef(null), j = e.useRef(null), R = e.useRef(null), H = e.useRef(null), K = e.useRef(null), [A, z] = e.useState({}), B = e.useRef(null), P = e.useRef(!1), I = e.useRef(null), [L, S] = e.useState(null), [$, f] = e.useState(null), [M, Y] = e.useState(null), [W, Z] = e.useState(0);
  e.useEffect(() => {
    const _ = R.current;
    if (!_)
      return;
    const T = () => {
      const Q = _.offsetWidth - _.clientWidth;
      Z((ee) => ee === Q ? ee : Q);
    };
    T();
  ...
  const F = e.useCallback((_) => A[_.name] ?? _.width, [A]), te = e.useMemo(() => {
    const _ = [];
    let T = v && p > 0 ? w : 0;
    for (let V = 0; V < p && V < u.length; V++)
      _.push(T), T += F(u[V]);
    return _;
  }, [u, p, v, w, F]), se = e.useMemo(() => {
    if (p <= 0)
      return 0;
    let _ = v ? w : 0;
    for (let T = 0; T < p && T < u.length; T++)
      _ += F(u[T]);
    return _;
  }, [u, p, v, w, F]), le = s * r, pe = e.useRef(null), ye = e.useCallback((_, T, V) => {
    V.preventDefault(), V.stopPropagation(), B.current = { column: _, startX: V.clientX, startWidth: T };
    ...
    const re = () => {
      ...
      Jt !== 0 && (de && (de.scrollLeft = ce.scrollLeft), ee += Jt, re()), pe.current = requestAnimationFrame(oe);
    };
    ...
    D.current && R.current && (D.current.scrollLeft = R.current.scrollLeft), H.current !== null && clearTimeout(H.current), H.current = window.setTimeout(() => {
      const _ = R.current;
      if (!_) return;
      const T = _.scrollTop, V = Math.ceil(_.clientHeight / r), Q = Math.floor(T / r);
      n("scroll", { start: Q, count: V });
    }, 80);
  }, [n, r]), Te = e.useCallback((_, T, V) => {
    if (P.current) return;
    let Q;
    !T || T === "desc" ? Q = "asc" : Q = "desc";
    const ee = V.shiftKey ? "add" : "replace";
    n("sort", { column: _, direction: Q, mode: ee });
  }, [n]), Re = e.useCallback((_, T) => {
    I.current = _, T.dataTransfer.effectAllowed = "move", T.dataTransfer.setData("text/plain", _);
  }, []), $e = e.useCallback((_, T) => {
    if (!I.current || I.current === _) {
      S(null);
      return;
    }
    ...
    if (!Lt(T) && ((ee = R.current) == null || ee.focus({ preventScroll: !0 }), !T.ctrlKey && !T.metaKey && !T.shiftKey)) {
      ...
      K.current = { index: _, col: fe ?? void 0 };
    }
    const Q = i.find((fe) => fe.index === _);
    Lt(T) && (Q != null && Q.selected) && !T.ctrlKey && !T.metaKey && !T.shiftKey || n("select", {
      rowIndex: _,
      ctrlKey: T.ctrlKey || T.metaKey,
      shiftKey: T.shiftKey
    });
  }, [n, i]), ae = e.useCallback((_, T, V) => {
    n("moveSelection", { direction: _, extend: T, move: V });
  }, [n]), ie = e.useCallback(() => {
    m < 0 || n("select", { rowIndex: m, ctrlKey: v, shiftKey: !1 });
  }, [n, m, v]), qe = e.useCallback(() => {
  ...
  e.useEffect(() => {
    ...
    if (!_)
      return;
    const T = m * r, V = T + r;
    T < _.scrollTop ? _.scrollTop = T : V > _.scrollTop + _.clientHeight && (_.scrollTop = V - _.clientHeight);
  }, [m, r]), e.useEffect(() => {
    const _ = K.current, T = R.current;
    if (!_ || !T)
      return;
    const V = i.find((re) => re.index === _.index);
    if (!V || !xt(T, V.id))
      return;
    K.current = null;
  ...
  const Mn = e.useCallback((_) => {
    ...
    if (!re)
      return;
    const oe = wn(T, ee).flatMap((xe) => Array.from(xe.querySelectorAll(or))), he = oe.indexOf(V);
    if (he < 0)
      return;
    const fe = !_.shiftKey;
    ...
    _e && xt(T, _e.id) || (_.preventDefault(), K.current = { index: de, last: !fe }, n("select", { rowIndex: de, ctrlKey: !1, shiftKey: !1 }));
  }, [i, s, n]), In = e.useCallback((_, T) => {
    T.stopPropagation(), n("select", { rowIndex: _, ctrlKey: !0, shiftKey: !1 });
  }, [n]), jn = e.useCallback(() => {
    const _ = d === s && s > 0;
    n("selectAll", { selected: !_ });
  }, [n, d, s]), Pn = e.useCallback((_, T, V) => {
    V.stopPropagation(), n("expand", { rowIndex: _, expanded: T });
  }, [n]), Bn = e.useCallback((_, T) => {
    T.preventDefault(), f({ x: T.clientX, y: T.clientY, colIdx: _ });
  }, []), An = e.useCallback(() => {
    $ && (n("setFrozenColumnCount", { count: $.colIdx + 1 }), f(null));
  }, [$, n]), Fn = e.useCallback(() => {
    n("setFrozenColumnCount", { count: 0 }), f(null);
  }, [n]), On = e.useCallback((_) => {
    _.preventDefault(), _.stopPropagation();
  ...
  const $n = e.useCallback((_, T) => {
    T.stopPropagation(), T.preventDefault(), n("openFilter", { column: _ });
  }, [n]), Hn = e.useCallback((_) => {
    _.stopPropagation(), _.preventDefault(), n("openColumnSelect", {});
  }, [n]), [Wn, qt] = e.useState(y), yt = e.useRef(!1), Le = e.useRef(null);
  e.useEffect(() => {
    yt.current || qt(y);
  }, [y]), e.useEffect(() => () => {
    Le.current !== null && clearTimeout(Le.current);
  }, []);
  const st = e.useCallback((_) => {
    Le.current !== null && (clearTimeout(Le.current), Le.current = null), yt.current = !1, n("search", { term: _ });
  }, [n]), Un = e.useCallback((_) => {
    qt(_), yt.current = !0, Le.current !== null && clearTimeout(Le.current), Le.current = window.setTimeout(() => st(_), ar);
  }, [st]), Vn = e.useCallback((_) => {
    _.key === "Enter" && (_.preventDefault(), st(_.currentTarget.value));
  }, [st]), zn = e.useCallback((_) => {
    _ === E ? n("clearFilter", {}) : n("applyNamedFilter", { id: _ });
  }, [E, n]), Kn = e.useCallback((_, T) => {
    T.stopPropagation(), n("deleteNamedFilter", { id: _ });
  }, [n]), [Ze, Qe] = e.useState(null), wt = e.useCallback(() => {
    const _ = (Ze ?? "").trim();
    _ && (n("saveNamedFilter", { filterName: _ }), Qe(null));
  }, [Ze, n]), Yn = e.useCallback((_) => {
    _.key === "Enter" ? (_.preventDefault(), wt()) : _.key === "Escape" && (_.preventDefault(), Qe(null));
  }, [wt]), kt = u.reduce((_, T) => _ + F(T), 0) + (v ? w : 0), Nt = g ? 32 : 0, Gn = d === s && s > 0, Zt = d > 0 && d < s, Xn = e.useCallback((_) => {
    _ && (_.indeterminate = Zt);
  }, [Zt]);
  return /* @__PURE__ */ e.createElement(Yt, { active: xn }, /* @__PURE__ */ e.createElement(
    nr,
    {
      isMulti: v,
      cursorIndex: m,
    ...
    "div",
    {
      ...
      onDragOver: (_) => {
        ...
        _.clientX < Q.left + ee ? T.scrollLeft = Math.max(0, T.scrollLeft - re) : _.clientX > Q.right - ee && (T.scrollLeft += re), V && (V.scrollLeft = T.scrollLeft);
      },
      onDrop: He
    },
    N && /* @__PURE__ */ e.createElement("div", { className: "tlTableView__filterBar" }, C.length > 0 && /* @__PURE__ */ e.createElement("div", { className: "tlTableView__filterChips" }, C.map((_) => {
      const T = _.id === E;
      return /* @__PURE__ */ e.createElement(
        "span",
        {
        ...
        /* @__PURE__ */ e.createElement(
          "button",
          {
            ...
            "aria-pressed": T,
            title: T ? a["js.table.clearFilter"] : _.label,
            onClick: () => zn(_.id)
          },
          _.label
        ),
        _.deletable && /* @__PURE__ */ e.createElement(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlTableView__headerArea", ref: j }, /* @__PURE__ */ e.createElement("div", { className: "tlTableView__header", ref: D }, /* @__PURE__ */ e.createElement(
      "div",
      {
        ...
        style: { width: kt, paddingRight: Nt + W }
      },
      v && /* @__PURE__ */ e.createElement(
        "div",
        {
          ...
          onDragOver: (_) => {
            I.current && (_.preventDefault(), _.dataTransfer.dropEffect = "move", u.length > 0 && u[0].name !== I.current && S({ column: u[0].name, side: "left" }));
          }
        },
        /* @__PURE__ */ e.createElement(
          "input",
      ...
      u.map((_, T) => {
        ...
        _.sortable && (Q += " tlTableView__headerCell--sortable"), L && L.column === _.name && (Q += " tlTableView__headerCell--dragOver-" + L.side);
        ...
        return ee && (Q += " tlTableView__headerCell--frozen"), re && (Q += " tlTableView__headerCell--frozenLast"), /* @__PURE__ */ e.createElement(
          "div",
          {
            ...
            draggable: !0,
            onClick: _.sortable ? (oe) => Te(_.name, _.sortDirection, oe) : void 0,
            onContextMenu: (oe) => Bn(T, oe),
            onDragStart: (oe) => Re(_.name, oe),
            onDragOver: (oe) => $e(_.name, oe),
            onDrop: He,
            onDragEnd: O
          },
          /* @__PURE__ */ e.createElement("span", { className: "tlTableView__headerLabel" }, _.label),
          _.filterable && /* @__PURE__ */ e.createElement(
            "button",
            {
              type: "button",
              className: "tlTableView__filterButton" + (_.filterActive ? " tlTableView__filterButton--active" : ""),
              ...
              style: {
                ...
                cursor: "pointer",
                padding: "0 4px",
                color: _.filterActive ? "#1565c0" : "inherit"
              },
              onMouseDown: (oe) => oe.stopPropagation(),
              onClick: (oe) => $n(_.name, oe)
            },
            /* @__PURE__ */ e.createElement("i", { className: _.filterActive ? "bi bi-funnel-fill" : "bi bi-funnel" })
          ),
          _.sortDirection && /* @__PURE__ */ e.createElement("span", { className: "tlTableView__sortIndicator" }, _.sortDirection === "asc" ? "▲" : "▼", x > 1 && _.sortPriority != null && _.sortPriority > 0 && /* @__PURE__ */ e.createElement("span", { className: "tlTableView__sortPriority" }, _.sortPriority)),
          /* @__PURE__ */ e.createElement(
            "div",
            {
              className: "tlTableView__resizeHandle",
              onMouseDown: (oe) => ye(_.name, V, oe)
            }
          )
        );
      }),
        ...
        "div",
        {
          ...
          onDragOver: (_) => {
            if (I.current && u.length > 0) {
              ...
              T.name !== I.current && (_.preventDefault(), _.dataTransfer.dropEffect = "move", S({ column: T.name, side: "right" }));
            }
          },
          onDrop: He
        }
    ...
    /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement("div", { style: { height: le, position: "relative", width: kt, paddingRight: Nt } }, i.map((_) => /* @__PURE__ */ e.createElement(
        "div",
        {
          key: _.id,
          className: "tlTableView__row" + (_.selected ? " tlTableView__row--selected" : "") + (_.index === m ? " tlTableView__row--cursor" : ""),
          style: {
            position: "absolute",
            top: _.index * r,
            height: r,
            width: kt,
            paddingRight: Nt,
            ..._.index === m ? { outline: "2px solid var(--color-primary, #1a73e8)", outlineOffset: "-2px" } : {}
          },
          onMouseDown: (T) => {
            (T.shiftKey || T.ctrlKey || T.metaKey || T.detail > 1) && !Lt(T) && T.preventDefault();
          },
          onClick: (T) => q(_.index, T)
        },
        v && /* @__PURE__ */ e.createElement(
          "div",
          {
        ...
        u.map((T, V) => {
          ...
          const fe = h && V === 0, ce = _.treeDepth ?? 0;
          return /* @__PURE__ */ e.createElement(
            "div",
            {
              key: T.name,
            ...
            fe ? /* @__PURE__ */ e.createElement("div", { className: "tlTableView__treeCell", style: { paddingLeft: ce * b } }, _.expandable ? /* @__PURE__ */ e.createElement(
              "button",
              {
                className: "tlTableView__treeToggle",
                onClick: (de) => Pn(_.index, !_.expanded, de)
              },
              _.expanded ? "▾" : "▸"
            ) : /* @__PURE__ */ e.createElement("span", { className: "tlTableView__treeToggleSpacer" }), _.cells[T.name] && /* @__PURE__ */ e.createElement(G, { control: _.cells[T.name] })) : _.cells[T.name] && /* @__PURE__ */ e.createElement(G, { control: _.cells[T.name] })
          );
        })
      )))
    ),
  ...
  const t = X(), n = ne(), a = ue(cr), o = t.entries ?? [], u = o.filter((v) => v.visible).length, [s, i] = e.useState(""), r = s.trim().toLowerCase(), c = r ? o.filter((v) => v.label.toLowerCase().includes(r)) : o, d = e.useRef(null), m = e.useRef(null), [p, h] = e.useState(null), g = e.useCallback((v) => {
    m.current = v, h(v);
  }, []), N = e.useCallback((v, w) => {
    n("columnVisible", { column: v, visible: w });
  }, [n]), C = e.useCallback((v, w) => {
    d.current = v, w.dataTransfer.effectAllowed = "move", w.dataTransfer.setData("text/plain", v);
  }, []), E = e.useCallback((v, w) => {
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlColumnSelect", onDrop: k }, x && /* @__PURE__ */ e.createElement("div", { className: "tlColumnSelect__search" }, /* @__PURE__ */ e.createElement("i", { className: "bi bi-search", "aria-hidden": "true" }), /* @__PURE__ */ e.createElement(
    ...
    const w = v.visible && u <= 1;
    let b = "tlColumnSelect__row";
    return p && p.name === v.name && (b += " tlColumnSelect__row--dragOver-" + p.side), /* @__PURE__ */ e.createElement(
      "div",
      {
        key: v.name,
        className: b,
        draggable: !0,
        onDragStart: (D) => C(v.name, D),
        onDragOver: (D) => E(v.name, D),
        onDrop: k,
        onDragEnd: y
      },
      ...
      /* @__PURE__ */ e.createElement("label", { className: "tlColumnSelect__label" }, /* @__PURE__ */ e.createElement(
        "input",
        {
          ...
          checked: v.visible,
          disabled: w,
          onChange: (D) => N(v.name, D.target.checked)
        }
      ), /* @__PURE__ */ e.createElement("span", null, v.label))
    );
  })));
}, { useState: Ut, useRef: lt, useCallback: bt, useMemo: Ae, useEffect: dn } = e, ur = {
...
}, Ee = 44, vt = 15, Ce = 6e4, dr = 36e5, je = 864e5, mr = 8;
function Se(l) {
  const t = new Date(l);
...
const Mt = (l) => {
  ...
  const { events: a, locale: o, nonWorkingDays: u, dayStartHour: s, dayEndHour: i, now: r, send: c, editable: d, i18n: m } = l, p = Ae(() => {
    ...
    return P;
  }, [t, n, u]), h = kn(c), g = lt(null), N = lt(null), [C, E] = Ut(null), y = lt(null);
  y.current = C;
  ...
  const v = bt(
    (B, P) => {
      ...
      const L = I.getBoundingClientRect(), S = L.width / p.length, $ = et(Math.floor((B - L.left) / S), 0, p.length - 1), f = P - L.top + I.scrollTop, M = et(f / Ee * 60, 0, 1440);
  ...
  dn(() => {
    ...
    const B = (L) => {
      ...
      S.mode === "move" ? E({ ...S, dayStart: p[$], startMin: et(Je(f - S.grabMin), 0, 1440 - S.dur) }) : S.mode === "resize" ? E({ ...S, endMin: et(Je(f), S.startMin + vt, 1440) }) : E({ ...S, toMin: et(Je(f), 0, 1440) });
    }, P = () => {
      const L = y.current;
      if (E(null), !!L)
        if (L.mode === "move") {
  ...
  const w = (B, P, I) => {
    ...
    const { min: L } = v(B.clientX, B.clientY), S = (P.end - P.start) / Ce;
    E({
      mode: "move",
      id: P.id,
    ...
    !d || !P.resizable || (B.stopPropagation(), Mt(B), h.discard(), E({
      mode: "resize",
      id: P.id,
      dayStart: I,
      startMin: Ie(P.start),
    ...
    if (!d || B.button !== 0)
      return;
    Mt(B), h.discard();
    const { min: I } = v(B.clientX, B.clientY);
    E({ mode: "create", dayStart: P, fromMin: Je(I), toMin: Je(I) });
  ...
  ), [p, R]), K = Ae(() => p.map((B) => R.filter((P) => P.allDay && P.start < B + je && P.end > B)), [p, R]), A = s * Ee, z = i * Ee;
  return /* @__PURE__ */ e.createElement("div", { className: "tlCalTimeGrid" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalTimeHeader" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalGutter" }), p.map((B) => {
    ...
    K[P].map((I) => /* @__PURE__ */ e.createElement(
      ...
      {
        key: I.id,
        className: "tlCalAllDayEvent " + Et(I.category) + (I.selected ? " tlCalEvent--selected" : ""),
        style: _t(I),
        title: I.tooltip,
        onClick: (L) => {
  ...
  ))), /* @__PURE__ */ e.createElement("div", { className: "tlCalScroll", ref: N }, /* @__PURE__ */ e.createElement("div", { className: "tlCalTimeBody", style: { height: 24 * Ee } }, /* @__PURE__ */ e.createElement("div", { className: "tlCalHourAxis" }, j.map((B) => /* @__PURE__ */ e.createElement("div", { key: B, className: "tlCalHourLabel", style: { top: B * Ee } }, B === 0 ? "" : Fe(o, { hour: "numeric" }, Se(t) + B * dr)))), /* @__PURE__ */ e.createElement("div", { className: "tlCalColumns", ref: g, style: { gridTemplateColumns: `repeat(${p.length}, 1fr)` } }, p.map((B, P) => {
    ...
    return /* @__PURE__ */ e.createElement(
      ...
      j.map((S) => /* @__PURE__ */ e.createElement("div", { key: S, className: "tlCalHourLine", style: { top: S * Ee } })),
      /* @__PURE__ */ e.createElement("div", { className: "tlCalWorkBand", style: { top: A, height: z - A } }),
      at(B, k) && /* @__PURE__ */ e.createElement("div", { className: "tlCalNowLine", style: { top: Ie(Date.now()) / 60 * Ee } }),
      H[P].map((S) => {
        const $ = C !== null && "id" in C && C.id === S.ev.id, f = S.topMin / 60 * Ee, M = (S.botMin - S.topMin) / 60 * Ee, Y = 100 / S.cols;
        return /* @__PURE__ */ e.createElement(
          "div",
          {
            key: S.ev.id,
            className: "tlCalEvent " + Et(S.ev.category) + (S.ev.selected ? " tlCalEvent--selected" : "") + ($ ? " tlCalEvent--dragging" : ""),
            style: _t(S.ev, {
              top: f,
              height: M,
              left: `${S.col * Y}%`,
  ...
  const { events: a, locale: o, nonWorkingDays: u, send: s, editable: i, now: r, i18n: c } = l, d = kn(s), m = Ae(() => {
    const h = [];
    for (let g = 0; g < 6; g++) {
      const N = [];
      for (let C = 0; C < 7; C++)
    ...
    if (!C || !i || !C.movable)
      return;
    const E = g - Se(C.start);
    s("moveEvent", { eventId: N, start: C.start + E, end: C.end + E });
  };
  return /* @__PURE__ */ e.createElement("div", { className: "tlCalMonth" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthHead" }, m[0].map((h) => /* @__PURE__ */ e.createElement("div", { key: h, className: "tlCalMonthWeekday" }, Fe(o, { weekday: "short" }, h)))), /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthBody" }, m.map((h, g) => {
    const N = h[0], C = Ke(N, 7), E = a.filter((k) => (k.allDay || k.end - k.start >= je) && k.start < C && k.end > N).sort((k, x) => k.start - x.start).slice(0, 3), y = E.length;
    return /* @__PURE__ */ e.createElement("div", { key: g, className: "tlCalMonthWeek" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthDays" }, h.map((k) => {
      const x = new Date(k).getMonth() === new Date(n).getMonth(), v = u.includes(new Date(k).getDay()), w = at(k, r);
      return /* @__PURE__ */ e.createElement(
        "div",
        {
          key: k,
    ...
    })), /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthOverlay" }, E.map((k, x) => {
      const v = Math.max(0, Math.floor((Se(Math.max(k.start, N)) - N) / je)), w = Math.min(7, Math.ceil((k.end - N) / je));
      return /* @__PURE__ */ e.createElement(
        "div",
        {
          key: k.id,
          className: "tlCalMonthBar " + Et(k.category) + (k.selected ? " tlCalEvent--selected" : ""),
          style: _t(k, {
            gridColumn: `${v + 1} / ${Math.max(v + 1, w) + 1}`,
            gridRow: x + 1
          }),
      ...
      const v = a.filter((D) => !D.allDay && D.end - D.start < je && at(D.start, k)).sort((D, j) => D.start - j.start), w = v.slice(0, _r), b = v.length - w.length;
      return w.map((D, j) => /* @__PURE__ */ e.createElement(
        "div",
        {
          key: D.id,
          className: "tlCalChip " + Et(D.category) + (D.selected ? " tlCalEvent--selected" : ""),
  ...
  return /* @__PURE__ */ e.createElement("div", { className: "tlCalYear" }, d.map((p) => {
    const h = new Date(p), g = Se(Ke(p, -((h.getDay() - o + 7) % 7))), N = Array.from({ length: 42 }, (C, E) => Ke(g, E));
    return /* @__PURE__ */ e.createElement("div", { key: p, className: "tlCalMini" }, /* @__PURE__ */ e.createElement(
      ...
      Fe(a, { month: "long" }, p)
    ), /* @__PURE__ */ e.createElement("div", { className: "tlCalMiniGrid" }, m.map((C, E) => /* @__PURE__ */ e.createElement("div", { key: "h" + E, className: "tlCalMiniWd" }, C)), N.map((C) => {
      const E = new Date(C).getMonth() === h.getMonth(), y = u.includes(new Date(C).getDay()), k = at(C, i), x = r.has(pr(C));
      return /* @__PURE__ */ e.createElement(
        "div",
        {
          key: C,
          className: "tlCalMiniDay" + (E ? "" : " tlCalMiniDay--other") + (y ? " tlCalMiniDay--nonworking" : "") + (k ? " tlCalMiniDay--today" : "") + (x ? " tlCalMiniDay--event" : ""),
  ...
  return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlCalendar" }, /* @__PURE__ */ e.createElement(gr, { title: i, granularity: o, i18n: a, send: n }), /* @__PURE__ */ e.createElement("div", { className: "tlCalBody" }, o === "MONTH" ? /* @__PURE__ */ e.createElement(Cr, { ctx: r, rangeStart: u, anchorMonth: s }) : o === "YEAR" ? /* @__PURE__ */ e.createElement(yr, { ctx: r, rangeStart: u }) : /* @__PURE__ */ e.createElement(Er, { ctx: r, rangeStart: u, granularity: o })));
}, kr = {
  readOnly: !1,
  resolvedLabelPosition: "side"
}, Nn = e.createContext(kr), { useMemo: Nr, useRef: Sr, useState: Dr, useEffect: Tr } = e, Rr = 320, Lr = "TLTableView", xr = "TLPanel", Mr = ({ controlId: l }) => {
  var C;
  ...
  return s ? /* @__PURE__ */ e.createElement("div", { id: l, className: "tlFormLayout tlFormLayout--empty", ref: i }, /* @__PURE__ */ e.createElement("p", { className: "tlFormLayout__noModel" }, s)) : /* @__PURE__ */ e.createElement(Nn.Provider, { value: d }, /* @__PURE__ */ e.createElement("div", { id: l, className: N, style: p, ref: i }, u.map((E, y) => /* @__PURE__ */ e.createElement(G, { key: y, control: E }))));
}, { useCallback: Ir } = e, jr = {
  ...
  const t = X(), n = Br(Nn), a = t.label ?? "", o = t.required === !0, u = t.error, s = t.errorIcon, i = t.warnings, r = t.warningIcon, c = t.helpText, d = t.dirty === !0, m = t.labelPosition ?? n.resolvedLabelPosition, p = t.fullLine === !0, h = t.visible !== !1, g = t.hasTooltip === !0, N = t.field, C = n.readOnly, [E, y] = Ar(!1), k = Fr(() => y((D) => !D), []), x = m === "hidden", v = u != null, w = i != null && i.length > 0, b = [
    "tlFormField",
    `tlFormField--${m}`,
    C ? "tlFormField--readonly" : "",
    p ? "tlFormField--fullLine" : "",
    v ? "tlFormField--error" : "",
    !v && w ? "tlFormField--warning" : "",
    d ? "tlFormField--dirty" : ""
  ].filter(Boolean).join(" ");
...
var It = { exports: {} }, be = {}, jt = { exports: {} }, J = {};
/**
 * @license React
 * react.production.js
 *
...
function Ur() {
  ...
  x.constructor = k, N(x, E.prototype), x.isPureReactComponent = !0;
  var v = Array.isArray;
  function w() {
  }
  ...
  function P(f, M, Y, W, Z) {
    ...
    if (te)
      return Z = Z(f), te = W === "" ? "." + z(f, 0) : W, v(Z) ? (Y = "", te != null && (Y = te.replace(A, "$&/") + "/"), P(Z, M, Y, "", function(pe) {
        return pe;
      })) : Z != null && (H(Z) && (Z = R(
        Z,
    ...
    if (v(f))
      ...
      for (f = le.call(f), le = 0; !(W = f.next()).done; )
        W = W.value, F = se + z(W, le++), te += P(
          W,
          M,
          Y,
          F,
  ...
  return J.Activity = m, J.Children = $, J.Component = E, J.Fragment = n, J.Profiler = o, J.PureComponent = k, J.StrictMode = a, J.Suspense = r, J.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = b, J.__COMPILER_RUNTIME = {
    __proto__: null,
    c: function(f) {
...
var pn;
function Vr() {
  return pn || (pn = 1, jt.exports = Ur()), jt.exports;
}
/**
 * @license React
...
function Kr() {
  ...
  return l(), It.exports = zr(), It.exports;
}
var Sn = Kr();
...
const Xr = ({ controlId: l, state: t }) => {
  const n = ne(), a = t.value ?? [], o = t.multiSelect === !0, u = t.customOrder === !0, s = t.mandatory === !0, i = t.disabled === !0, r = t.editable !== !1, c = t.optionsLoaded === !0, d = t.options ?? [], m = t.emptyOptionLabel ?? "", p = u && o && !i && r, h = ue({
    ...
    [h]
  ), [C, E] = Me(!1), [y, k] = Me(""), [x, v] = Me(-1), [w, b] = Me(!1), [D, j] = Me({}), [R, H] = Me(null), [K, A] = Me(null), [z, B] = Me(null), P = tt(null), I = tt(null), L = tt(null), S = tt(a);
  S.current = a;
  const $ = tt(-1), f = zt(
  ...
  Ue(() => {
    ...
    if (!C) return;
    const O = (q) => {
      P.current && !P.current.contains(q.target) && L.current && !L.current.contains(q.target) && (E(!1), k(""));
    };
  ...
  const Y = ge(async () => {
    ...
    var O;
    E(!1), k(""), v(-1), (O = P.current) == null || O.focus();
  }, []), Z = ge(
    (O) => {
      let q;
      if (o) {
      ...
      S.current = q, n(ct, { value: q.map((ae) => ae.value) }), o ? (k(""), v(-1)) : W();
    },
    [o, d, n, W]
  ), F = ge(
    (O) => {
    ...
    (O) => {
      O.stopPropagation(), n(ct, { value: [] }), W();
    },
    [n, W]
  ), se = ge((O) => {
    k(O.target.value);
    ...
    (O) => {
      ...
      let ie = K;
      R < K ? ie = z === "before" ? ie - 1 : ie : ie = z === "before" ? ie : ie + 1, q.splice(ie, 0, ae), S.current = q, n(ct, { value: q.map((qe) => qe.value) }), H(null), A(null), B(null);
    },
    [R, K, z, n]
  ), Re = ge(() => {
  ...
  if (Ue(() => {
    ...
    return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDropdownSelect tlDropdownSelect--immutable" }, a.map((O) => /* @__PURE__ */ e.createElement("span", { key: O.value, className: "tlDropdownSelect__readonlyValue" }, /* @__PURE__ */ e.createElement(Xt, { image: O.image }), /* @__PURE__ */ e.createElement("span", null, O.label))));
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__chips" }, a.length === 0 ? /* @__PURE__ */ e.createElement("span", { className: "tlDropdownSelect__placeholder" }, m) : a.map((O, q) => {
      let ae = "";
      return R === q ? ae = "tlDropdownSelect__chip--dragging" : K === q && z === "before" ? ae = "tlDropdownSelect__chip--dropBefore" : K === q && z === "after" && (ae = "tlDropdownSelect__chip--dropAfter"), /* @__PURE__ */ e.createElement(
        Yr,
        {
          key: O.value,
          option: O,
  ...
  ), He && Sn.createPortal(He, document.body));
}, { useCallback: Pt, useRef: qr } = e, Dn = "application/x-tl-color", Zr = ({
  colors: l,
  columns: t,
  onSelect: n,
  onConfirm: a,
  ...
  const s = qr(null), i = Pt(
    ...
    (d) => (m) => {
      m.preventDefault();
      const p = m.dataTransfer.getData(Dn);
...
function Ln(l, t, n) {
  const a = (o) => Tn(o).toString(16).padStart(2, "0");
  return "#" + a(l) + a(t) + a(n);
}
function Qr(l, t, n) {
...
const { useCallback: Ve, useRef: bn } = e, to = ({ color: l, onColorChange: t }) => {
  const [n, a, o] = eo(l), u = bn(null), s = bn(null), i = Ve(
    (g, N) => {
      var k;
      const C = (k = u.current) == null ? void 0 : k.getBoundingClientRect();
      if (!C) return;
      const E = Math.max(0, Math.min(1, (g - C.left) / C.width)), y = Math.max(0, Math.min(1, 1 - (N - C.top) / C.height));
      t(Bt(n, E, y));
    },
    [n, t]
  ), r = Ve(
    ...
    (g) => {
      ...
      if (!N) return;
      const E = Math.max(0, Math.min(1, (g - N.top) / N.height)) * 360;
      t(Bt(E, a, o));
    },
    [a, o, t]
  ), m = Ve(
...
const lo = {
  ...
  "js.colorInput.ok": "OK"
}, { useState: mt, useCallback: ke, useEffect: gn, useRef: ao, useLayoutEffect: ro } = e, oo = ({
  anchorRef: l,
  currentColor: t,
  palette: n,
  paletteColumns: a,
  ...
  const [c, d] = mt("palette"), [m, p] = mt(t), h = ao(null), g = ue(lo), [N, C] = mt(null);
  ro(() => {
  ...
  const E = m != null, [y, k, x] = E ? Rn(m) : [0, 0, 0], [v, w] = mt((m == null ? void 0 : m.toUpperCase()) ?? "");
  gn(() => {
  ...
  const b = ke(
    (L) => (S) => {
      ...
      if (isNaN($)) return;
      const f = Tn($);
      p(Ln(L === "r" ? f : y, L === "g" ? f : k, L === "b" ? f : x));
    },
    [y, k, x]
  ), D = ke(
    (L) => {
      if (m != null) {
        L.dataTransfer.setData(Dn, m.toUpperCase()), L.dataTransfer.effectAllowed = "move";
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__body" }, c === "palette" ? /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__paletteArea" }, /* @__PURE__ */ e.createElement(
    ...
    ), /* @__PURE__ */ e.createElement("button", { className: "tlColorInput__paletteReset", onClick: B }, g["js.colorInput.reset"])) : /* @__PURE__ */ e.createElement(to, { color: m ?? "#000000", onColorChange: p }), /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__controls" }, /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__previewRow" }, /* @__PURE__ */ e.createElement("span", { className: "tlColorInput__previewLabel" }, g["js.colorInput.current"]), /* @__PURE__ */ e.createElement(
      "div",
      {
      ...
      "input",
      {
        className: "tlColorInput__input" + (v !== "" && !Kt(v) ? " tlColorInput__input--error" : ""),
        type: "text",
        value: v,
        onChange: j
      }
...
}, so = { "js.colorInput.chooseColor": "Choose color" }, { useState: co, useCallback: pt, useRef: io } = e, uo = ({ controlId: l, state: t }) => {
  const [n, a] = De(), o = ne(), u = ue(so), [s, i] = co(!1), r = io(null), c = n, d = t.editable !== !1, m = t.palette ?? [], p = t.paletteColumns ?? 6, h = t.defaultPalette ?? m, g = pt(() => {
    d && i(!0);
  }, [d]), N = pt(
    (y) => {
      i(!1), a(y);
...
}, { useState: nt, useCallback: Be, useEffect: At, useRef: vn, useLayoutEffect: mo, useMemo: po } = e, fo = {
  ...
  const i = ue(fo), [r, c] = nt("simple"), [d, m] = nt(""), [p, h] = nt(t ?? ""), [g, N] = nt(!1), [C, E] = nt(null), y = vn(null), k = vn(null);
  mo(() => {
    ...
    z + A.height > window.innerHeight && (z = K.top - A.height - 4), B + A.width > window.innerWidth && (B = Math.max(0, K.right - A.width)), E({ top: z, left: B });
  }, [l]), At(() => {
    !a && !g && s().catch(() => N(!0));
  }, [a, g, s]), At(() => {
...
}, bo = { "js.iconSelect.chooseIcon": "Choose icon" }, { useState: go, useCallback: ft, useRef: vo } = e, Eo = ({ controlId: l, state: t }) => {
  const [n, a] = De(), o = ne(), u = ue(bo), [s, i] = go(!1), r = vo(null), c = n, d = t.editable !== !1, m = t.disabled === !0, p = t.icons ?? [], h = t.iconsLoaded === !0, g = ft(() => {
    d && !m && i(!0);
  }, [d, m]), N = ft(
    (y) => {
      i(!1), a(y);
...
}, { useCallback: ze, useEffect: _o, useMemo: En, useRef: Co, useState: Ft } = e, yo = {
  quarter: 0.25,
  third: 1 / 3,
  half: 0.5,
  "two-thirds": 2 / 3,
...
function Do(l, t) {
  ...
  for (const m of l) {
    ...
    const N = r, C = r + h, E = i, y = i + p;
    s.push({ id: m.id, colStart: N, colEnd: C, rowStart: E, rowEnd: y });
    for (let k = E; k < y; k++)
...
const To = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.minColWidth ?? "16rem", o = (t.children ?? []).filter((w) => w && w.id), u = Co(null), [s, i] = Ft(1), r = t.editMode === !0;
  _o(() => {
    const w = u.current;
    if (!w) return;
    const b = parseFloat(getComputedStyle(document.documentElement).fontSize) || 16, D = ko(a, b), j = () => i(No(w.clientWidth, D));
    j();
    const R = new ResizeObserver(j);
    return R.observe(w), () => R.disconnect();
  }, [a]);
  const c = En(() => Do(o, s), [o, s]), d = En(() => {
    const w = {};
    for (const b of c) w[b.id] = b;
    return w;
  }, [c]), [m, p] = Ft(null), [h, g] = Ft(null), N = ze((w, b) => {
    if (!r) {
      w.preventDefault();
      return;
    }
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDashboard__grid", style: v }, o.map((w) => {
      const b = d[w.id];
      if (!b) return null;
      const D = {
...
}, { useCallback: Ro, useRef: _n, useState: Cn, useEffect: Lo, useLayoutEffect: xo } = e, Mo = ({ group: l }) => {
  ...
  var m, p;
  const [t, n] = Cn(!1), [a, o] = Cn({}), u = _n(null), s = _n(null), i = Ro(() => {
    n((h) => !h);
  }, []);
  xo(() => {
    if (!t) return;
  ...
  return a.length === 0 ? null : /* @__PURE__ */ e.createElement("div", { id: l, className: "tlToolbar", role: "toolbar" }, a.map((o, u) => /* @__PURE__ */ e.createElement(e.Fragment, { key: o.name }, u > 0 && /* @__PURE__ */ e.createElement("span", { className: "tlToolbar__separator", "aria-hidden": "true" }), o.display === "menu" ? /* @__PURE__ */ e.createElement(Io, { group: o }) : /* @__PURE__ */ e.createElement(Mo, { group: o }))));
}, Po = ({ frame: l, covered: t }) => {
  const [n, a] = rt(), o = [
    "tlTileStack__frame",
  ...
  return /* @__PURE__ */ e.createElement(ot, { host: a }, /* @__PURE__ */ e.createElement("div", { id: l, className: n ? "tlTileStack " + n : "tlTileStack" }, o.map((s, i) => /* @__PURE__ */ e.createElement(Po, { key: s.controlId, frame: s, covered: i !== u }))));
}, Ao = ({ controlId: l }) => {
...
}, Oo = ({ controlId: l }) => /* @__PURE__ */ e.createElement("div", { id: l, className: "tlSlotContent", style: { display: "none" } }), $o = {
...
U("TLResourceCell", $r);
U("TLTreeView", Wr);
U("TLDropdownSelect", Xr);
U("TLColorInput", uo);
U("TLIconSelect", Eo);
U("TLDashboard", To);
U("TLToolbar", jo);
U("TLTileStack", Bo);
U("TLAdaptiveDetail", Ao);
U("TLSlot", Fo);
U("TLSlotContent", Oo);
U("TLDrawerToggle", Ho);
