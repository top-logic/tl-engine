import { React as e, useTLFieldValue as De, useTLCommand as ne, useTLState as X, useKeyboardBinding as me, useTLUpload as Ke, useFill as gt, FillBarrier as Pe, TLChild as G, useI18N as ue, useTLDataUrl as Ye, scrollToAnchor as Mn, useStandaloneKeyboardScope as Oe, useFillHost as tt, FillProvider as nt, KeyboardScopeProvider as $t, useFocusTrap as Ht, CMD_VALUE_CHANGED as at, anchoredOverlayProps as Pn, register as z } from "tl-react-bridge";
const { useCallback: Kt, useRef: jn } = e, An = 300, Bn = ({ controlId: l, state: t }) => {
  const [n, a, o] = De({
    debounceMs: An,
...
}, { useCallback: Yt } = e, On = 300, Fn = ({ controlId: l, state: t }) => {
  const [n, a, o] = De({ debounceMs: On }), u = Yt(
    (m) => {
      a(m.target.value);
    },
    [a]
...
}, { useCallback: Gt } = e, $n = 300, Hn = ({ controlId: l, state: t, config: n }) => {
  const [a, o, u] = De({ debounceMs: $n }), s = Gt(
    (p) => {
  ...
  const t = X(), n = ne(), a = Ke(), o = Ye(), u = ue(hl), s = t.chips ?? [], i = t.editable === !0, [r, c] = e.useState(!1), [d, m] = e.useState(!1), p = e.useRef(null), h = e.useCallback(async (E) => {
    ...
    if (E.hasData)
      try {
        ...
        const S = await b.blob(), M = URL.createObjectURL(S), R = document.createElement("a");
        R.href = M, R.download = E.name, R.style.display = "none", document.body.appendChild(R), R.click(), document.body.removeChild(R), URL.revokeObjectURL(M);
      } catch (w) {
...
const Nl = ({ controlId: l }) => {
  ...
  const t = X(), n = Ye(), a = !!t.hasPdf, o = t.dataRevision ?? 0, u = ue(Il), i = n.indexOf("react-api/"), r = i >= 0 ? n.slice(0, i) : n, c = n + "&rev=" + o, d = r + "html/pdfjs/web/viewer.html?file=" + encodeURIComponent(c);
...
}, { useCallback: Xt, useRef: _t } = e, Pl = ({ controlId: l }) => {
  const t = X(), n = ne(), a = gt(!0), o = t.orientation, u = t.resizable === !0, s = t.children ?? [], i = o === "horizontal", r = s.length > 0 && s.every((v) => v.collapsed), c = !r && s.some((v) => v.collapsed), d = r ? !i : i, m = _t(null), p = _t(null), h = _t(null), g = Xt((v, y) => {
    const C = {
    ...
    const S = (R) => {
      ...
      if (document.removeEventListener("mousemove", S), document.removeEventListener("mouseup", M), document.body.style.cursor = "", document.body.style.userSelect = "", h.current) {
        const R = {};
        s.forEach(($, H) => {
          const A = $.control;
    ...
    document.addEventListener("mousemove", S), document.addEventListener("mouseup", M), document.body.style.cursor = i ? "col-resize" : "row-resize", document.body.style.userSelect = "none";
  }, [s, i, n]), _ = [];
  ...
  const t = X(), n = ne(), a = ue(jl), o = t.title, u = t.expansionState ?? "NORMALIZED", s = t.showMinimize === !0, i = t.showMaximize === !0, r = t.showPopOut === !0, c = t.fullLine === !0, d = t.fill === !0, m = t.hoverActions === !0, p = t.appearance === "card", h = t.errorMessage, g = u === "MINIMIZED", k = u === "MAXIMIZED", _ = u === "HIDDEN", v = Ct(() => {
    n("toggleMinimize");
  }, [n]), y = Ct(() => {
    n("toggleMaximize");
  }, [n]), C = Ct(() => {
...
}, { useCallback: Ee, useState: dt, useEffect: Mt, useRef: pt } = e, zl = {
...
function Pt(l, t, n, a) {
  ...
  for (const u of l)
    ...
    } else u.type === "command" ? o.push({ id: u.id, type: "command", groupId: a }) : u.type === "group" && (o.push({ id: u.id, type: "group" }), (n.get(u.id) ?? u.expanded) && !t && o.push(...Pt(u.children, t, n, u.id)));
  return o;
}
const Ve = ({ icon: l }) => l ? /* @__PURE__ */ e.createElement(Ne, { encoded: l, className: "tlSidebar__icon" }) : null, Vl = ({ item: l, active: t, collapsed: n, onSelect: a, tabIndex: o, itemRef: u, onFocus: s }) => /* @__PURE__ */ e.createElement(
...
}, { useCallback: qt, useRef: sa } = e, ca = ({ onClose: l }) => (me("ESCAPE", () => (l(), !0)), null), ia = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.open === !0, o = t.closeOnBackdrop !== !1, u = t.child, s = sa(null), i = qt(() => {
    n("close");
  }, [n]), r = qt((c) => {
    o && c.target === c.currentTarget && i();
  }, [o, i]);
  return a ? /* @__PURE__ */ e.createElement($t, null, /* @__PURE__ */ e.createElement(ca, { onClose: i }), /* @__PURE__ */ e.createElement(
    "div",
    {
      id: l,
  ...
  const t = X(), n = ne(), a = ue(fa), o = t.title ?? "", u = t.width ?? "32rem", s = t.height ?? null, i = t.minHeight ?? null, r = t.resizable === !0, c = t.child, d = t.actions ?? [], m = t.toolbar, p = t.buttonBar, [h, g] = ot(null), [k, _] = ot(null), [v, y] = ot(null), C = $e(null), [L, E] = ot(!1), w = $e(null), b = $e(null), S = $e(null), M = $e(null), R = $e(null), $ = rt(() => {
    n("close");
  }, [n]);
  Ht(!0, M, "field");
  const H = rt((B, x) => {
    ...
    const D = M.current;
    if (!D) return;
    const K = D.getBoundingClientRect(), f = !C.current, I = C.current ?? { x: K.left, y: K.top };
    f && (C.current = I, y(I)), R.current = {
      dir: B,
      startX: x.clientX,
      startY: x.clientY,
      startW: K.width,
    ...
    const Y = (Z) => {
      ...
      let le = F.startW, ge = F.startH, ve = 0, we = 0;
      F.symmetric ? (F.dir.includes("e") && (le = F.startW + 2 * te), F.dir.includes("w") && (le = F.startW - 2 * te), F.dir.includes("s") && (ge = F.startH + 2 * ce), F.dir.includes("n") && (ge = F.startH - 2 * ce)) : (F.dir.includes("e") && (le = F.startW + te), F.dir.includes("w") && (le = F.startW - te, ve = te), F.dir.includes("s") && (ge = F.startH + ce), F.dir.includes("n") && (ge = F.startH - ce, we = ce));
    ...
    const x = M.current;
    if (!x) return;
    const D = x.getBoundingClientRect(), K = C.current ?? { x: D.left, y: D.top }, f = B.clientX - K.x, I = B.clientY - K.y, Y = (Z) => {
      const F = window.innerWidth, te = window.innerHeight;
      let ce = Z.clientX - f, le = Z.clientY - I;
      const ge = x.offsetWidth, ve = x.offsetHeight;
      ce + ge > F && (ce = F - ge), le + ve > te && (le = te - ve), ce < 0 && (ce = 0), le < 0 && (le = 0);
      const we = { x: ce, y: le };
      C.current = we, y(we);
    }, U = () => {
      document.removeEventListener("mousemove", Y), document.removeEventListener("mouseup", U);
  ...
  return /* @__PURE__ */ e.createElement($t, { modal: !0 }, /* @__PURE__ */ e.createElement(pa, { onClose: $ }), /* @__PURE__ */ e.createElement(
    "div",
    {
      id: l,
      className: "tlWindow",
...
}, { useCallback: ya, useEffect: Zt, useRef: wa, useState: Qt } = e, ka = 250, Na = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.message ?? "", o = t.content ?? "", u = t.variant ?? "info", s = t.duration ?? 5e3, i = t.visible === !0, r = t.generation ?? 0, [c, d] = Qt(!1), [m, p] = Qt(!1), h = wa(!1);
  Zt(() => {
    h.current = !1;
  }, [r]);
  const g = ya(() => {
...
}, { useCallback: Sa, useEffect: Jt, useMemo: Da, useRef: Ta, useState: Ra } = e, La = 1e3;
function xa(l) {
...
}, { useCallback: yt, useEffect: en, useRef: Ma, useState: tn } = e, Pa = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.open === !0, o = t.anchorId, u = t.anchorX, s = t.anchorY, i = t.items ?? [], r = Ma(null), [c, d] = tn({ top: 0, left: 0 }), [m, p] = tn(0), h = i.filter((v) => v.type === "item" && !v.disabled);
  en(() => {
    var b, S;
    if (!a) return;
    ...
    if (u != null && s != null) {
      let M = s, R = u;
      M + v > window.innerHeight && (M = Math.max(0, window.innerHeight - v)), R + y > window.innerWidth && (R = Math.max(0, window.innerWidth - y)), d({ top: M, left: R }), p(0);
      return;
    }
    if (!o) return;
...
}, nn = 50, $a = 'input, textarea, select, button, a, [contenteditable="true"], [role="combobox"], [role="listbox"], [role="option"], [role="button"], [role="link"], [role="checkbox"], [role="radio"], [role="switch"], [role="textbox"], [role="spinbutton"], [role="slider"], [role="menu"], [role="menuitem"]';
function wt(l) {
  var n;
  const t = l.target;
  return !!((n = t == null ? void 0 : t.closest) != null && n.call(t, $a));
}
const jt = 'input:not([disabled]):not([readonly]), textarea:not([disabled]):not([readonly]), select:not([disabled]), [contenteditable="true"]', Ha = jt + ", button:not([disabled]), a[href]";
function bn(l, t) {
...
function kt(l, t, n = {}) {
  const a = bn(l, t);
  if (n.col) {
    const u = a.find((i) => i.dataset.col === n.col), s = u == null ? void 0 : u.querySelector(jt);
    if (s) return s;
  }
  if (n.col)
    return null;
...
const Wa = ({ controlId: l }) => {
  ...
  const u = t.columns ?? [], s = t.totalRowCount ?? 0, i = t.rows ?? [], r = t.rowHeight ?? 36, c = t.selectionMode ?? "single", d = t.selectedCount ?? 0, m = t.cursorIndex ?? -1, p = t.frozenColumnCount ?? 0, h = t.treeMode ?? !1, g = t.columnSelect ?? !1, k = e.useMemo(
    ...
    [u]
  ), _ = c === "multi", v = 40, y = 20, C = e.useRef(null), L = e.useRef(null), E = e.useRef(null), w = e.useRef(null), b = e.useRef(null), [S, M] = e.useState({}), R = e.useRef(null), $ = e.useRef(!1), H = e.useRef(null), [A, W] = e.useState(null), [P, j] = e.useState(null), [B, x] = e.useState(null), [D, K] = e.useState(0);
  e.useEffect(() => {
    const N = E.current;
    if (!N)
      return;
  ...
  const f = e.useCallback((N) => S[N.name] ?? N.width, [S]), I = e.useMemo(() => {
    ...
    const re = () => {
      const se = R.current;
      if (!se) return;
      const de = Math.max(nn, se.startWidth + (Q - se.startX) + ee);
      M((Ce) => ({ ...Ce, [se.column]: de }));
    }, oe = () => {
      const se = E.current, de = C.current;
      if (!se || !R.current) return;
      const Ce = se.getBoundingClientRect(), Le = 40, zt = 8, In = se.scrollLeft;
      Q > Ce.right - Le ? se.scrollLeft += zt : Q < Ce.left + Le && (se.scrollLeft = Math.max(0, se.scrollLeft - zt));
      const Vt = se.scrollLeft - In;
      Vt !== 0 && (de && (de.scrollLeft = se.scrollLeft), ee += Vt, re()), Z.current = requestAnimationFrame(oe);
    };
    ...
    const fe = (se) => {
      ...
      const de = R.current;
      if (de) {
        const Ce = Math.max(nn, de.startWidth + (se.clientX - de.startX) + ee);
    ...
    if (V && !V.isCollapsed && T.currentTarget.contains(V.anchorNode))
      return;
    if (!wt(T) && ((ee = E.current) == null || ee.focus({ preventScroll: !0 }), !T.ctrlKey && !T.metaKey && !T.shiftKey)) {
    ...
    wt(T) && (Q != null && Q.selected) && !T.ctrlKey && !T.metaKey && !T.shiftKey || n("select", {
      rowIndex: N,
  ...
  const q = e.useCallback((N) => {
    ...
    if (!re)
      return;
    const oe = bn(T, ee).flatMap((Le) => Array.from(Le.querySelectorAll(Ha))), fe = oe.indexOf(V);
    if (fe < 0)
      return;
    const pe = !N.shiftKey;
    ...
    Ce && kt(T, Ce.id) || (N.preventDefault(), b.current = { index: de, last: !pe }, n("select", { rowIndex: de, ctrlKey: !1, shiftKey: !1 }));
  }, [i, s, n]), ae = e.useCallback((N, T) => {
    T.stopPropagation(), n("select", { rowIndex: N, ctrlKey: !0, shiftKey: !1 });
  }, [n]), ie = e.useCallback(() => {
    const N = d === s && s > 0;
    n("selectAll", { selected: !N });
  }, [n, d, s]), Ge = e.useCallback((N, T, V) => {
    V.stopPropagation(), n("expand", { rowIndex: N, expanded: T });
  }, [n]), kn = e.useCallback((N, T) => {
    ...
    const oe = (pe) => {
      ...
      document.removeEventListener("mousemove", oe), document.removeEventListener("mouseup", fe), x(null), re.count !== p && n("setFrozenColumnCount", { count: re.count });
    };
  ...
  }, [n]), Et = u.reduce((N, T) => N + f(T), 0) + (_ ? v : 0), vt = g ? 32 : 0, Ln = d === s && s > 0, Ut = d > 0 && d < s, xn = e.useCallback((N) => {
    N && (N.indeterminate = Ut);
  }, [Ut]);
  return /* @__PURE__ */ e.createElement($t, { active: O }, /* @__PURE__ */ e.createElement(
    Oa,
    {
      isMulti: _,
      cursorIndex: m,
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlTableView__headerArea", ref: L }, /* @__PURE__ */ e.createElement("div", { className: "tlTableView__header", ref: C }, /* @__PURE__ */ e.createElement(
      "div",
      {
        ...
        style: { width: Et, paddingRight: vt + D }
      },
    ...
    /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement("div", { style: { height: U, position: "relative", width: Et, paddingRight: vt } }, i.map((N) => /* @__PURE__ */ e.createElement(
        "div",
        {
          key: N.id,
          ...
          onMouseDown: (T) => {
            (T.shiftKey || T.ctrlKey || T.metaKey || T.detail > 1) && !wt(T) && T.preventDefault();
          },
          ...
          return /* @__PURE__ */ e.createElement(
            "div",
            {
              ...
              style: {
                ...
                ...re ? { position: "sticky", left: I[V], zIndex: 2 } : {}
              }
            },
            pe ? /* @__PURE__ */ e.createElement("div", { className: "tlTableView__treeCell", style: { paddingLeft: se * y } }, N.expandable ? /* @__PURE__ */ e.createElement(
              "button",
              {
                ...
                onClick: (de) => Ge(N.index, !N.expanded, de)
              },
              N.expanded ? "▾" : "▸"
  ...
  const t = X(), n = ne(), a = ue(Ua), o = t.entries ?? [], u = o.filter((E) => E.visible).length, [s, i] = e.useState(""), r = s.trim().toLowerCase(), c = r ? o.filter((E) => E.label.toLowerCase().includes(r)) : o, d = e.useRef(null), m = e.useRef(null), [p, h] = e.useState(null), g = e.useCallback((E) => {
    ...
    if (d.current = null, g(null), !w || !b)
      return;
    const S = o.findIndex(($) => $.name === b.name), M = o.findIndex(($) => $.name === w);
    if (S < 0 || M < 0)
      return;
    let R = b.side === "top" ? S : S + 1;
    M < R && R--, R !== M && n("columnReorder", { column: w, targetIndex: R });
  }, [o, n, g]), L = o.length > 10;
...
}, { useState: At, useRef: Je, useCallback: mt, useMemo: Ae, useEffect: ln } = e, Va = {
...
}, _e = 44, ft = 15, ye = 6e4, Ka = 36e5, Me = 864e5, Ya = 8;
function Se(l) {
  const t = new Date(l);
...
const Nt = (l) => {
...
}, Bt = ({ className: l, placeholder: t, style: n, onCommit: a, onDiscard: o }) => {
  const u = Je(!1), s = (i) => {
  ...
  const { events: a, locale: o, nonWorkingDays: u, dayStartHour: s, dayEndHour: i, now: r, send: c, editable: d, i18n: m } = l, p = Ae(() => {
    ...
    return j;
  }, [t, n, u]), h = gn(c), g = Je(null), k = Je(null), [_, v] = At(null), y = Je(null);
  y.current = _;
  const [C, L] = At(Date.now());
  ln(() => {
  ...
  const E = mt(
    (P, j) => {
      ...
      const x = B.getBoundingClientRect(), D = x.width / p.length, K = qe(Math.floor((P - x.left) / D), 0, p.length - 1), f = j - x.top + B.scrollTop, I = qe(f / _e * 60, 0, 1440);
      return { dayIndex: K, min: I };
    },
    [p.length]
  );
  ln(() => {
  ...
  const w = (P, j, B) => {
    if (!d || !j.movable)
      return;
    P.stopPropagation(), Nt(P), h.discard();
    const { min: x } = E(P.clientX, P.clientY), D = (j.end - j.start) / ye;
    v({
      mode: "move",
      id: j.id,
      grabMin: x - Ie(j.start),
      dur: D,
      dayStart: B,
      startMin: Ie(j.start),
      origStartMs: j.start
    ...
    !d || !j.resizable || (P.stopPropagation(), Nt(P), h.discard(), v({
      mode: "resize",
      id: j.id,
      dayStart: B,
      startMin: Ie(j.start),
  ...
  }, M = Array.from({ length: 24 }, (P, j) => j), R = Ae(() => {
    if (_ === null || !("id" in _))
      return a;
    const P = _;
    return a.map((j) => {
    ...
    (P) => Ja(
      R.filter((j) => !j.allDay && j.start < P + Me && j.end > P)
    )
  ), [p, R]), H = Ae(() => p.map((P) => R.filter((j) => j.allDay && j.start < P + Me && j.end > P)), [p, R]), A = s * _e, W = i * _e;
  return /* @__PURE__ */ e.createElement("div", { className: "tlCalTimeGrid" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalTimeHeader" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalGutter" }), p.map((P) => {
    ...
    return /* @__PURE__ */ e.createElement(
      ...
      et(P, C) && /* @__PURE__ */ e.createElement("div", { className: "tlCalNowLine", style: { top: Ie(Date.now()) / 60 * _e } }),
      $[j].map((D) => {
        const K = _ !== null && "id" in _ && _.id === D.ev.id, f = D.topMin / 60 * _e, I = (D.botMin - D.topMin) / 60 * _e, Y = 100 / D.cols;
        return /* @__PURE__ */ e.createElement(
          "div",
          {
            key: D.ev.id,
  ...
  const { events: a, locale: o, nonWorkingDays: u, send: s, editable: i, now: r, i18n: c } = l, d = gn(s), m = Ae(() => {
    const h = [];
    for (let g = 0; g < 6; g++) {
      const k = [];
      for (let _ = 0; _ < 7; _++)
  ...
  return /* @__PURE__ */ e.createElement("div", { className: "tlCalMonth" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthHead" }, m[0].map((h) => /* @__PURE__ */ e.createElement("div", { key: h, className: "tlCalMonthWeekday" }, Be(o, { weekday: "short" }, h)))), /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthBody" }, m.map((h, g) => {
    const k = h[0], _ = ze(k, 7), v = a.filter((C) => (C.allDay || C.end - C.start >= Me) && C.start < _ && C.end > k).sort((C, L) => C.start - L.start).slice(0, 3), y = v.length;
    return /* @__PURE__ */ e.createElement("div", { key: g, className: "tlCalMonthWeek" }, /* @__PURE__ */ e.createElement("div", { className: "tlCalMonthDays" }, h.map((C) => {
      ...
      return /* @__PURE__ */ e.createElement(
        "div",
        {
          ...
          onDrop: (b) => p(b, C),
          onClick: () => i && d.open({ start: C, end: C + Me, allDay: !0 })
        },
        /* @__PURE__ */ e.createElement(
          "div",
          {
      ...
      const E = Math.max(0, Math.floor((Se(Math.max(C.start, k)) - k) / Me)), w = Math.min(7, Math.ceil((C.end - k) / Me));
      return /* @__PURE__ */ e.createElement(
        "div",
        {
          key: C.id,
      ...
      const E = a.filter((S) => !S.allDay && S.end - S.start < Me && et(S.start, C)).sort((S, M) => S.start - M.start), w = E.slice(0, tr), b = E.length - w.length;
      return w.map((S, M) => /* @__PURE__ */ e.createElement(
        "div",
        {
          key: S.id,
          className: "tlCalChip " + ht(S.category) + (S.selected ? " tlCalEvent--selected" : ""),
          style: bt(S, { gridColumn: L + 1, gridRow: y + 1 + M }),
...
}, En = e.createContext(rr), { useMemo: or, useRef: sr, useState: cr, useEffect: ir } = e, ur = 320, dr = "TLTableView", mr = "TLPanel", pr = ({ controlId: l }) => {
  var _;
  ...
  return s ? /* @__PURE__ */ e.createElement("div", { id: l, className: "tlFormLayout tlFormLayout--empty", ref: i }, /* @__PURE__ */ e.createElement("p", { className: "tlFormLayout__noModel" }, s)) : /* @__PURE__ */ e.createElement(En.Provider, { value: d }, /* @__PURE__ */ e.createElement("div", { id: l, className: k, style: p, ref: i }, u.map((v, y) => /* @__PURE__ */ e.createElement(G, { key: y, control: v }))));
}, { useCallback: fr } = e, hr = {
  ...
  const t = X(), n = gr(En), a = t.label ?? "", o = t.required === !0, u = t.error, s = t.errorIcon, i = t.warnings, r = t.warningIcon, c = t.helpText, d = t.dirty === !0, m = t.labelPosition ?? n.resolvedLabelPosition, p = t.fullLine === !0, h = t.visible !== !1, g = t.hasTooltip === !0, k = t.field, _ = n.readOnly, [v, y] = Er(!1), C = vr(() => y((S) => !S), []), L = m === "hidden", E = u != null, w = i != null && i.length > 0, b = [
    "tlFormField",
    `tlFormField--${m}`,
  ...
  const p = e.useCallback((b, S) => {
    ...
    M && !M.isCollapsed && S.currentTarget.contains(M.anchorNode) || ((R = d.current) == null || R.focus({ preventScroll: !0 }), t("select", {
      nodeId: b,
    ...
    const M = S.getBoundingClientRect(), R = b.clientY - M.top, $ = M.height / 3;
    ...
    const M = _(S, S.currentTarget);
    k.current != null && window.clearTimeout(k.current), k.current = window.setTimeout(() => {
      t("dragOver", { nodeId: b, position: M }), k.current = null;
    }, 50);
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    n.map((b, S) => /* @__PURE__ */ e.createElement(
      "li",
      {
        ...
        style: { paddingLeft: b.depth * yr },
        draggable: o,
        onMouseDown: (M) => {
          (M.shiftKey || M.ctrlKey || M.metaKey || M.detail > 1) && M.preventDefault();
        },
        onClick: (M) => h(b.id, M),
        onContextMenu: (M) => g(b.id, M),
        onDragStart: (M) => v(b.id, M),
        onDragOver: u ? (M) => y(b.id, M) : void 0,
        onDrop: u ? (M) => C(b.id, M) : void 0,
        onDragEnd: L
      },
      b.expandable ? /* @__PURE__ */ e.createElement(
        "button",
        {
          ...
          onClick: (M) => {
            M.stopPropagation(), p(b.id, b.expanded);
          },
          tabIndex: -1,
...
var St = { exports: {} }, he = {}, Dt = { exports: {} }, J = {};
/**
 * @license React
 * react.production.js
 *
...
function kr() {
  ...
  function v(f, I, Y) {
    this.props = f, this.context = I, this.refs = _, this.updater = Y || g;
  }
  ...
  var A = /\/+/g;
  function W(f, I) {
    return typeof f == "object" && f !== null && f.key != null ? H("" + f.key) : I.toString(36);
  }
  function P(f) {
    switch (f.status) {
      case "fulfilled":
  ...
  function j(f, I, Y, U, Z) {
    ...
    if (te)
      return Z = Z(f), te = U === "" ? "." + W(f, 0) : U, E(Z) ? (Y = "", te != null && (Y = te.replace(A, "$&/") + "/"), j(Z, I, Y, "", function(ge) {
        return ge;
      })) : Z != null && ($(Z) && (Z = R(
        Z,
  ...
  return J.Activity = m, J.Children = K, J.Component = v, J.Fragment = n, J.Profiler = o, J.PureComponent = C, J.StrictMode = a, J.Suspense = r, J.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = b, J.__COMPILER_RUNTIME = {
    ...
    if (I != null)
      for (F in I.key !== void 0 && (Z = "" + I.key), I)
        !S.call(I, F) || F === "key" || F === "__self" || F === "__source" || F === "ref" && I.ref === void 0 || (U[F] = I[F]);
    ...
    if (I != null)
      for (U in I.key !== void 0 && (F = "" + I.key), I)
        S.call(I, U) && U !== "key" && U !== "__self" && U !== "__source" && (Z[U] = I[U]);
...
var rn;
function Nr() {
  return rn || (rn = 1, Dt.exports = kr()), Dt.exports;
}
/**
 * @license React
...
function Dr() {
  ...
  return l(), St.exports = Sr(), St.exports;
}
var vn = Dr();
const { useState: xe, useCallback: be, useRef: Ze, useEffect: He, useMemo: Ot } = e;
function Wt({ image: l }) {
...
function Tr({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(Wt, { image: l.image }),
...
function Rr({
  ...
  const s = be(() => a(l.value), [a, l.value]), i = Ot(() => {
    if (!n) return l.label;
...
const Lr = ({ controlId: l, state: t }) => {
  ...
  }), g = h["js.dropdownSelect.nothingFound"], k = be(
    (O) => h["js.dropdownSelect.removeChip"].replace("{0}", O),
    [h]
  ), [_, v] = xe(!1), [y, C] = xe(""), [L, E] = xe(-1), [w, b] = xe(!1), [S, M] = xe({}), [R, $] = xe(null), [H, A] = xe(null), [W, P] = xe(null), j = Ze(null), B = Ze(null), x = Ze(null), D = Ze(a);
  D.current = a;
  const K = Ze(-1), f = Ot(
  ...
  const Y = be(async () => {
    ...
    (O) => {
      ...
      D.current = q, n(at, { value: q.map((ae) => ae.value) }), o ? (C(""), E(-1)) : U();
    },
    [o, d, n, U]
  ), F = be(
    (O) => {
      K.current = D.current.findIndex((ae) => ae.value === O);
      const q = D.current.filter((ae) => ae.value !== O);
      D.current = q, n(at, { value: q.map((ae) => ae.value) });
    },
    [n]
  ), te = be(
    (O) => {
    ...
    (O, q) => {
      ...
      const ae = q.currentTarget.getBoundingClientRect(), ie = ae.left + ae.width / 2, Ge = q.clientX < ie ? "before" : "after";
      A(O), P(Ge);
    },
    [R]
  ), Te = be(
    (O) => {
      ...
      const q = [...D.current], [ae] = q.splice(R, 1);
      let ie = H;
      R < H ? ie = W === "before" ? ie - 1 : ie : ie = W === "before" ? ie : ie + 1, q.splice(ie, 0, ae), D.current = q, n(at, { value: q.map((Ge) => Ge.value) }), $(null), A(null), P(null);
    },
    [R, H, W, n]
  ), Re = be(() => {
    $(null), A(null), P(null);
  ...
  if (He(() => {
    ...
    return /* @__PURE__ */ e.createElement("div", { id: l, className: "tlDropdownSelect tlDropdownSelect--immutable" }, a.map((O) => /* @__PURE__ */ e.createElement("span", { key: O.value, className: "tlDropdownSelect__readonlyValue" }, /* @__PURE__ */ e.createElement(Wt, { image: O.image }), /* @__PURE__ */ e.createElement("span", null, O.label))));
  const Fe = !s && a.length > 0 && !i, lt = _ ? /* @__PURE__ */ e.createElement(
    "div",
    {
      ref: x,
    ...
    /* @__PURE__ */ e.createElement(
      ...
      w && /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__error" }, /* @__PURE__ */ e.createElement("a", { href: "#", onClick: ge }, h["js.dropdownSelect.error"])),
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__chips" }, a.length === 0 ? /* @__PURE__ */ e.createElement("span", { className: "tlDropdownSelect__placeholder" }, m) : a.map((O, q) => {
      let ae = "";
      return R === q ? ae = "tlDropdownSelect__chip--dragging" : H === q && W === "before" ? ae = "tlDropdownSelect__chip--dropBefore" : H === q && W === "after" && (ae = "tlDropdownSelect__chip--dropAfter"), /* @__PURE__ */ e.createElement(
        Tr,
        {
          key: O.value,
          option: O,
          ...
          draggable: p,
          onDragStart: p ? (ie) => ve(q, ie) : void 0,
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDropdownSelect__controls" }, Fe && /* @__PURE__ */ e.createElement(
      "button",
      {
        type: "button",
  ...
  ), lt && vn.createPortal(lt, document.body));
}, { useCallback: Tt, useRef: xr } = e, _n = "application/x-tl-color", Ir = ({
  colors: l,
  columns: t,
  onSelect: n,
  onConfirm: a,
  ...
  const s = xr(null), i = Tt(
    ...
    (d) => (m) => {
      m.preventDefault();
      const p = m.dataTransfer.getData(_n);
...
function wn(l, t, n) {
  const a = (o) => Cn(o).toString(16).padStart(2, "0");
  return "#" + a(l) + a(t) + a(n);
}
function Mr(l, t, n) {
...
const { useCallback: We, useRef: cn } = e, Ar = ({ color: l, onColorChange: t }) => {
  const [n, a, o] = jr(l), u = cn(null), s = cn(null), i = We(
    (g, k) => {
      var C;
...
const Or = {
  ...
  "js.colorInput.ok": "OK"
}, { useState: ct, useCallback: ke, useEffect: un, useRef: Fr, useLayoutEffect: $r } = e, Hr = ({
  anchorRef: l,
  currentColor: t,
  palette: n,
  paletteColumns: a,
  ...
  const [c, d] = ct("palette"), [m, p] = ct(t), h = Fr(null), g = ue(Or), [k, _] = ct(null);
  $r(() => {
  ...
  const v = m != null, [y, C, L] = v ? yn(m) : [0, 0, 0], [E, w] = ct((m == null ? void 0 : m.toUpperCase()) ?? "");
  un(() => {
  ...
  const b = ke(
    (x) => (D) => {
      ...
      if (isNaN(K)) return;
      const f = Cn(K);
      p(wn(x === "r" ? f : y, x === "g" ? f : C, x === "b" ? f : L));
    },
    [y, C, L]
  ), S = ke(
    (x) => {
      if (m != null) {
        x.dataTransfer.setData(_n, m.toUpperCase()), x.dataTransfer.effectAllowed = "move";
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__body" }, c === "palette" ? /* @__PURE__ */ e.createElement("div", { className: "tlColorInput__paletteArea" }, /* @__PURE__ */ e.createElement(
      ...
      "input",
      {
        className: "tlColorInput__input" + (E !== "" && !Ft(E) ? " tlColorInput__input--error" : ""),
        type: "text",
        value: E,
        onChange: M
      }
...
}, Wr = { "js.colorInput.chooseColor": "Choose color" }, { useState: Ur, useCallback: it, useRef: zr } = e, Vr = ({ controlId: l, state: t }) => {
  const [n, a] = De(), o = ne(), u = ue(Wr), [s, i] = Ur(!1), r = zr(null), c = n, d = t.editable !== !1, m = t.palette ?? [], p = t.paletteColumns ?? 6, h = t.defaultPalette ?? m, g = it(() => {
    d && i(!0);
  }, [d]), k = it(
    (y) => {
      i(!1), a(y);
...
}, { useState: Qe, useCallback: je, useEffect: Lt, useRef: dn, useLayoutEffect: Kr, useMemo: Yr } = e, Gr = {
  ...
  const i = ue(Gr), [r, c] = Qe("simple"), [d, m] = Qe(""), [p, h] = Qe(t ?? ""), [g, k] = Qe(!1), [_, v] = Qe(null), y = dn(null), C = dn(null);
  Kr(() => {
...
}, qr = { "js.iconSelect.chooseIcon": "Choose icon" }, { useState: Zr, useCallback: ut, useRef: Qr } = e, Jr = ({ controlId: l, state: t }) => {
  const [n, a] = De(), o = ne(), u = ue(qr), [s, i] = Zr(!1), r = Qr(null), c = n, d = t.editable !== !1, m = t.disabled === !0, p = t.icons ?? [], h = t.iconsLoaded === !0, g = ut(() => {
    d && !m && i(!0);
  }, [d, m]), k = ut(
    (y) => {
      i(!1), a(y);
...
}, { useCallback: Ue, useEffect: eo, useMemo: mn, useRef: to, useState: xt } = e, no = {
  quarter: 0.25,
  third: 1 / 3,
  half: 0.5,
  "two-thirds": 2 / 3,
...
const co = ({ controlId: l }) => {
  const t = X(), n = ne(), a = t.minColWidth ?? "16rem", o = (t.children ?? []).filter((w) => w && w.id), u = to(null), [s, i] = xt(1), r = t.editMode === !0;
  eo(() => {
    const w = u.current;
    if (!w) return;
    const b = parseFloat(getComputedStyle(document.documentElement).fontSize) || 16, S = ao(a, b), M = () => i(ro(w.clientWidth, S));
    M();
    const R = new ResizeObserver(M);
    return R.observe(w), () => R.disconnect();
  }, [a]);
  const c = mn(() => so(o, s), [o, s]), d = mn(() => {
    const w = {};
    for (const b of c) w[b.id] = b;
    return w;
  }, [c]), [m, p] = xt(null), [h, g] = xt(null), k = Ue((w, b) => {
    if (!r) {
      w.preventDefault();
      return;
    }
    ...
    if (!r || !m || m === b) return;
    w.preventDefault(), w.dataTransfer.dropEffect = "move";
    const S = w.currentTarget.getBoundingClientRect(), M = w.clientX < S.left + S.width / 2;
    g((R) => R && R.id === b && R.before === M ? R : { id: b, before: M });
  }, [r, m]), v = Ue(() => {
  }, []), y = Ue((w, b, S) => {
    const M = o.map((A) => A.id), R = M.indexOf(w);
    if (R < 0) return;
    M.splice(R, 1);
    const $ = M.indexOf(b);
    if ($ < 0) {
    ...
    const H = S ? $ : $ + 1;
    M.splice(H, 0, w), n("reorder", { order: M });
  }, [o, n]), C = Ue((w, b) => {
    if (!r || !m || m === b) return;
    w.preventDefault();
    const S = w.currentTarget.getBoundingClientRect(), M = w.clientX < S.left + S.width / 2;
    y(m, b, M), p(null), g(null);
  }, [r, m, y]), L = Ue(() => {
    p(null), g(null);
  }, []), E = {
    display: "grid",
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "tlDashboard__grid", style: E }, o.map((w) => {
      ...
      return m === w.id && M.push("tlDashboard__tile--dragging"), h && h.id === w.id && M.push(h.before ? "tlDashboard__tile--dropBefore" : "tlDashboard__tile--dropAfter"), /* @__PURE__ */ e.createElement(
        "div",
        {
          key: w.id,
          className: M.join(" "),
...
}, { useCallback: io, useRef: pn, useState: fn, useEffect: uo, useLayoutEffect: mo } = e, po = ({ group: l }) => {
  ...
  var m, p;
  const [t, n] = fn(!1), [a, o] = fn({}), u = pn(null), s = pn(null), i = io(() => {
    n((h) => !h);
  }, []);
  mo(() => {
    if (!t) return;
  ...
  }, [t]), Oe(t, { ESCAPE: () => n(!1) }), Ht(t, s, "first");
  ...
  return a.length === 0 ? null : /* @__PURE__ */ e.createElement("div", { id: l, className: "tlToolbar", role: "toolbar" }, a.map((o, u) => /* @__PURE__ */ e.createElement(e.Fragment, { key: o.name }, u > 0 && /* @__PURE__ */ e.createElement("span", { className: "tlToolbar__separator", "aria-hidden": "true" }), o.display === "menu" ? /* @__PURE__ */ e.createElement(fo, { group: o }) : /* @__PURE__ */ e.createElement(po, { group: o }))));
  ...
  return /* @__PURE__ */ e.createElement(nt, { host: a }, /* @__PURE__ */ e.createElement("div", { id: l, className: n ? "tlTileStack " + n : "tlTileStack" }, o.map((s, i) => /* @__PURE__ */ e.createElement(bo, { key: s.controlId, frame: s, covered: i !== u }))));
}, Eo = ({ controlId: l }) => {
...
}, _o = ({ controlId: l }) => /* @__PURE__ */ e.createElement("div", { id: l, className: "tlSlotContent", style: { display: "none" } }), Co = {
...
z("TLResourceCell", Cr);
z("TLTreeView", wr);
z("TLDropdownSelect", Lr);
z("TLColorInput", Vr);
z("TLIconSelect", Jr);
z("TLDashboard", co);
z("TLToolbar", ho);
z("TLTileStack", go);
z("TLAdaptiveDetail", Eo);
z("TLSlot", vo);
z("TLSlotContent", _o);
z("TLDrawerToggle", yo);
