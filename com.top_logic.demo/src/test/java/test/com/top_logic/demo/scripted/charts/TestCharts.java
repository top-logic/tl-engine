...
public class TestCharts {
	...
	/**
	 * a cumulative {@link Test} for all Tests in {@link TestCharts}.
	 */
	public static Test suite() {
		String[] testCases = {
			"01_Interactive_calculated",
			"02_ExcludedAttributes",
			"03_DownloadFileName",
		};
		TestSuite testSuite = XmlScriptedTestUtil.suite(TestCharts.class, testCases);
