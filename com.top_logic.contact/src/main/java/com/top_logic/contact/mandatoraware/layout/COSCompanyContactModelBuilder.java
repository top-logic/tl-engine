 ...
 */
public class COSCompanyContactModelBuilder extends CompanyContactModelBuilder {

	// private Object model;
	private TLStructuredTypePart metaAttribute;

	/**
	 * Singleton {@link COSCompanyContactModelBuilder} instance.
	 */
	public static final COSCompanyContactModelBuilder INSTANCE = new COSCompanyContactModelBuilder();

	private COSCompanyContactModelBuilder() {
	...
	public Object retrieveModelFromListElement(LayoutComponent aComponent, Object anObject) {
        return (((COSCompanyContact) anObject).getMandator());
    }
	...
	public boolean supportsModel(Object aModel, LayoutComponent aComponent) {
        return (aModel instanceof Mandator);
    }
