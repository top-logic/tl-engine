...
/**
 * Implementation of {@link com.top_logic.react.flow.data.EdgeDecoration}.
 */
public class EdgeDecoration_Impl extends com.top_logic.react.flow.data.impl.Widget_Impl implements com.top_logic.react.flow.data.EdgeDecoration {

	private double _linePosition = 0.0d;

	private com.top_logic.react.flow.data.OffsetPosition _offsetPosition = com.top_logic.react.flow.data.OffsetPosition.CENTER;
	 ...
	 *
	 * @see com.top_logic.react.flow.data.EdgeDecoration#create()
	 */
	...
	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setLinePosition(double value) {
	...
	@Override
	public final com.top_logic.react.flow.data.OffsetPosition getOffsetPosition() {
		return _offsetPosition;
	}

	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setOffsetPosition(com.top_logic.react.flow.data.OffsetPosition value) {
		internalSetOffsetPosition(value);
		return this;
	}

	/** Internal setter for {@link #getOffsetPosition()} without chain call utility. */
	protected final void internalSetOffsetPosition(com.top_logic.react.flow.data.OffsetPosition value) {
	...
	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setContent(com.top_logic.react.flow.data.Box value) {
	...
	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.EdgeDecoration setRenderInfo(java.lang.Object value) {
	...
	public void set(String field, Object value) {
		switch (field) {
			...
			case OFFSET_POSITION__PROP: internalSetOffsetPosition((com.top_logic.react.flow.data.OffsetPosition) value); break;
	...
	public void readField(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in, String field) throws java.io.IOException {
		switch (field) {
			...
			case OFFSET_POSITION__PROP: setOffsetPosition(com.top_logic.react.flow.data.OffsetPosition.readOffsetPosition(in)); break;
