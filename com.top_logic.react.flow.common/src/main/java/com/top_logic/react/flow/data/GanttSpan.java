...
public interface GanttSpan extends com.top_logic.react.flow.data.GanttItem {
	...
	/**
	 * Start position on the axis; see {@link GanttLayout#getRangeMin()} for position semantics.
	 */
	double getStart();
	...
	/**
	 * End position on the axis; see {@link GanttLayout#getRangeMin()} for position semantics.
	...
	@Override
	com.top_logic.react.flow.data.GanttSpan setRowModel(java.lang.Object value);
