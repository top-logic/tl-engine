...
/**
 * Implementation of {@link com.top_logic.react.flow.data.DropArea}.
 */
public class DropArea_Impl extends de.haumacher.msgbuf.graph.AbstractSharedGraphNode implements com.top_logic.react.flow.data.DropArea {
	...
	/**
	 * Creates a {@link DropArea_Impl} instance.
	 *
	 * @see com.top_logic.react.flow.data.DropArea#create()
	 */
	public DropArea_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.DropArea setX(double value) {
		internalSetX(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.DropArea setY(double value) {
		internalSetY(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.DropArea setWidth(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.DropArea setHeight(double value) {
