...
%><layout:html>
	...
	<layout:body>
		<p>
			...
			Der Tabber "Details Typ B" ist jetzt ausgeblendet.
		</p>
		<p>
			Die Komponente akzeptiert nur ein Modell vom Typ A. Ist kein A-Knoten gewählt, wird das Modell auf null gesetzt und der Tabber blendet sich aus (BoundComponent#allowNullModel()).
