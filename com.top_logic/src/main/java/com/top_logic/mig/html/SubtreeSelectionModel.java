 ...
 * 
 * <p>
 * The selection strategy in a {@link SubtreeSelectionModel} differs from the
 ...
 */
public abstract class SubtreeSelectionModel<N> extends AbstractMultiSelectionModel<N> {
	...
	public static class StateChanged<N> {
		...
		private final SubtreeSelectionModel<N> _sender;
		 ...
		 */
		public StateChanged(SubtreeSelectionModel<N> sender, Map<N, TriState> formerStates) {
			super();
			_sender = sender;
		...
		/**
		 * The {@link SubtreeSelectionModel} in which the states changed.
		 */
		public SubtreeSelectionModel<N> sender() {
			return _sender;
		}
	...
	/**
	 * Listener interfaces that is informed about changes {@link SubtreeSelectionModel}s.
	 */
	...
	/**
	 * Creates a {@link SubtreeSelectionModel}.
	 */
	public SubtreeSelectionModel(SelectionModelOwner owner, Class<N> nodeType) {
		super(owner);
		_nodeType = nodeType;
	}
