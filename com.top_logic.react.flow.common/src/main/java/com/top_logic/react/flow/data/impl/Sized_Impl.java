...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Sized}.
 */
public class Sized_Impl extends com.top_logic.react.flow.data.impl.Decoration_Impl implements com.top_logic.react.flow.data.Sized {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.Sized#create()
	 */
	public Sized_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.react.flow.data.Sized setMinWidth(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setMaxWidth(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setMinHeight(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setMaxHeight(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setDesiredX(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setDesiredY(Double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setPreserveAspectRatio(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.Sized setContent(com.top_logic.react.flow.data.Box value) {
		internalSetContent(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Sized setRenderInfo(java.lang.Object value) {
