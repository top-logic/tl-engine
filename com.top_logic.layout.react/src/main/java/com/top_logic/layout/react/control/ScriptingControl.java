 ...
 * </p>
 */
public interface ScriptingControl extends ReactCommandTarget {
	 ...
	 * {@link com.top_logic.layout.react.scripting.ScriptingNode}).
	 * </p>
	 */
	 ...
	 * </p>
	 */
	List<ReactControl> scriptingChildren();
	 ...
	 *
	 * @param child
	 *        A direct child control (an element of {@link #scriptingChildren()}).
	 * @return The slot segment for the child, or {@code null}.
	 */
	String scriptingChildSlot(ReactControl child);

	/**
	 * Formats a navigation-slot segment for {@link #scriptingChildSlot(ReactControl)}.
	 *
	 * @param role
	 ...
	 * represented as separate addressable nodes via {@link #scriptingChildren()}.
	 * </p>
	 */
	 ...
	 */
	ReactParam[] scriptingCommandParams(String command);
	 ...
	 * {@link #scriptingCommandParams(String) hand-declared params}.
	 * </p>
	 *
	 * @param command
	 *        The command ID.
	 */
	ConfigurationDescriptor scriptingCommandArgsType(String command);
}
