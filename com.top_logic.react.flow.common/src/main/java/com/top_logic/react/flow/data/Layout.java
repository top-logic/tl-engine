...
public interface Layout extends Box {
	 ...
	 * @see #getContents()
	 */
	com.top_logic.react.flow.data.Layout setContents(java.util.List<? extends com.top_logic.react.flow.data.Box> value);

	/**
	 * Adds a value to the {@link #getContents()} list.
	 */
	com.top_logic.react.flow.data.Layout addContent(com.top_logic.react.flow.data.Box value);
	...
	@Override
	com.top_logic.react.flow.data.Layout setX(double value);

	@Override
	com.top_logic.react.flow.data.Layout setY(double value);

	@Override
	com.top_logic.react.flow.data.Layout setWidth(double value);

	@Override
	com.top_logic.react.flow.data.Layout setHeight(double value);

	@Override
	com.top_logic.react.flow.data.Layout setCssClass(String value);

	@Override
	com.top_logic.react.flow.data.Layout setUserObject(java.lang.Object value);

	@Override
	com.top_logic.react.flow.data.Layout setClientId(String value);

	@Override
	com.top_logic.react.flow.data.Layout setRenderInfo(java.lang.Object value);

	/** Reads a new instance from the given reader. */
	static com.top_logic.react.flow.data.Layout readLayout(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.react.flow.data.Layout) scope.resolveOrFail(in.nextInt());
		}
		com.top_logic.react.flow.data.Layout result;
		in.beginArray();
