...
/**
 * {@link CompareExpression} for "greater".
 */
public class GtExpression extends CompareExpression {

	/**
	 * Creates a {@link GtExpression}.
	 */
	public GtExpression(TemplateExpression left, TemplateExpression right) {
		super(left, right);
	}
	...
	protected boolean compareObj(Object leftValue, Object rightValue) {
		...
		return Utils.isGreater(leftComparable, rightComparable);
	}
