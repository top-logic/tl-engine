...
public interface ExternalUserMapping {
	...
	/**
	 * Retrieves the logged-in {@link Person} using the name that the person has in the
	 * authentication system.
	 * 
	 * @param externalUserName
	 *        Name of the person in the authentication system.
	 * 
	 * @throws LoginDeniedException
	 *         When it is not possible to retrieve a valid {@link Person}.
	 */
	Person findPersonForExternalName(String externalUserName) throws LoginDeniedException;
	 ...
	 */
	static Person findValidPerson(String loginName) throws LoginDeniedException {
