 ...
 */
public class TestMedianFunction extends AbstractAggregationTest {

	public TestMedianFunction(String aTest) {
		super(aTest);
    }
	...
	public void testCalculateResult() {
		...
		MedianFunction mf = getFunction("value");
		...
		assertTrue(theValue.doubleValue() == 14.0);
		someObjects.clear();
	...
	protected MedianFunction getFunction(String anAttribute) {
	    return (MedianFunction) super.createFunction(MedianFunction.class, anAttribute);
	}
	
    public static Test suite() {
        return TLTestSetup.createTLTestSetup(TestMedianFunction.class);
    }
