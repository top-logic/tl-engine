...
/**
 * {@link ConfigurationValueProvider} for non-nullable properties of type <code>byte</code>.
 *
 * @author <a href="mailto:bhu@top-logic.com">Bernhard Haumacher</a>
 */
public final class PrimitiveByteFormat extends PrimitiveValueProvider {

	/**
	 * Singleton {@link PrimitiveByteFormat} instance.
	 */
	public static final PrimitiveByteFormat INSTANCE = new PrimitiveByteFormat();

	/** {@link GenericArrayFormat} for arrays of type "byte". */
	public static final GenericArrayFormat<byte[]> ARRAY_FORMAT = new GenericArrayFormat<>(byte[].class, INSTANCE);

	private PrimitiveByteFormat() {
		super(byte.class);
	}
