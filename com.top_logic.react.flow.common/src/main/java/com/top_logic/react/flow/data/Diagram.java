...
public interface Diagram extends Widget, com.top_logic.react.flow.operations.DiagramOperations {
	 ...
	 */
	static com.top_logic.react.flow.data.Diagram create() {
		return new com.top_logic.react.flow.data.impl.Diagram_Impl();
	}

	/** Identifier for the {@link com.top_logic.react.flow.data.Diagram} type in JSON format. */
	 ...
	 */
	com.top_logic.react.flow.data.Box getRoot();

	/**
	 * @see #getRoot()
	 */
	com.top_logic.react.flow.data.Diagram setRoot(com.top_logic.react.flow.data.Box value);
	 ...
	 * @see #isMultiSelect()
	 */
	com.top_logic.react.flow.data.Diagram setMultiSelect(boolean value);
	 ...
	 * @see #getClickHandler()
	 */
	com.top_logic.react.flow.data.Diagram setClickHandler(com.top_logic.react.flow.svg.event.Registration value);
	 ...
	 */
	com.top_logic.react.flow.callback.DiagramContext getContext();

	/**
	 * @see #getContext()
	 */
	com.top_logic.react.flow.data.Diagram setContext(com.top_logic.react.flow.callback.DiagramContext value);
	 ...
	 * @see #getViewBoxX()
	 */
	com.top_logic.react.flow.data.Diagram setViewBoxX(double value);
	 ...
	 * @see #getViewBoxY()
	 */
	com.top_logic.react.flow.data.Diagram setViewBoxY(double value);
	 ...
	 * @see #getViewBoxWidth()
	 */
	com.top_logic.react.flow.data.Diagram setViewBoxWidth(double value);
	 ...
	 * @see #getViewBoxHeight()
	 */
	com.top_logic.react.flow.data.Diagram setViewBoxHeight(double value);

	@Override
	com.top_logic.react.flow.data.Diagram setCssClass(String value);

	@Override
	com.top_logic.react.flow.data.Diagram setUserObject(java.lang.Object value);

	@Override
	com.top_logic.react.flow.data.Diagram setClientId(String value);

	@Override
	com.top_logic.react.flow.data.Diagram setRenderInfo(java.lang.Object value);

	/** Reads a new instance from the given reader. */
	static com.top_logic.react.flow.data.Diagram readDiagram(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.react.flow.data.Diagram) scope.resolveOrFail(in.nextInt());
		}
		in.beginArray();
		String type = in.nextString();
		assert DIAGRAM__TYPE.equals(type);
		int id = in.nextInt();
		com.top_logic.react.flow.data.impl.Diagram_Impl result = new com.top_logic.react.flow.data.impl.Diagram_Impl();
