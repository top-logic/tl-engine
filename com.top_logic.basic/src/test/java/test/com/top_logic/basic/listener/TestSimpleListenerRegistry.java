...
/**
 * Tests for {@link ListenerRegistry} which is not thread safe and stores the {@link Listener}s
 * directly.
 * 
 * @author <a href="mailto:Jan Stolzenburg@top-logic.com">Jan Stolzenburg</a>
 */
public class TestSimpleListenerRegistry extends TestCase {
	...
	private ListenerRegistry<Object> createListenerRegistry() {
		return ListenerRegistryFactory.getInstance().createSimple();
	}
