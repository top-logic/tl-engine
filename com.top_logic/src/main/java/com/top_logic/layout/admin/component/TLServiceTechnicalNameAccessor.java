...
/**
 * {@link Accessor} for the technical name of a {@link BasicRuntimeModule}.
 * 
 * @author <a href="mailto:sfo@top-logic.com">sfo</a>
 */
public class TLServiceTechnicalNameAccessor extends ReadOnlyAccessor<BasicRuntimeModule<?>> {
