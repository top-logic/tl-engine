 ...
 */
package test.com.top_logic.reporting.data.processing;
...
public final class TestAll {
	...
	/**
	 * Creates a test containing all tests in package 'test.com.top_logic.reporting.data.processing' and all subpackages.
	 */
