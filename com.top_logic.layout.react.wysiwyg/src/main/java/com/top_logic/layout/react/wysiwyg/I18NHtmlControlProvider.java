 ...
 *
 * <p>
 * Edits the current session locale's entry of the attribute value with a
 ...
 * {@link I18NLocalizedHtmlFieldModel}.
 * </p>
 */
public class I18NHtmlControlProvider implements ReactFieldControlProvider {
	...
	public ReactControl createControl(ReactContext context, TLStructuredTypePart part, FieldModel model) {
		return new ReactWysiwygControl(context, new I18NLocalizedHtmlFieldModel(model));
	}
