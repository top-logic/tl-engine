...
public class ResKeyAttributeValueBinding implements AttributeValueBinding<ResKey> {
	...
	public ResKey loadValue(XMLStreamLog log, XMLStreamReader in, TLStructuredTypePart attribute)
		...
		if (tag == XMLStreamConstants.START_ELEMENT) {
			if (!"resource".equals(in.getLocalName())) {
				throw new XMLStreamException("Expected resource element, but found: " + in.getLocalName(),
					in.getLocation());
			}
			...
			if (!"resource".equals(in.getLocalName())) {
				throw new XMLStreamException("Expected end of resource element, but found: " + in.getLocalName(),
					in.getLocation());
			}
