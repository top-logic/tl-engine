...
/**
 * Implementation of {@link com.top_logic.react.flow.data.PolygonalChain}.
 */
public class PolygonalChain_Impl extends com.top_logic.react.flow.data.impl.Box_Impl implements com.top_logic.react.flow.data.PolygonalChain {

	private final java.util.List<com.top_logic.react.flow.data.Point> _points = new de.haumacher.msgbuf.util.ReferenceList<com.top_logic.react.flow.data.Point>() {
		@Override
		protected void beforeAdd(int index, com.top_logic.react.flow.data.Point element) {
			_listener.beforeAdd(PolygonalChain_Impl.this, POINTS__PROP, index, element);
		}

		@Override
		protected void afterRemove(int index, com.top_logic.react.flow.data.Point element) {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.PolygonalChain#create()
	 */
	...
	@Override
	public final java.util.List<com.top_logic.react.flow.data.Point> getPoints() {
		return _points;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setPoints(java.util.List<? extends com.top_logic.react.flow.data.Point> value) {
		internalSetPoints(value);
		return this;
	}

	/** Internal setter for {@link #getPoints()} without chain call utility. */
	protected final void internalSetPoints(java.util.List<? extends com.top_logic.react.flow.data.Point> value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain addPoint(com.top_logic.react.flow.data.Point value) {
		internalAddPoint(value);
		return this;
	}

	/** Implementation of {@link #addPoint(com.top_logic.react.flow.data.Point)} without chain call utility. */
	protected final void internalAddPoint(com.top_logic.react.flow.data.Point value) {
		_points.add(value);
	}

	@Override
	public final void removePoint(com.top_logic.react.flow.data.Point value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setClosed(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setStrokeStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setFillStyle(String value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setThickness(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setDashes(java.util.List<? extends Double> value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain addDash(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.PolygonalChain setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.PolygonalChain setRenderInfo(java.lang.Object value) {
	...
	public void set(String field, Object value) {
		switch (field) {
			case POINTS__PROP: internalSetPoints(de.haumacher.msgbuf.util.Conversions.asList(com.top_logic.react.flow.data.Point.class, value)); break;
	...
	protected void writeFields(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonWriter out) throws java.io.IOException {
		...
		out.beginArray();
		for (com.top_logic.react.flow.data.Point x : getPoints()) {
			x.writeTo(scope, out);
		}
		out.endArray();
	...
	public void readField(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in, String field) throws java.io.IOException {
		switch (field) {
			case POINTS__PROP: {
				java.util.List<com.top_logic.react.flow.data.Point> newValue = new java.util.ArrayList<>();
				in.beginArray();
				while (in.hasNext()) {
					newValue.add(com.top_logic.react.flow.data.Point.readPoint(scope, in));
				}
				in.endArray();
				setPoints(newValue);
			}
	...
	public void writeElement(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonWriter out, String field, Object element) throws java.io.IOException {
		switch (field) {
			case POINTS__PROP: {
				((com.top_logic.react.flow.data.Point) element).writeTo(scope, out);
				break;
			}
			case DASHES__PROP: {
	...
	public Object readElement(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in, String field) throws java.io.IOException {
		switch (field) {
			case POINTS__PROP: {
				return com.top_logic.react.flow.data.Point.readPoint(scope, in);
			}
			case DASHES__PROP: {
