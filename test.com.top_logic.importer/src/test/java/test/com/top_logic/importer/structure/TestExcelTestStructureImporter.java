 ...
 */
public class TestExcelTestStructureImporter extends AbstractTestImporter {

    @Override
    protected String getFileName() {
        return "/data/TestStructure.xlsx";
    }
    ...
    public static Test suite() {
		return AbstractTestImporter.suite(TestExcelTestStructureImporter.class);
    }
}
