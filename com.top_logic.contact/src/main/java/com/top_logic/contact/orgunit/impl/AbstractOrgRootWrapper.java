...
/**
 * Implementation base class for wrapper classes of <code>OrgUnit.root</code> business objects.
 * 
 * <p>
 ...
 */
public class AbstractOrgRootWrapper extends AbstractOrgUnitAllWrapper implements OrgRoot {

	/**
	 * Default constructor.
	 */
	public AbstractOrgRootWrapper(KnowledgeObject ko) {
		super(ko);
	}
