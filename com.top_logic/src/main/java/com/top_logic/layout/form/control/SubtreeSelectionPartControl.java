 ...
 */
public class SubtreeSelectionPartControl<N> extends TriStateCheckboxControl implements TreeSelectionListener<N> {
	...
	/**
	 * Creates a {@link SubtreeSelectionPartControl}.
	 */
	public SubtreeSelectionPartControl(SubtreeSelectionModel<N> selectionModel, N part) {
