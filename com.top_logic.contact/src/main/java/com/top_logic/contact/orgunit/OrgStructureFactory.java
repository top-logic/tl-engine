...
/**
 * Factory for <code>orgStructure</code> objects.
 * 
 * <p>
 ...
 */
public class OrgStructureFactory extends StructuredElementWrapperFactory {

	/**
	 * Name of the structure <code>orgStructure</code> defined by {@link OrgStructureFactory}.
	 */
	public static final String ORG_STRUCTURE_STRUCTURE = "orgStructure";

	/**
	 * Lookup {@link OrgUnitAll} meta element.
	 */
	public TLClass getOrgUnitAllType() {
		return MetaElementFactory.getInstance().getGlobalMetaElement(ORG_STRUCTURE_STRUCTURE,
			OrgUnitAll.ME_ORG_UNIT_ALL);
	}
	...
	public TLClass getOrgUnitBaseType() {
		return MetaElementFactory.getInstance().getGlobalMetaElement(ORG_STRUCTURE_STRUCTURE, OrgUnitBase.ME_ORG_UNIT_BASE);
	}
	...
	public TLClass getOrgRootType() {
		return MetaElementFactory.getInstance().getGlobalMetaElement(ORG_STRUCTURE_STRUCTURE, OrgRoot.ME_ORG_ROOT);
	}
	...
	public TLClass getOrgHeadType() {
		return MetaElementFactory.getInstance().getGlobalMetaElement(ORG_STRUCTURE_STRUCTURE, OrgHead.ME_ORG_HEAD);
	}
	...
	public TLClass getOrgUnitType() {
		return MetaElementFactory.getInstance().getGlobalMetaElement(ORG_STRUCTURE_STRUCTURE, OrgUnit.ME_ORG_UNIT);
	}
	...
	/**
	 * Node name of node <code>OrgRoot</code> in structure <code>orgStructure</code>.
	 */
	public static final String ELEMENT_NAME_ORG_ROOT = "OrgRoot";

	/**
	 * Node name of node <code>OrgHead</code> in structure <code>orgStructure</code>.
	 */
	public static final String ELEMENT_NAME_ORG_HEAD = "OrgHead";

	/**
	 * Node name of node <code>OrgUnit</code> in structure <code>orgStructure</code>.
	 */
	...
	/**
	 * Root node of structure {@link #ORG_STRUCTURE_STRUCTURE}.
	 */
	public OrgRoot getRootOrgStructure(Branch requestedBranch) {
	 ...
	 * Root node of structure {@link #ORG_STRUCTURE_STRUCTURE}.
	 */
	public OrgRoot getRootOrgStructure() {
		return (OrgRoot) getRoot();
	}

	/**
	 * The singleton instance of {@link OrgStructureFactory}.
	 */
	public static OrgStructureFactory getInstance() throws ElementException {
		return (OrgStructureFactory) StructuredElementFactory.getInstanceForStructure(ORG_STRUCTURE_STRUCTURE);
	}

	protected String getStructureName() {
		return ORG_STRUCTURE_STRUCTURE;
	}
