...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Box}.
 */
public abstract class Box_Impl extends com.top_logic.react.flow.data.impl.Widget_Impl implements com.top_logic.react.flow.data.Box {

	private com.top_logic.react.flow.data.Widget _parent = null;
	...
	@Override
	public final com.top_logic.react.flow.data.Widget getParent() {
		return _parent;
	}
	 ...
	 */
	com.top_logic.react.flow.data.Box setParent(com.top_logic.react.flow.data.Widget value) {
		internalSetParent(value);
		return this;
	}

	/** Internal setter for {@link #getParent()} without chain call utility. */
	protected final void internalSetParent(com.top_logic.react.flow.data.Widget value) {
	...
	@Override
	public com.top_logic.react.flow.data.Box setX(double value) {
		internalSetX(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.Box setY(double value) {
		internalSetY(value);
		return this;
	}
	...
	@Override
	public com.top_logic.react.flow.data.Box setWidth(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Box setHeight(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.Box setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Box setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Box setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Box setRenderInfo(java.lang.Object value) {
	...
	@Override
	public final <R,A,E extends Throwable> R visit(com.top_logic.react.flow.data.Widget.Visitor<R,A,E> v, A arg) throws E {
		return visit((com.top_logic.react.flow.data.Box.Visitor<R,A,E>) v, arg);
	}
