 ...
 * key.
 */
public class ResourceDisplay extends TemplateProvider {

	/**
	 * Singleton {@link ResourceDisplay} instance.
	 */
	public static final ResourceDisplay INSTANCE = new ResourceDisplay();

	private ResourceDisplay() {
		// Singleton constructor.
	}

	@Override
	public HTMLTemplateFragment get(ConfigurationItem model) {
		return div(resourceExpr(ResKey.forConfig(model)));
	}
}