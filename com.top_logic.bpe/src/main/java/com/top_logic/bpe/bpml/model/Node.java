...
import com.top_logic.bpe.bpml.model.impl.NodeBase;
...
public interface Node extends NodeBase {
	...
	/**
	 * Visit method for the {@link Node} hierarchy.
	 */
	<R, A, E extends Throwable> R visit(NodeVisitor<R, A, E> v, A arg) throws E;
