...
/**
 * {@link Check} that tests for added list entries.
 * 
...
public class AddCheck extends Check {
	...
	public AddCheck(int first, int last) {
		this.first = first;
		this.last = last;
	...
	public void checkEvent(ListDataEvent evt) {
		Assert.assertEquals("Is add event.", ListDataEvent.INTERVAL_ADDED, evt.getType());
