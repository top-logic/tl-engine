...
/**
 * {@link Operator} checking whether an integer is within a certain range.
 * 
 * @author <a href="mailto:bhu@top-logic.com">Bernhard Haumacher</a>
 */
@UseTemplate(ResourceDisplay.class)
public interface IntegerRangeCompare extends AbstractIntegerCompare<IntegerRangeCompare.Impl>,
		PrimitiveRangeCompare<IntegerRangeCompare.Impl> {
	...
	/**
	 * {@link Operator.Impl} for {@link IntegerRangeCompare}.
	 */
	class Impl extends AbstractIntegerCompare.Impl<IntegerRangeCompare> {

		/**
		 * Creates a {@link Impl}.
		 */
		public Impl(InstantiationContext context, IntegerRangeCompare config) {
			super(context, config);
		}

		@Override
		public SearchExpression build(ExpressionBuilder builder, SearchExpression contextExpr) {
			IntegerRangeCompare comparison = getConfig();
