...
/**
 * Implementation of {@link com.top_logic.react.flow.data.TreeConnector}.
 */
public class TreeConnector_Impl extends com.top_logic.react.flow.data.impl.Widget_Impl implements com.top_logic.react.flow.data.TreeConnector {

	private com.top_logic.react.flow.data.TreeConnection _connection = null;

	private com.top_logic.react.flow.data.Box _anchor = null;

	private double _connectPosition = 0.5;

	private com.top_logic.react.flow.data.ConnectorSymbol _symbol = com.top_logic.react.flow.data.ConnectorSymbol.NONE;

	/**
	 * Creates a {@link TreeConnector_Impl} instance.
	 *
	 * @see com.top_logic.react.flow.data.TreeConnector#create()
	 */
	...
	@Override
	public final com.top_logic.react.flow.data.TreeConnection getConnection() {
		return _connection;
	}
	 ...
	 */
	com.top_logic.react.flow.data.TreeConnector setConnection(com.top_logic.react.flow.data.TreeConnection value) {
		internalSetConnection(value);
		return this;
	}

	/** Internal setter for {@link #getConnection()} without chain call utility. */
	protected final void internalSetConnection(com.top_logic.react.flow.data.TreeConnection value) {
	...
	@Override
	public final com.top_logic.react.flow.data.Box getAnchor() {
		return _anchor;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnector setAnchor(com.top_logic.react.flow.data.Box value) {
		internalSetAnchor(value);
		return this;
	}

	/** Internal setter for {@link #getAnchor()} without chain call utility. */
	protected final void internalSetAnchor(com.top_logic.react.flow.data.Box value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnector setConnectPosition(double value) {
	...
	@Override
	public final com.top_logic.react.flow.data.ConnectorSymbol getSymbol() {
		return _symbol;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnector setSymbol(com.top_logic.react.flow.data.ConnectorSymbol value) {
		internalSetSymbol(value);
		return this;
	}

	/** Internal setter for {@link #getSymbol()} without chain call utility. */
	protected final void internalSetSymbol(com.top_logic.react.flow.data.ConnectorSymbol value) {
	...
	@Override
	public com.top_logic.react.flow.data.TreeConnector setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnector setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnector setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.TreeConnector setRenderInfo(java.lang.Object value) {
	...
	public void set(String field, Object value) {
		switch (field) {
			case ANCHOR__PROP: internalSetAnchor((com.top_logic.react.flow.data.Box) value); break;
			case CONNECT_POSITION__PROP: internalSetConnectPosition((double) value); break;
			case SYMBOL__PROP: internalSetSymbol((com.top_logic.react.flow.data.ConnectorSymbol) value); break;
	...
	public void readField(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in, String field) throws java.io.IOException {
		switch (field) {
			case ANCHOR__PROP: setAnchor(com.top_logic.react.flow.data.Box.readBox(scope, in)); break;
			case CONNECT_POSITION__PROP: setConnectPosition(in.nextDouble()); break;
			case SYMBOL__PROP: setSymbol(com.top_logic.react.flow.data.ConnectorSymbol.readConnectorSymbol(in)); break;
