 ...
 * <p>
 * If you're extending AbstractTestList, AbstractTestSet,
 * or AbstractTestBag, you probably don't have to worry about the
...
public abstract class AbstractTestCollection extends AbstractTestObject {
     ...
     */
    public Collection<Object>  confirmed;
     ...
     */
    public abstract Collection<Object> makeConfirmedCollection();
     ...
     */
    public abstract Collection<Object> makeConfirmedFullCollection();

    /**
     * Return a new, empty {@link Collection} to be used for testing.
     */
    public abstract Collection<Object> makeCollection();
    ...
    public Collection<Object> makeFullCollection() {
        Collection<Object> c = makeCollection();
     ...
     */
    public <K,V> Map.Entry<K,V> cloneMapEntry(Map.Entry<K,V> entry) {
    ...
    public void testCollectionIteratorRemove() {
        ...
        while (iter.hasNext()) {
            ...
            if (o instanceof Map.Entry) {
                o = cloneMapEntry((Map.Entry<Object, Object>) o);
            }
            iter.remove();
    ...
    public void testCollectionRemoveAll() {
        ...
        int max = (getFullElements().length == 1 ? 1 : 
                    (getFullElements().length <= 5 ? getFullElements().length - 1 : 5));
        Collection<Object> all = Arrays.asList(getFullElements()).subList(min, max);
    ...
    public void testCollectionRetainAll() {
        ...
        resetFull();
        HashSet<Object> set = new HashSet<>(elements);
        size = collection.size();
    ...
    public void testCollectionIteratorFailFast() {
        ...
        try {
            Iterator<Object> iter = collection.iterator();
            List<Object> sublist = Arrays.asList(getFullElements()).subList(2,5);
