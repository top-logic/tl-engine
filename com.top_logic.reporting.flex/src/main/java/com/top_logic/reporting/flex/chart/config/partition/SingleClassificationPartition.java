...
public class SingleClassificationPartition extends SingleValuePartition {
	...
	/**
	 * Config-interface for {@link SingleClassificationPartition}.
	 */
	@DisplayOrder({
		Config.ADD_EMPTY,
	...
	public interface Config extends SingleValuePartition.Config {
		...
		public Class<SingleClassificationPartition> getImplementationClass();
	...
	/**
	 * Config-constructor for {@link SingleClassificationPartition}
	 * 
	 * @param context
	 ...
	 *        - default config-constructor
	 */
	public SingleClassificationPartition(InstantiationContext context, Config config) {
