...
/**
 * Generate {@link CompanyContact}s that are {@link COSContactConstants#SUPPLIER}s and bound to a
 * part of {@link Mandator}-Structure.
 * 
 * @author <a href=mailto:kbu@top-logic.com>kbu</a>
 */
public class COSCachedSupplierGenerator extends MandatorAwareContactGenerator {

	private static final Filter<? super Object> SUPPLIER_FILTER = FilterFactory.createClassFilter(CompanyContact.class,
		new Filter<CompanyContact>() {

			@Override
			public boolean accept(CompanyContact anObject) {
				return anObject.getBooleanValue(COSContactConstants.SUPPLIER);
			}
