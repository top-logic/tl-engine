...
import TLSlider from './controls/TLSlider';
import TLSelect from './controls/TLSelect';
import TLBooleanChoice from './controls/TLBooleanChoice';
...
import TLValueList from './controls/TLValueList';
...
import TLBinaryField from './controls/TLBinaryField';
import TLFileChips from './controls/TLFileChips';
import TLRelativeTime from './controls/TLRelativeTime';
import TLProgress from './controls/TLProgress';
import TLJobStatus from './controls/TLJobStatus';
import TLAnchor from './controls/TLAnchor';
import TLScrollLink from './controls/TLScrollLink';
import TLAvatar from './controls/TLAvatar';
import TLDownload from './controls/TLDownload';
import TLPhotoCapture from './controls/TLPhotoCapture';
import TLImage from './controls/TLImage';
import TLPdfViewer from './controls/TLPdfViewer';
...
import TLInset from './controls/TLInset';
import TLGrid from './controls/TLGrid';
import TLColumns from './controls/TLColumns';
import TLCard from './controls/TLCard';
import TLOverlay from './controls/TLOverlay';
...
import TLMenuRegion from './controls/TLMenuRegion';
import TLSnackbar from './controls/TLSnackbar';
import TLNoticeBar from './controls/TLNoticeBar';
import TLMenu from './controls/TLMenu';
import TLAppShell from './controls/TLAppShell';
import TLText from './controls/TLText';
import TLIcon from './controls/TLIcon';
import TLHtml from './controls/TLHtml';
import TLTableView from './controls/TLTableView';
import TLColumnSelect from './controls/TLColumnSelect';
import TLCalendar from './controls/TLCalendar';
...
import TLOptionChips from './controls/TLOptionChips';
import TLSegmentedChoice from './controls/TLSegmentedChoice';
...
import TLWizard from './controls/TLWizard';
import TLAdaptiveDetail from './controls/TLAdaptiveDetail';
...
register('TLSlider', TLSlider);
register('TLSelect', TLSelect);
register('TLBooleanChoice', TLBooleanChoice);
register('TLCheckbox', TLCheckbox);
register('TLCounter', TLCounter);
register('TLTabBar', TLTabBar);
register('TLFieldList', TLFieldList);
register('TLValueList', TLValueList);
register('TLAudioRecorder', TLAudioRecorder);
register('TLAudioPlayer', TLAudioPlayer);
register('TLFileUpload', TLFileUpload);
register('TLBinaryField', TLBinaryField);
register('TLFileChips', TLFileChips);
register('TLRelativeTime', TLRelativeTime);
register('TLProgress', TLProgress);
register('TLJobStatus', TLJobStatus);
register('TLAnchor', TLAnchor);
register('TLScrollLink', TLScrollLink);
register('TLAvatar', TLAvatar);
register('TLDownload', TLDownload);
register('TLPhotoCapture', TLPhotoCapture);
register('TLImage', TLImage);
register('TLPdfViewer', TLPdfViewer);
register('TLSplitPanel', TLSplitPanel);
register('TLPanel', TLPanel);
register('TLInset', TLInset);
...
register('TLColumns', TLColumns);
register('TLCard', TLCard);
register('TLOverlay', TLOverlay);
...
register('TLMenuRegion', TLMenuRegion);
register('TLSnackbar', TLSnackbar);
register('TLNoticeBar', TLNoticeBar);
register('TLMenu', TLMenu);
register('TLAppShell', TLAppShell);
register('TLText', TLText);
register('TLIcon', TLIcon);
register('TLHtml', TLHtml);
register('TLTableView', TLTableView);
register('TLColumnSelect', TLColumnSelect);
register('TLCalendar', TLCalendar);
...
register('TLOptionChips', TLOptionChips);
register('TLSegmentedChoice', TLSegmentedChoice);
...
register('TLWizard', TLWizard);
register('TLAdaptiveDetail', TLAdaptiveDetail);
