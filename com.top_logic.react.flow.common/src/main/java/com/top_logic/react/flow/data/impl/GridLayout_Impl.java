...
/**
 * Implementation of {@link com.top_logic.react.flow.data.GridLayout}.
 */
public class GridLayout_Impl extends com.top_logic.react.flow.data.impl.Layout_Impl implements com.top_logic.react.flow.data.GridLayout {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.GridLayout#create()
	 */
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setRows(int value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setCols(int value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setGapX(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setGapY(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setRowHeight(java.util.List<? extends Double> value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout addRowHeight(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setColWidth(java.util.List<? extends Double> value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout addColWidth(double value) {
	...
	@Override
	public com.top_logic.react.flow.data.GridLayout setContents(java.util.List<? extends com.top_logic.react.flow.data.Box> value) {
		internalSetContents(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout addContent(com.top_logic.react.flow.data.Box value) {
		internalAddContent(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.GridLayout setRenderInfo(java.lang.Object value) {
