...
/**
 * Implementation of {@link com.top_logic.graphic.flow.data.Stack}.
 */
public class Stack_Impl extends com.top_logic.graphic.flow.data.impl.Box_Impl implements com.top_logic.graphic.flow.data.Stack {
	 ...
	 *
	 * @see com.top_logic.graphic.flow.data.Stack#create()
	 */
	public Stack_Impl() {
		super();
	}
	...
	@Override
	public com.top_logic.graphic.flow.data.Stack setContents(java.util.List<? extends com.top_logic.graphic.flow.data.Box> value) {
	...
	@Override
	public com.top_logic.graphic.flow.data.Stack addContent(com.top_logic.graphic.flow.data.Box value) {
	...
	@Override
	public com.top_logic.graphic.flow.data.Stack setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.graphic.flow.data.Stack setRenderInfo(java.lang.Object value) {
