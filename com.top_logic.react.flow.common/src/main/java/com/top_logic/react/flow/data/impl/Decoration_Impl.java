...
/**
 * Implementation of {@link com.top_logic.react.flow.data.Decoration}.
 */
public abstract class Decoration_Impl extends com.top_logic.react.flow.data.impl.Box_Impl implements com.top_logic.react.flow.data.Decoration {
	...
	@Override
	public com.top_logic.react.flow.data.Decoration setContent(com.top_logic.react.flow.data.Box value) {
	...
	@Override
	public com.top_logic.react.flow.data.Decoration setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.Decoration setRenderInfo(java.lang.Object value) {
	...
	public final <R,A,E extends Throwable> R visit(com.top_logic.react.flow.data.Box.Visitor<R,A,E> v, A arg) throws E {
		return visit((com.top_logic.react.flow.data.Decoration.Visitor<R,A,E>) v, arg);
	}
