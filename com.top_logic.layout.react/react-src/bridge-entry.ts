...
// Re-export the react-dom entry points that controls legitimately need.  Without
// these, a control has no rule-conforming way to create a portal and is forced to
// `import { createPortal } from 'react-dom'` -- which drags a second copy of React
// *and* react-dom into tl-react-controls.js, exactly what the note above forbids.
