 ...
 */
public class TestUpperQuartil extends AbstractAggregationTest {

	public TestUpperQuartil(String aTest) {
		super(aTest);
    }
	...
	public void testCalculateResult() {
		...
		UpperQuartil mf = getFunction("value");
		...
		assertTrue(theValue.doubleValue() == 17.0);
		someObjects.clear();
		...
		assertTrue(theValue.doubleValue() == 11.0);
	}
    ...
    protected UpperQuartil getFunction(String anAttribute) {
        return (UpperQuartil) super.createFunction(UpperQuartil.class, anAttribute);
    }

    public static Test suite() {
        return TLTestSetup.createTLTestSetup(TestUpperQuartil.class);
    }
