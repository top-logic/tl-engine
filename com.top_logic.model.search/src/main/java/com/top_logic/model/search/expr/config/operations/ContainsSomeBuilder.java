 ...
 */
public class ContainsSomeBuilder extends SingleArgMethodBuilder<ContainsSome> {
	...
	@Override
	protected ContainsSome internalBuild(Expr expr, SearchExpression self, SearchExpression arg) {
		return containsSome(self, arg);
	}
