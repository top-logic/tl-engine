import { React as e, useTLFieldValue as R, getComponent as D, useTLState as k, useTLCommand as w, TLChild as N, useTLUpload as T, useTLDataUrl as y, register as b } from "tl-react-bridge";
const { useCallback: U } = e, P = ({ state: o }) => {
  const [r, a] = R(), n = U(
    (t) => {
      a(t.target.value);
    },
  ...
  const n = k(), t = w(), l = o ?? "click", s = r ?? n.label, c = a ?? n.disabled === !0, i = x(() => {
    t(l);
  }, [t, l]);
  return /* @__PURE__ */ e.createElement(
    "button",
  ...
  const t = k(), l = w(), s = o ?? "click", c = r ?? t.label, i = a ?? t.active === !0, p = n ?? t.disabled === !0, h = W(() => {
    l(s);
  }, [l, s]);
  return /* @__PURE__ */ e.createElement(
    "button",
  ...
  const o = k(), r = w(), a = o.count ?? 0, n = o.label ?? "React Counter";
  ...
  const o = k(), r = w(), a = o.tabs ?? [], n = o.activeTabId, t = q((l) => {
  ...
  const o = k(), r = o.title, a = o.fields ?? [];
  ...
  const o = k(), r = T(), [a, n] = e.useState("idle"), t = e.useRef(null), l = e.useRef([]), s = e.useRef(null), c = o.status ?? "idle", i = o.error, p = c === "received" ? "idle" : a !== "idle" ? a : c, h = e.useCallback(async () => {
    if (a === "recording") {
      const d = t.current;
    ...
    if (a !== "uploading")
      try {
        ...
        const u = MediaRecorder.isTypeSupported("audio/webm") ? "audio/webm" : "", C = new MediaRecorder(d, u ? { mimeType: u } : void 0);
        t.current = C, C.ondataavailable = (L) => {
          L.data.size > 0 && l.current.push(L.data);
        }, C.onstop = async () => {
          d.getTracks().forEach((_) => _.stop()), s.current = null;
          const L = new Blob(l.current, { type: C.mimeType || "audio/webm" });
          ...
          m.append("audio", L, "recording.webm"), await r(m), n("idle");
        }, C.start(), n("recording");
      } catch (d) {
        console.error("[TLAudioRecorder] Microphone access denied or unavailable:", d), n("idle");
      }
  }, [a, r]), f = p === "recording" ? "Stop recording" : p === "uploading" ? "Uploading…" : "Record audio", g = p === "uploading", v = ["tlAudioRecorder__button"];
  ...
  const o = k(), r = y(), a = !!o.hasAudio, n = o.dataRevision ?? 0, [t, l] = e.useState(a ? "idle" : "disabled"), s = e.useRef(null), c = e.useRef(null), i = e.useRef(n);
  e.useEffect(() => {
  ...
  const p = e.useCallback(async () => {
    ...
    s.current = v, v.onended = () => {
      l("idle");
    }, v.play(), l("playing");
  }, [t, r]), h = t === "loading" ? "Loading…" : t === "playing" ? "Pause audio" : t === "disabled" ? "No audio" : "Play audio", f = t === "disabled" || t === "loading", g = ["tlAudioPlayer__button"];
  return t === "playing" && g.push("tlAudioPlayer__button--playing"), t === "loading" && g.push("tlAudioPlayer__button--loading"), /* @__PURE__ */ e.createElement("div", { className: "tlAudioPlayer" }, /* @__PURE__ */ e.createElement(
    "button",
    {
      type: "button",
      className: g.join(" "),
  ...
  const o = k(), r = T(), [a, n] = e.useState("idle"), [t, l] = e.useState(!1), s = e.useRef(null), c = o.status ?? "idle", i = o.error, p = o.accept ?? "", h = c === "received" ? "idle" : a !== "idle" ? a : c, f = e.useCallback(async (m) => {
    n("uploading");
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      "button",
      {
        ...
        onClick: v,
        disabled: L,
        title: h === "uploading" ? "Uploading…" : "Upload file",
        "aria-label": h === "uploading" ? "Uploading…" : "Upload file"
      },
  ...
  const o = k(), r = y(), a = w(), n = !!o.hasData, t = o.dataRevision ?? 0, l = o.fileName ?? "download", s = !!o.clearable, [c, i] = e.useState(!1), p = e.useCallback(async () => {
    if (!(!n || c)) {
      i(!0);
      try {
        const f = r + (r.includes("?") ? "&" : "?") + "rev=" + t, g = await fetch(f);
        if (!g.ok) {
          console.error("[TLDownload] Failed to fetch data:", g.status);
          return;
        }
        const v = await g.blob(), d = URL.createObjectURL(v), u = document.createElement("a");
  ...
  }, [n, c, r, t, l]), h = e.useCallback(async () => {
    n && await a("clear");
  }, [n, a]);
  ...
  const o = k(), r = T(), [a, n] = e.useState("idle"), t = e.useRef(null), l = e.useRef(null), s = e.useRef(null), c = o.error, i = e.useCallback(() => {
  ...
  }, [a, i]), h = e.useCallback(async () => {
    if (a !== "previewing")
      return;
    const u = t.current, C = s.current;
    if (!u || !C)
      return;
    C.width = u.videoWidth, C.height = u.videoHeight;
    const L = C.getContext("2d");
    L && (L.drawImage(u, 0, 0), i(), n("uploading"), C.toBlob(async (m) => {
      if (!m) {
        n("idle");
        return;
      }
  ...
  const f = a === "previewing" ? "Close camera" : a === "uploading" ? "Uploading…" : "Open camera", g = a === "uploading", v = ["tlPhotoCapture__cameraBtn"];
  a === "previewing" && v.push("tlPhotoCapture__cameraBtn--active");
  ...
  const o = k(), r = y(), a = !!o.hasPhoto, n = o.dataRevision ?? 0, [t, l] = e.useState(null), s = e.useRef(n);
  return e.useEffect(() => {
    if (!a) {
