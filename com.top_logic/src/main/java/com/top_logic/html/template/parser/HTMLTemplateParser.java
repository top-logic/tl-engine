...
public class HTMLTemplateParser implements HTMLTemplateParserConstants {
  ...
  final public RawTemplateFragment html() throws ParseException {
  ...
  RawTemplateFragment content;
    ...
    {if (true) return _f.template(result);}
    throw new Error("Missing return statement in function");
  }

  final public RawTemplateFragment htmlContent() throws ParseException {
  Token t;
  ...
  final public TemplateExpression templateExpression() throws ParseException {
  ...
  final public TemplateExpression ifThenExpression() throws ParseException {
  ...
  TemplateExpression elseExpr;
    ...
    case EXPRESSION_IF:
      ...
      case EXPRESSION_ELSE:
        ...
        {if (true) return _f.ifThenExpression(booleanExpression, thenExpr, elseExpr);}
        break;
      default:
        jj_la1[2] = jj_gen;
        ;
      }
      {if (true) return _f.ifThenExpression(booleanExpression, thenExpr);}
      break;
    default:
      jj_la1[3] = jj_gen;
      ;
  ...
  final public TemplateExpression booleanExpression() throws ParseException {
  TemplateExpression expr;
  ...
  final public TemplateExpression orExpr() throws ParseException {
  TemplateExpression expr;
  TemplateExpression right;
    expr = andExpr();
    label_3:
  ...
  final public TemplateExpression andExpr() throws ParseException {
  TemplateExpression expr;
  TemplateExpression right;
    expr = aditiveExpr();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public TemplateExpression aditiveExpr() throws ParseException {
  TemplateExpression expr;
  TemplateExpression right;
  ...
  final public TemplateExpression multiplicativeExpr() throws ParseException {
  TemplateExpression expr;
  TemplateExpression right;
    expr = negatedExpr();
    label_5:
  ...
  final public TemplateExpression negatedExpr() throws ParseException {
  TemplateExpression expr;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT:
  ...
  final public TemplateExpression atomicExpression() throws ParseException {
  Token t;
  TemplateExpression result;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VARIABLE_NAME:
  ...
  final public RawTemplateFragment startTag() throws ParseException {
  Token t, v;
  ...
  ConditionalTemplate top, current;
    ...
    {if (true) return _f.ifTag(expression, content);}
      break;
    case CHOOSE_TAG:
    ...
    if (current == null) { {if (true) return content;} } else { current.setElseFragment(content); {if (true) return top;} }
      break;
    case WITH_TAG:
    ...
    {if (true) return _f.withTag(v.image, expression, content);}
      break;
    case FOREACH_TAG:
    ...
    {if (true) return _f.foreachTag(v.image, expression, content);}
      break;
    case TEXT_TAG:
      jj_consume_token(TEXT_TAG);
      t = jj_consume_token(TEXT_CONTENT);
      jj_consume_token(TEXT_END);
    {if (true) return _f.rawText(t);}
      break;
    default:
      jj_la1[19] = jj_gen;
      jj_consume_token(-1);
  ...
  final public TagAttributeTemplate attribute() throws ParseException {
  Token t;
  List<RawTemplateFragment> content;
    ...
    {if (true) return _f.attribute(t, content);}
    throw new Error("Missing return statement in function");
  }

  final public List<RawTemplateFragment> attributeContent() throws ParseException {
  Token t;
  TemplateExpression expression;
  List<RawTemplateFragment> result = _f.builder();
    label_8:
