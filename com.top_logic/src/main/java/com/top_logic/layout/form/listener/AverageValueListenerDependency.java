...
/**
 * An {@link AggregationValueListenerDependency} implementation that computes the average
 * over the fields.
 *
 * @author <a href="mailto:CBR@top-logic.com">CBR</a>
 */
public class AverageValueListenerDependency extends AggregationValueListenerDependency {

	/** See {@link #isMandatory()}. */
	private boolean mandatory;

    /**
     * Creates a {@link AverageValueListenerDependency}. The Fields must
     ...
     */
    public AverageValueListenerDependency(FormField[] relatedFields, FormField resultField) {
		this(relatedFields, resultField, false);
	}

	/**
	 * Creates a {@link AverageValueListenerDependency}. The Fields must contain
	 ...
	 */
	public AverageValueListenerDependency(FormField[] relatedFields, FormField resultField, boolean mandatory) {
    ...
    /**
     * Computes the average over all {@link FormField}s.
