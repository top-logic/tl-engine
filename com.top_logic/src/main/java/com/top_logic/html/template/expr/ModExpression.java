...
/**
 * {@link NumericExpression} for a modulo operation.
 */
public class ModExpression extends NumericExpression {

	/**
	 * Creates a {@link ModExpression}.
	 */
	public ModExpression(TemplateExpression left, TemplateExpression right) {
		super(left, right);
	}
