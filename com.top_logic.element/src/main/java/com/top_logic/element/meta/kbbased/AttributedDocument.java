...
/**
 * Group implementation that returns the dynamic document type as {@link TLObject#tType()}.
 * 
 * @author <a href="mailto:daniel.busche@top-logic.com">Daniel Busche</a>
 */
public class AttributedDocument extends Document {

	/**
	 * @see KnowledgeItemImpl#createWrapper(KnowledgeItem)
	 */
	@CalledByReflection
	public AttributedDocument(KnowledgeObject ko) {
		super(ko);
	}
