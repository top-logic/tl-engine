...
public final class CreateClassEventHandler implements EventHandler {
	...
	/**
	 * Creates a {@link CreateClassEventHandler}.
	 */
	public CreateClassEventHandler(String controlID) {
	...
	public void call(Event event) {
		...
		arguments.setControlCommand(DiagramJSGraphControlCommon.CREATE_CLASS_COMMAND);
