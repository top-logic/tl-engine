...
public interface Box extends Widget, com.top_logic.react.flow.operations.BoxOperations {
	...
	public interface Visitor<R,A,E extends Throwable> extends com.top_logic.react.flow.data.Decoration.Visitor<R,A,E>, com.top_logic.react.flow.data.Layout.Visitor<R,A,E> {
		...
		/** Visit case for {@link com.top_logic.react.flow.data.FloatingLayout}.*/
		R visit(com.top_logic.react.flow.data.FloatingLayout self, A arg) throws E;

		/** Visit case for {@link com.top_logic.react.flow.data.Text}.*/
		R visit(com.top_logic.react.flow.data.Text self, A arg) throws E;

		/** Visit case for {@link com.top_logic.react.flow.data.Image}.*/
		R visit(com.top_logic.react.flow.data.Image self, A arg) throws E;

		/** Visit case for {@link com.top_logic.react.flow.data.Empty}.*/
		R visit(com.top_logic.react.flow.data.Empty self, A arg) throws E;
		...
		/** Visit case for {@link com.top_logic.react.flow.data.PolygonalChain}.*/
		R visit(com.top_logic.react.flow.data.PolygonalChain self, A arg) throws E;
	 ...
	 */
	com.top_logic.react.flow.data.Widget getParent();
	 ...
	 * @see #getX()
	 */
	com.top_logic.react.flow.data.Box setX(double value);
	 ...
	 * @see #getY()
	 */
	com.top_logic.react.flow.data.Box setY(double value);
	 ...
	 * @see #getWidth()
	 */
	com.top_logic.react.flow.data.Box setWidth(double value);
	 ...
	 * @see #getHeight()
	 */
	com.top_logic.react.flow.data.Box setHeight(double value);

	@Override
	com.top_logic.react.flow.data.Box setCssClass(String value);

	@Override
	com.top_logic.react.flow.data.Box setUserObject(java.lang.Object value);

	@Override
	com.top_logic.react.flow.data.Box setClientId(String value);

	@Override
	com.top_logic.react.flow.data.Box setRenderInfo(java.lang.Object value);

	/** Reads a new instance from the given reader. */
	static com.top_logic.react.flow.data.Box readBox(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.react.flow.data.Box) scope.resolveOrFail(in.nextInt());
		}
		com.top_logic.react.flow.data.Box result;
		in.beginArray();
