 ...
 * {@link CellContent.Raw} whose payload is a {@link CellControlFactory}; the React adapter
 * ({@link CellContentReactAdapter}) then asks the factory to build the actual cell
