...
/**
 * {@link PersistentModelPart} fetching its properties from the dynamic model.
 * 
 * @author <a href="mailto:daniel.busche@top-logic.com">Daniel Busche</a>
 */
public abstract class DynamicModelPart extends PersistentModelPart {

	/**
	 * Creates a new {@link DynamicModelPart}.
	 */
	public DynamicModelPart(KnowledgeObject ko) {
		super(ko);
	}
