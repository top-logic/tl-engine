 ...
 * An empty region.
 */
public interface Empty extends com.top_logic.graphic.flow.data.Box, com.top_logic.graphic.flow.operations.EmptyOperations {
	...
	@Override
	com.top_logic.graphic.flow.data.Empty setRenderInfo(java.lang.Object value);
