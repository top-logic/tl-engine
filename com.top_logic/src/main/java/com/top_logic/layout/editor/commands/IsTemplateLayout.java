...
/**
 * Checks if the given component is directly instantiated from a typed template.
 * 
 * @author <a href="mailto:sfo@top-logic.com">sfo</a>
 */
public class IsTemplateLayout implements ExecutabilityRule {

	/**
	 * Singleton instance.
	 */
	public static final ExecutabilityRule INSTANCE = new IsTemplateLayout();
	...
	public ExecutableState isExecutable(LayoutComponent component, Object model, Map<String, Object> someValues) {
		...
		return ExecutableState.createDisabledState(I18NConstants.NO_TEMPLATE_LAYOUT_ERROR);
	}
