 ...
 */
package test.com.top_logic.reporting.data.base;
...
public final class TestAll {
	...
	/**
	 * Creates a test containing all tests in package 'test.com.top_logic.reporting.data.base' and all subpackages.
	 */
