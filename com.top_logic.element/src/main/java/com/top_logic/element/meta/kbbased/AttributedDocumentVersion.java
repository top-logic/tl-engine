...
/**
 * Group implementation that returns the dynamic document version type as {@link TLObject#tType()}.
 * 
 * @author <a href="mailto:daniel.busche@top-logic.com">Daniel Busche</a>
 */
public class AttributedDocumentVersion extends DocumentVersion {

	/**
	 * @see KnowledgeItemImpl#createWrapper(KnowledgeItem)
	 */
	@CalledByReflection
	public AttributedDocumentVersion(KnowledgeObject ko) {
		super(ko);
	}
