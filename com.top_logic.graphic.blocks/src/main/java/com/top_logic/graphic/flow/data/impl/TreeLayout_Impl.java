...
public class TreeLayout_Impl extends com.top_logic.graphic.flow.data.impl.FloatingLayout_Impl implements com.top_logic.graphic.flow.data.TreeLayout {
	...
	@Override
	public com.top_logic.graphic.flow.data.TreeLayout setChildSplitThreshold(int value) {
	...
	@Override
	public com.top_logic.graphic.flow.data.TreeLayout setSubGridStartCol(int value) {
	...
	@Override
	public com.top_logic.graphic.flow.data.TreeLayout setRowWise(boolean value) {
	...
	static {
		...
		tmp.addAll(com.top_logic.graphic.flow.data.impl.FloatingLayout_Impl.PROPERTIES);
		tmp.addAll(local);
	...
	static {
		...
		tmp.addAll(com.top_logic.graphic.flow.data.impl.FloatingLayout_Impl.TRANSIENT_PROPERTIES);
