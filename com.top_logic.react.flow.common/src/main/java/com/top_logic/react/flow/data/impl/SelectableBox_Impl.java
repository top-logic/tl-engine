...
/**
 * Implementation of {@link com.top_logic.react.flow.data.SelectableBox}.
 */
public class SelectableBox_Impl extends com.top_logic.react.flow.data.impl.Decoration_Impl implements com.top_logic.react.flow.data.SelectableBox {
	 ...
	 *
	 * @see com.top_logic.react.flow.data.SelectableBox#create()
	 */
	...
	@Override
	public com.top_logic.react.flow.data.SelectableBox setSelected(boolean value) {
	...
	@Override
	public com.top_logic.react.flow.data.SelectableBox setClickHandler(com.top_logic.react.flow.svg.event.Registration value) {
	...
	@Override
	public com.top_logic.react.flow.data.SelectableBox setContent(com.top_logic.react.flow.data.Box value) {
		internalSetContent(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setX(double value) {
		internalSetX(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setY(double value) {
		internalSetY(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setWidth(double value) {
		internalSetWidth(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setHeight(double value) {
		internalSetHeight(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setCssClass(String value) {
		internalSetCssClass(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setUserObject(java.lang.Object value) {
		internalSetUserObject(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setClientId(String value) {
		internalSetClientId(value);
		return this;
	}

	@Override
	public com.top_logic.react.flow.data.SelectableBox setRenderInfo(java.lang.Object value) {
